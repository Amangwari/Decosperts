...
jQuery(document).ready(function() { 
	...
	(function ($) { 
		...
		$('.cmsmasters_tabs:not(.cmsmasters_woo_tabs) > ul.cmsmasters_tabs_list li a').on('click', function (t) { 
			var tabs_parent = $(this).parents('.cmsmasters_tabs:not(.cmsmasters_woo_tabs)'), 
		...
		$('.cmsmasters_woo_tabs > ul.cmsmasters_tabs_list li a').on('click', function (t) { 
			var tabs_parent = $(this).parents('.cmsmasters_woo_tabs'), 
				tabs = tabs_parent.find(' > .cmsmasters_tabs_wrap'), 
				index = $(this).parents('li').index();
