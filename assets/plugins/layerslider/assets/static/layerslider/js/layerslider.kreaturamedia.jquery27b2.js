  ...
  (window._layerSliders = {}),
    ...
    ie(window).on("resize.lsGlobal", function () {
      window._lsData.documentIsAccessible &&
        ...
        ie(window).trigger("scroll.lsGlobal"),
        ...
        window._lsData.resize.once
          ...
          : (window._lsData.resize.timeout = setTimeout(function () {
              (window._lsData.resize.once = !0),
                ie(window).trigger("resize.lsGlobal");
            }, 100)));
    }),
    ie(window).on("scroll.lsGlobal", function () {
      window._lsData.documentIsAccessible &&
        ((window._lsData.scroll.left = window.pageXOffset),
        (window._lsData.scroll.top = window.pageYOffset),
        (window._lsData.scroll.leftMax =
          window._lsData.document.width - window._lsData.viewport.width),
        (window._lsData.scroll.topMax =
          window._lsData.document.height - window._lsData.viewport.height));
    }),
    ie(document).on("wheel.lsGlobal ", function (e) {
      0 !== Math.abs(e.originalEvent.deltaY) &&
        (window._lsData.scroll.direction =
          e.originalEvent.deltaY < 0 ? "up" : "down");
    }),
    ...
    ie(document).on("touchend.lsGlobal ", function (e) {
      ...
      window._lsData.ts > e + 5
        ? (window._lsData.scroll.direction = "down")
        : window._lsData.ts < e - 5 && (window._lsData.scroll.direction = "up");
    }),
        ...
        return (typeof i).match("object|undefined")
          ? this.each(function (e) {
              (t = "LS" + Math.random().toString(36).substr(2, 9)),
                ie(this).data("lsSliderUID") ||
                  (window._layerSliders[t] = new n(this, ie(this), i, t));
            })
          : "data" === i
    ...
    (J.defaults = {
      ...
      slide: {
        ...
        registerPluginDefaults: function (e, t, i) {
          J.defaults.slide.options.plugins ||
            (J.defaults.slide.options.plugins = {}),
            (J.defaults.slide.options.plugins[e] = t);
        },
      },
      layer: {
        ...
        options: function (e, t) {
          t = {
            ...
            mediaSettings: { backgroundVideo: !1 },
            timeline: {
              slidestart: 0,
              transitioninstart: 0,
              transitioninend: 0,
              ...
              transitioninandloopend: function (e) {
                return (
                  ...
                  ("number" == typeof e.loop.startAt ||
                    ...
                    ? ((this.loopstart =
                        J.transitions.layers.timeline.getTiming(
                          e,
                          e.loop.startAt,
                          "loopstart"
                        )),
            ...
            transitionProperties: {
              ...
              clip: {
                ...
                none: {
                  ...
                  css: {
                    clipPath:
                      "polygon(-9999% -9999%,9999% -9999%,9999% 9999%,-9999% 9999%)",
                  },
                },
              },
              filter: {
          ...
          for (
            ...
            if (
              ...
              r
                ...
                .appendTo(J.slider.$hiddenWrapper),
              r.data("ls"))
            )
                  ...
                  "" !== h[0] &&
                    (void 0 !== i[h[0]]
                      ? ((p = void 0 === i[h[0]][1] ? h[0] : i[h[0]][1]),
                        (u = J.functions.convert.properties(h[1])),
              ...
              for (var m in n.plugins)
                if (r.data("ls-plugin-" + m)) {
                  ...
                  for (var v = 0; v < g.length; v++) {
                    ...
                    (S[0] = ie.trim(S[0])),
                      "" !== S[0] &&
                        ((w = J.functions.convert.properties(ie.trim(S[1]))),
                        (-1 === S[0].indexOf("duration") &&
                          -1 === S[0].indexOf("delay")) ||
                          (w /= 1e3),
                        y[S[0]]
                          ? (n.plugins[m][y[S[0]]] = w)
                ...
                n.data.$backgroundVideo
                  ...
                  ? (n.data.$backgroundVideo
                    ...
                    n.data.$backgroundVideo.append(
                      ie('<div class="ls-bg-video-overlay"></div>')
                    ))
                  : (n.data.$backgroundVideo = !1));
            for (var b = r.find("picture"), v = 0, x = b.length; v < x; v++)
              J.layers.set.pictureElement(ie(b[v]));
            r.find("> .ls-bg").length &&
              ...
              n.data.thumbnail ||
                ...
                l
                  ? ((n.data.thumbnail = J.functions.getURL(l)),
                    (n.data.tnAlt = J.functions.getALT(l)))
                  : (n.data.thumbnail =
                      J.o.skinsPath + J.o.skin + "/nothumb.png")),
              ...
              n.data.backgroundColor
                ...
                : (n.data.backgroundColor =
                    "" === r[0].style.backgroundColor
                      ...
                      : r[0].style.backgroundColor),
              (J.slides[++t] = {}),
              (J.slides[t].data = ie.extend(
                !0,
                {},
                J.defaults.slide.options.data,
                n.data
              )),
              (J.slides[t].parallax = n.parallax),
              (J.slides[t].scroll = n.scroll),
              (J.slides[t].kenBurns = n.kenBurns),
              (J.slides[t].filter = n.filter),
              (J.slides[t].index = t),
              (J.slides[t].$layers = ie()),
              (J.slides[t].plugins = n.plugins),
              J.slider.thumbnails.push(n.data.thumbnail),
              J.layers.init(r, t);
          }
        ...
        set: {
          slideIndexes: function () {
            ...
            (e.prev.index = e.current.index),
              ...
              (e.next.index = J.slideshow.get.slideInSequence(
                J.slideshow.direction
              )),
              e.set.slidesData(),
              J.slider.set.attributes();
          },
          ...
          slidesData: function () {
            var e = J.slides;
            (e.prev =
              -1 !== e.prev.index ? ie.extend(!0, {}, e[e.prev.index]) : {}),
              (e.current =
                -1 !== e.current.index
                  ? ie.extend(!0, {}, e[e.current.index])
                  : {}),
              (e.next =
                -1 !== e.next.index ? ie.extend(!0, {}, e[e.next.index]) : {});
          },
          firstSlide: function () {
            var e,
              t = J.slides;
            (t.first.index =
              "random" === J.o.firstSlide
                ? J.o.firstSlide
                : Math.max(
                    J.functions.convert.properties(J.o.firstSlide, !0),
                    1
                  )),
              J.o.shuffleSlideshow && 2 < J.slides.count
                ? (J.o.twoWaySlideshow = !1)
                : (J.o.shuffleSlideshow = !1),
              (t.first.index =
                "random" == t.first.index
                  ? Math.floor(Math.random() * J.slides.count + 1)
                  : t.first.index),
              !document.location.hash ||
                ((e = J.slides.deeplink(document.location.hash, !0)) &&
                  (J.slides.first.index = e)),
              (t.first.index =
                t.first.index < 1 || t.first.index > J.slides.count
                  ? 1
                  : t.first.index),
              J.o.shuffleSlideshow &&
                "random" != J.o.firstSlide &&
                (t.first.index = J.o.firstSlide),
              t[t.first.index] &&
                t[t.first.index].data &&
                (t.first.data = ie.extend(!0, {}, t[t.first.index].data)),
              J.o.playByScroll && J.slideshow.set.normalizedSequence(),
              J.debugMode &&
                J.debug.options.firstSlide &&
                (t.first.index = J.debug.options.firstSlide);
          },
      ...
      (J.layers = {
        ...
        init: function (e, t) {
          ...
          for (
            ...
            o.is("a") &&
              ...
              o.data(
                J.defaults.init.dataKey,
                new J.defaults.layer.options(o, t)
              ),
              ...
              (J.slides[t].$layers = J.slides[t].$layers.add(i));
          }
        },
        set: {
          ...
          smartLinks: function (e) {
            ...
            if (t && -1 !== t.indexOf("ls-scroll")) {
              ...
              J.layers.set.ariaLabel(e, i),
                e.on("click." + B, function (e) {
                  e.preventDefault();
                  var t,
                    i = document.body.scrollHeight - te.viewport.height;
                  if (s)
                    switch (s) {
                      case "pagetop":
                        t = 0;
                      ...
                      case "sliderbottom":
                        ...
                        break;
                      default:
                        t = ie(s).filter(":visible").last().length
                          ? ie(s).filter(":visible").last().offset().top
                          : J.slider.offset.top + J.slider.height;
                    }
                  (t += J.o.scrollModifier),
                    (t = Math.min(t, i)),
                    (t = Math.max(0, t)),
                    ee.TweenMax.to("html, body", 1, {
                      scrollTop: t,
            ...
            if (
              -1 !== J.defaults.init.controls.indexOf(s.toLowerCase()) ||
              s.match(/^\#[0-9]/)
            ) {
              ...
              J.layers.set.ariaLabel(e, i),
                e.on("click." + B, function (e) {
                  if (
                    ...
                    J.navigation[a]("clicked");
                  else if ("number" == typeof r && r == r)
                    J.slideshow.changeTo(r, !0, !0);
                  else if (!J.slider.state.changingSlides)
                    switch (a) {
                      case "replay":
          ...
          linkTo: function (e) {
            ...
            (e.data(J.defaults.init.dataKey).settings.linkedToSlide = i),
              e.css({ cursor: "pointer" }).on("click." + B, function (e) {
                e.preventDefault(),
                  $.layerSlider(
                    ie(this).data(J.defaults.init.dataKey).settings
                      .linkedToSlide
                  );
              });
          },
          wrappers: function (e, t, i) {
            t.is.slideBackground || t.is.backgroundVideo
              ...
              t.scroll.enabled &&
                ...
                t.elements.$scrollWrapper.data(J.defaults.init.dataKey, {
                  scroll: {},
                }),
                (t.settings.scrollWrapperData = t.elements.$scrollWrapper.data(
                  J.defaults.init.dataKey
                )),
                J.transitions.layers.scroll.addLayer(
              ...
              t.hover.enabled &&
                !J.slides[i].data.globalhover &&
                J.transitions.layers.hover.set(e, t),
              (t.elements.$outerWrapper = e.closest(".ls-z")),
              (t.elements.$outerStyleWrapper =
                t.elements.$outerWrapper.find("> .ls-wrapper")),
              t.settings.trmask &&
                t.elements.$outerStyleWrapper.css("overflow", "hidden"),
          ...
          singleLayer: function (e, t) {
            J.layers.set.style(e),
              J.layers.set.properties(e, t),
              J.layers.set.dataAttribute("add", e, "hidden"),
              e.data("hasBeenSet", !0);
          },
          style: function (e) {
            var t,
              ...
              x =
                "" !== m.paddingLeft
                  ? f.getStyle(m.paddingLeft, J.slider.initial.percW)
                  : f.getStyle(e.css("padding-left"), J.slider.initial.percW),
              T =
                "" !== m.paddingRight
                  ? f.getStyle(m.paddingRight, J.slider.initial.percW)
                  : f.getStyle(e.css("padding-right"), J.slider.initial.percW),
              k =
                "" !== m.paddingTop
                  ? f.getStyle(m.paddingTop, J.slider.initial.percH)
                  : f.getStyle(e.css("padding-top"), J.slider.initial.percH),
              C =
                "" !== m.paddingBottom
                  ? f.getStyle(m.paddingBottom, J.slider.initial.percH)
                  : f.getStyle(e.css("padding-bottom"), J.slider.initial.percH),
              P =
                "" !== m.marginLeft
                  ? f.getStyle(m.marginLeft, J.slider.initial.percW)
                  : f.getStyle(e.css("margin-left"), J.slider.initial.percW),
              O =
                "" !== m.marginRight
                  ? f.getStyle(m.marginRight, J.slider.initial.percW)
                  : f.getStyle(e.css("margin-right"), J.slider.initial.percW),
              I =
                "" !== m.marginTop
                  ? f.getStyle(m.marginTop, J.slider.initial.percH)
                  : f.getStyle(e.css("margin-top"), J.slider.initial.percH),
              L =
                "" !== m.marginBottom
                  ? f.getStyle(m.marginBottom, J.slider.initial.percH)
                  : f.getStyle(e.css("margin-bottom"), J.slider.initial.percH);
            (u.style.margin = "0"),
              (r =
                "" !== m.borderLeftWidth
                  ? f.getStyle(m.borderLeftWidth, J.slider.initial.percW)
                  : f.getStyle(
                      e.css("border-left-width"),
                      J.slider.initial.percW
                    )),
              (n =
                "" !== m.borderRightWidth
                  ? f.getStyle(m.borderRightWidth, J.slider.initial.percW)
                  : f.getStyle(
              ...
              (o =
                "" !== m.borderTopWidth
                  ? f.getStyle(m.borderTopWidth, J.slider.initial.percH)
                  : f.getStyle(
                      e.css("border-top-width"),
                      J.slider.initial.percH
                    )),
              (l =
                "" !== m.borderBottomWidth
                  ? f.getStyle(m.borderBottomWidth, J.slider.initial.percH)
                  : f.getStyle(
                      e.css("border-bottom-width"),
                      J.slider.initial.percH
                    )),
              (1 !== J.media.properties.$allMediaLayers.filter(e).length &&
                !e.children("iframe").length) ||
                ((p = (c = e.children()).attr("width")
                  ? c.attr("width")
                  : c.width()),
                ($ = c.attr("height") ? c.attr("height") : c.height()),
                300 === parseInt(p) &&
                  150 === parseInt($) &&
                  ((p = 640), ($ = 360)),
            ...
            e.is("img") &&
                ...
                ($.width && $.height
                  ? ((t =
                      -1 === $.width.indexOf("%")
                        ? parseInt($.width)
                        : ((g = parseInt($.width)),
                          f.getStyle($.width, J.slider.initial.percW))),
                    (i =
                      -1 === $.height.indexOf("%")
                        ? parseInt($.height)
                        : ((y = parseInt($.height)),
                          f.getStyle($.height, J.slider.initial.percH))))
                  : $.maxWidth &&
                    ((e[0].style.width = $.maxWidth + "px"),
                    (t = $.maxWidth),
                    (i = e.height())))),
              (c = S.width ? S.width / b : (S.right - S.left) / b),
              (b = S.height ? S.height / b : (S.bottom - S.top) / b),
              t ||
                ((t = m.width),
                ...
                (t =
                  (t =
                    "" !== t && "auto" !== t
                      ? f.getStyle(t, J.slider.initial.percW)
                      : c -
                        J.layers.toNum(x, w) -
                        J.layers.toNum(T, w) -
                        J.layers.toNum(r, w) -
                        J.layers.toNum(n, w)) || "auto")),
              i ||
                ((i = m.height),
                ...
                (i =
                  (i =
                    "" !== i && "auto" !== i
                      ? f.getStyle(i, J.slider.initial.percH)
                      : b -
                        J.layers.toNum(k, w) -
                        J.layers.toNum(C, w) -
                        J.layers.toNum(o, w) -
                        J.layers.toNum(l, w)) || "auto")),
              0 === parseInt(i) &&
                (e.addClass("ls-force-height-auto"),
                parseInt(u.getBoundingClientRect().height),
                e.addClass("ls-force-height-auto")),
              ...
              (a = m.clipPath || m.clip || !1) &&
                ((h.clip.style.css.clipPath = a),
                (h.clip.userDefined = !0),
                (m.clip = ""),
                (m.clipPath = "")),
                  ...
                  (-1 === M.borderRadius.indexOf("/")
                    ? ie.each(
                        ...
                        function (e, t) {
                          (e = M[W[e]]),
                            (t = B.css(t)),
                            (t = ie.trim(void 0 !== e && e.length ? e : t));
                          -1 == t.indexOf(" ") &&
                            -1 == t.indexOf("em") &&
                            -1 == t.indexOf("%") &&
                            (t = parseInt(t)),
          ...
          parseScaleProperties: function (e) {
            for (
              var t = [
                  { x: "scalexin", y: "scaleyin", s: "scalein" },
                  { x: "textscalexin", y: "textscaleyin", s: "textscalein" },
                  { x: "loopscalex", y: "loopscaley", s: "loopscale" },
                  { x: "textscalexout", y: "textscaleyout", s: "textscaleout" },
                  { x: "scalexout", y: "scaleyout", s: "scaleout" },
                  { x: "hoverscalex", y: "hoverscaley", s: "hoverscale" },
                ],
                i = 0;
              i < t.length;
              i++
              ...
              e[s.x] &&
                e[s.y] &&
                e[s.x] === e[s.y] &&
                ((e[s.s] = e[s.x]), delete e[s.x], delete e[s.y]);
            }
            return e;
          },
          properties: function (e, t, i) {
            ...
            if (
              ...
              for (
                ...
                ie.trim(d[p]) &&
                  ((a = d[p].indexOf(":")),
                  (r = d[p].substring(0, a).trim()),
                  (o = d[p].substring(a + 1).trim()),
                  r && (c[r] = o));
              for (n in ((d = null), (c = this.parseScaleProperties(c)))) {
                ...
                if (
                  ((r = n.toLowerCase()),
                  (o = c[n]),
                  -1 == ["thumbnail", "poster"].indexOf(r) &&
                    (o = o.toLowerCase()),
                  (r = r.replace("split", "text")).match(/(text)/) && (y = !0),
                  void 0 !== l[r])
                ) {
                  if (
                    ((u = l[r][0]),
                    (f = o),
                    "overlay" !== r && (f = J.functions.convert.properties(o)),
                    -1 !== r.indexOf("mirror") &&
                      (f = J.layers.set.mirrorTransitions(o)),
                    !o ||
                      (-1 === o.indexOf("random") &&
                        o.charAt(0) !== J.defaults.init.openingBracket) ||
                      (g = !0),
                    g &&
                      (y ||
                        -1 !== r.indexOf("offset") ||
                        (f = J.functions.convert.randomProperties(f, u, e, s)),
                      s.should.update || (s.should.update = !0)),
                    "number" == typeof f &&
                      u.match(/(duration|startat|shift|delay)/i) &&
                      (f /= 1e3),
                    r.match(/(fade)(.+)/))
                  )
                    switch (f) {
                  ...
                  void 0 !== (m = l[r][1])
                    ? "" !== f
                      ? "object" == typeof f && -1 == r.indexOf("mirror")
                        ? r.match(/(text)/)
                          ? m.match(/(converted)/i)
                            ? (s[m][u] = f)
                            : (s[m].cycle[u] = f)
                          : ((h = J.functions.convert.properties(
                              ie.trim(f[0])
                            )),
                            J.debugMode &&
                              J.debug.add("warn", "layerInit.prop1", [r, f, h]),
                            "number" == typeof h &&
                              u.match(/(duration|startat|shift|delay)/i) &&
                              (h /= 1e3),
                            (s[m][u] = h))
                        ...
                        ? (s[m].random[u] = f)
                        : (s[m][u] = f)
                      : J.debugMode && J.debug.add("warn", "layerInit.prop2", r)
                    : (s[u][r] = f);
                } else
                  "clip" === r
                    ? ((s.original.clip = o), (s.clip.style.css.clipPath = o))
                    : J.debugMode && J.debug.add("warn", "layerInit.prop4", r);
              }
            }
            if (
              (J.browser.isOld &&
              ...
              s.in.enabled &&
                (s.inLayerTo.ease =
                  ...
                  s.inClipTo.ease =
                    J.functions.convert.easing(s.in.ease)),
              ...
              s.out.enabled &&
                (s.outLayerTo.ease =
                  ...
                  s.outClipTo.ease =
                    J.functions.convert.easing(s.out.ease)),
              ie.isNumeric(s.loop.count) &&
              (0 < s.loop.count || -1 === s.loop.count) &&
              !1 !== s.loop.enabled
                ? ((s.loop.enabled = !0),
                  (s.loopTo.ease = s.loopClipTo.ease =
                    J.functions.convert.easing(s.loop.ease)),
                  -1 !== s.loop.count
                    ? s.loop.yoyo
              ...
              !1 !== s.hover.enabled
                ? ((s.hover.enabled = !0),
                  ...
                  (s.hover.easeIn = J.functions.convert.easing(s.hover.easeIn)),
                  (s.hover.easeOut = J.functions.convert.easing(
                    s.hover.easeOut,
                    !0
                  )),
                  s.hover.durationOut ||
                ...
                : (s.hover.enabled = !1),
              s.parallax.level &&
              ie.isNumeric(s.parallax.level) &&
              0 !== s.parallax.level &&
              !1 !== s.parallax.enabled
                ? ((s.parallax.enabled = !0),
                  s.parallax.reset && e.attr("data-ls-parallax-reset", ""))
                : (s.parallax.enabled = !1),
              s.is.slideBackground)
            ) {
              var v = { scale: 1, rotation: 0 };
              if (
                (J.slides[t].kenBurns.zoom &&
                  (s.kenBurns = J.slides[t].kenBurns),
                s.kenBurns.zoom)
              ) {
                switch (
                  ((s.kenBurns.from = {}),
              ...
              ie.isEmptyObject(J.slides[t].filter) ||
                (J.slides[t].filter.from &&
                  (s.filter.values.bgFrom =
                    J.transitions.layers.filters.convert(
                      J.slides[t].filter.from
                    )),
                J.slides[t].filter.to &&
                  (s.filter.values.bgTo = J.transitions.layers.filters.convert(
                    J.slides[t].filter.to
                  )));
            }
            if (
              (s.textIn.type &&
                -1 === J.defaults.layer.splitTypeKeys.indexOf(s.textIn.type) &&
                (J.debugMode &&
                  J.debug.add("warn", "layerInit.splitType3a", [
                    e[0].tagName,
                    s.textIn.type,
                  ]),
                ...
                (s.textIn.enabled = !1)),
              s.textOut.type &&
                -1 === J.defaults.layer.splitTypeKeys.indexOf(s.textOut.type) &&
                (J.debugMode &&
                  J.debug.add("warn", "layerInit.splitType3b", [
                    e[0].tagName,
                    s.textOut.type,
                  ]),
              ...
              if (
                (s.is.textLayer
                  ? (s.textIn.type &&
                      ((s.textIn.enabled = !0),
                      (s.textInNodesTo.ease = J.functions.convert.easing(
                        s.textInNodesTo.ease
                      )),
                      (s.textIn.split = s.textIn.type.split("_")[0]),
                      e.children().length && J.debugMode && (w = 1)),
                    s.textOut.type &&
                      !J.o.inLayerPreview &&
                      (s.textOut.enabled = !0),
                    s.textOut.enabled &&
                      (s.textOutNodesTo.ease = J.functions.convert.easing(
                ...
                switch (w) {
                  case 1:
                    J.debug.add("warn", "layerInit.splitType1", [
                      e.prop("nodeName"),
                      t,
                    ]);
                    break;
                  case 2:
                    J.debug.add("warn", "layerInit.splitType2", [
                      t,
                      e.prop("nodeName"),
                    ]);
                }
            }
            (s.inClipFromCSS.clipPath ||
              s.outClipToCSS.clipPath ||
              s.loopClipToCSS.clipPath ||
              s.clip.style.css.clipPath !== s.clip.default.css.clipPath) &&
              (s.clip.enabled = !0),
              s.textIn.enabled &&
                "textmask" === s.textInLayerStyle.overflow &&
                e.attr("data-ls-mask-text-in", ""),
              s.textOut.enabled &&
                "textmask" === s.textOutLayerStyle.overflow &&
                e.attr("data-ls-mask-text-out", ""),
              s.in.enabled &&
                s.inLayerToCSS.hasOwnProperty("scale") &&
                (delete s.inLayerToCSS.scaleX, delete s.inLayerToCSS.scaleY),
              s.out.enabled &&
                s.outLayerToCSS.hasOwnProperty("scale") &&
                (delete s.outLayerToCSS.scaleX, delete s.outLayerToCSS.scaleY),
              s.inLayerStyleShouldBeConvertedFrom.filter &&
                (s.filter.values.in = J.transitions.layers.filters.convert(
                  s.inLayerStyleShouldBeConvertedFrom.filter
                )),
              (s.filter.values.style = J.transitions.layers.filters.convert(
                s.original.filter
              )),
              s.outLayerStyleShouldBeConvertedTo.filter &&
                (s.filter.values.out = J.transitions.layers.filters.convert(
                  s.outLayerStyleShouldBeConvertedTo.filter
                )),
              s.loopLayerShouldBeConverted.filter &&
                (s.filter.values.loop = J.transitions.layers.filters.convert(
                  s.loopLayerShouldBeConverted.filter
                )),
              s.hoverShouldBeConverted.filter &&
                (s.filter.values.hover = J.transitions.layers.filters.convert(
                  s.hoverShouldBeConverted.filter
                )),
              ...
              void 0 !== s.settings.static && "none" !== s.settings.static
                ? (0 !== (w = parseInt(s.settings.static)) &&
                  "forever" !== s.settings.static
                    ? (e.attr("data-ls-slideout", w), (s.settings.slideOut = w))
              ...
              s.is.mediaLayer &&
                ...
                J.media.html5.singleInit(e.children("video, audio").eq(0)),
              s.is.backgroundVideo &&
              ...
              J.slider.isPopup && (s.is.pinned = !1),
              s.is.pinned &&
                ((J.slider.hasPinnedLayers = !0),
                J.slider.$layersWrapper.is(".ls-layers-clip") ||
                  J.slider.$layersWrapper.addClass("ls-layers-clip"),
                (!te.isMobile && !J.browser.isSafari) ||
                  J.slider.$layersWrapper.is(".ls-m-layers-clip") ||
                  J.slider.$layersWrapper.addClass("ls-m-layers-clip")),
              s.styleSettings.smartbg &&
                (e
                  .attr("data-ls-smart-bg", "")
                  .css("--bgs", s.original.backgroundSize),
                (s.styleSettings.smartbg = s.styleSettings.smartbg.toString()),
                (s.is.smartBG = !0));
          },
        ...
        update: {
          data: function (e, t, i) {
            var s, a, r;
            switch (
              (e instanceof jQuery || (e = ie(e)),
              i && e.attr("data-ls", i).data("ls", i),
              (s = (a = e.data(J.defaults.init.dataKey)).is.onSlide),
              (r = a.original),
              t)
            ) {
              default:
              ...
              case "all":
                e.data(
                  J.defaults.init.dataKey,
                  new J.defaults.layer.options(e, s)
                ),
        ...
        wrap: function (u, e) {
          var t, h;
          J.slides[u].wrapped ||
            "wrapping" === J.slides[u].wrapped ||
            ((J.slides[u].wrapped = "wrapping"),
            (t = e ? 25 : 0),
            (e = J.slides[u].$layers),
            0 === (h = e.length)
              ? (J.slides[u].wrapped = !0)
              : e.each(function (c, p) {
                  J.timeouts["slide-" + u + "-layer-" + c] = setTimeout(
                    function () {
                      ...
                      var r,
                        o,
                        n,
                        l = e.data(J.defaults.init.dataKey);
                      if (!l) return !0;
                      (d = e.data("$layerGroup") || J.slider.$layersWrapper),
                        l.is.backgroundVideo
                          ? (d = J.slider.$bgVideosWrapper)
                          : l.is.slideBackground &&
                            (d = J.slider.$slideBGWrapper),
                        e.data("hasBeenSet") || J.layers.set.singleLayer(e, u),
                        l.textIn.split &&
                          ((n = new ee.SplitType(e[0], {
                            ...
                            : (l.clip.enabled &&
                              ...
                              l.scroll.enabled &&
                                (i =
                                  ...
                                  i +
                                  "</div></div>"),
                              '<div class="ls-wrapper ls-in-out" style="">' +
                                i +
                                "</div>")),
                        l.parallax.enabled &&
                          (i =
                      ...
                      l.is.backgroundVideo || l.is.slideBackground
                        ...
                        J.browser.isSafari && (d.transform = "translateZ(0)"),
                        J.layers.set.wrappers(e, l, u),
                        ...
                        (J.layers.$all = J.layers.$all.add(e)),
                        (J.slides[u].$layers = J.slides[u].$layers.not(t)),
                        c === h - 1 &&
                          ($.children(".ls-slide")
                            .eq(u - 1)
                            .empty(),
      ...
      (J.slideshow = {
        ...
        init: function () {
          1 == J.slides.count &&
            ...
            (J.o.autoStart && 1 != J.slides.count) ||
              J.functions.setStates(this, { running: !1, paused: !0 }),
        ...
        set: {
          pauseOnHover: function () {
            (J.o.pauseOnHover =
              !0 === J.o.pauseOnHover ? "slideshowOnly" : J.o.pauseOnHover),
              !1 !== J.o.pauseOnHover &&
                $.on("mouseenter." + B, function () {
                  J.slider.state.inFullscreen ||
                    (J.functions.setStates(J.slideshow, { pausedByHover: !0 }),
                    "slideshowOnly" !== J.o.pauseOnHover &&
                      J.transitions.layers.timeline.pause());
                }).on("mouseleave." + B, function () {
                  var e = 1;
                  J.transitions._slideTimeline &&
                    J.transitions._slideTimeline.duration() >
                      J.transitions.layers.timeline.totalDuration &&
                    (e =
                      J.transitions.layers.timeline.totalDuration /
                      J.transitions._slideTimeline.duration()),
                    J.functions.setStates(J.slideshow, { pausedByHover: !1 }),
                    ie("body").hasClass("ls-unselectable") ||
                      "slideshowOnly" === J.o.pauseOnHover ||
                      (J.o.pauseLayers && J.slideshow.isPaused()) ||
                      J.transitions.layers.timeline.resume(),
                    J.transitions._slideTimeline &&
                      J.transitions.layers.timeline.state.finished &&
                      J.transitions._slideTimeline.progress() < e &&
          ...
          sequences: function () {
            for (var e = 0; e < J.slides.count; e++)
              J.slideshow.sequence.normal[e] = e + 1;
            J.slideshow.sequence.randomized = J.functions.shuffleArray(
              ie.merge([], J.slideshow.sequence.normal)
            );
          },
          normalizedSequence: function () {
            ...
            for (var a = s; a < i; a++)
              J.slideshow.sequence.normalized.push(t[a]);
            for (var r = 0; r < s; r++)
              J.slideshow.sequence.normalized.push(t[r]);
          },
          prevNext: function (e) {
            switch (
              (("prev" !== e && "first" !== e) || !J.o.twoWaySlideshow
                ? (J.slideshow.direction = "next")
                : (J.slideshow.direction = "prev"),
              e)
            ) {
              case "prev":
                J.slideshow.changeTo(
                  J.slideshow.get.slideInSequence("prev"),
                  !0
                );
                break;
              case "next":
                J.slideshow.changeTo(
                  J.slideshow.get.slideInSequence("next"),
                  !0
                );
                break;
              case "first":
        ...
        get: {
          sequence: function () {
            ...
            return (
              J.o.playByScroll
                ? (e = "normalized")
                : J.o.shuffleSlideshow && (e = "randomized"),
              e
            );
          },
        ...
        cycles: {
          set: function () {
            0 < J.o.cycles &&
              ((J.slideshow.curCycle = 1),
              (J.slideshow.cycleSlideIndex =
                J.slideshow.get.indexOfSlideInSequence(J.slides.first.index)));
          },
          check: function (e) {
            if (
              J.slideshow.get.indexOfSlideInSequence(e) ===
              J.slideshow.cycleSlideIndex
            )
              return ++J.slideshow.curCycle === J.o.cycles + 1;
          },
        },
        start: function (e) {
          !this.isPaused() &&
            J.transitions._slideTimeline &&
            J.transitions.layers.timeline.state.finished &&
            this.changeTo(J.slides.next.index);
        },
        stop: function () {
          J.functions.setStates(this, { running: !1, paused: !0 });
        },
        changeTo: function (e, t, i) {
          if (!document.body.contains(L)) return !1;
          if (J.slides.current.index === e && !J.slideshow.forceSlideChangeTo)
            return !1;
          if (
            ((J.slideshow.forceSlideChangeTo = null),
            !this.firstStart && J.api.hasEvent("slideChangeWillStart"))
          ) {
            var s = J.api.triggerEvent(
          ...
          e > J.slides.count || e < 1
            ? J.debugMode &&
              (J.debug.add("group", "slideshow"),
              J.debug.add("warn", "slideshow.invalidSlideIndex", [
                e,
                J.slides.count,
              ]),
              J.debug.groupEnd())
            : J.slider.isBusy() || (J.slideshow.state.pausedByVideo && !t)
            ? !J.slider.state.preloadingImages &&
              J.slider.state.animatingSlides &&
              J.transitions._slideTransition &&
              ((J.slideshow.forceSlideChangeTo = e),
              (J.slideshow.should.change = !0),
              J.transitions._slideTransition.progress(1),
              J.transitions.timelines.set("currentforce", function (e, t) {
                e.progress(1);
              }))
            : (J.functions.setStates(J.transitions.layers.timeline, {
                finished: !1,
              }),
              (J.slideshow.should.change = !1),
              J.debugMode && J.debug.add("group", "slideshow"),
              t
                ? (i &&
                    (J.navigation.direction =
                      J.slides.current.index > e ? "prev" : "next"),
                  J.o.twoWaySlideshow &&
                    ("prev" === J.navigation.direction
                      ? (J.slideshow.direction = "prev")
                      : (J.slideshow.direction = "next")),
                  J.debugMode &&
                    (J.debug.add("log", "slideshow.changedByUser", !1),
                    J.o.twoWaySlideshow &&
                      J.debug.add(
                        "log",
                        "slideshow.setdir",
                ...
                : (J.navigation.direction = J.slideshow.direction),
              J.transitions.timers.reverse(),
              J.gui.media.hideUnmute(),
              J.slides.set.nextSlideIndex(e),
              J.debugMode &&
                (J.debug.add("log", "slideshow.change", [
                  J.slides.current.index,
                  J.slides.next.index,
                  J.slideshow.direction,
                  J.navigation.direction,
              ...
              J.functions.setStates(J.slider, { changingSlides: !0 }),
              J.slider.state.animatingSlides &&
                J.transitions._slideTransition &&
                J.transitions.timelines.set("currentforce", function (e, t) {
                  e.progress(1);
        ...
        forceStop: function () {
          J.navigation.stop(),
            ie.each(J.timeouts, function (e, t) {
              clearTimeout(J.timeouts[e]);
            }),
            J.transitions.timers.stop(),
            J.transitions._slideTimeline.stop(),
            J.transitions._slideTimelineAlternate.stop(),
            J.functions.setStates(J.transitions.layers.timeline, {
              stopped: !0,
              running: !1,
            }),
        ...
        restart: function () {
          $.find("*").stop(),
            J.navigation.change(J.slides.current.index, J.slideshow.direction);
        },
      }),
      (J.media = {
        properties: {
        ...
        init: function () {
          J.functions.setStates(J.slider, {
            ...
            (J.media.properties.allowToUnmute = !0),
            J.media.youtube.init(),
            J.media.vimeo.init(),
            J.media.html5.init();
        },
        ...
        get: function (e) {
          var t,
            i = J.media.properties.$allMediaLayers;
          return (
            e &&
        ...
        set: {
          backgroundVideo: function (e, t) {
            0 === e.children(".ls-vpcontainer").length &&
              ((e = ie("<div>").addClass("ls-vpcontainer").appendTo(e)),
          ...
          dataAttribute: function (e, t) {
            e.removeAttr("data-ls-playing data-ls-not-playing"),
              e.attr("data-ls-" + t, ""),
              J.media.functions.checkSlideshowWaiting();
          },
          mediaElements: function (e, t, i) {
            var s = ie("<div>").addClass("ls-vpcontainer").appendTo(e);
            (!("autoplay" in i.mediaSettings) && J.o.autoPlayVideos) ||
            i.mediaSettings.autoplay
              ? "instant" === i.mediaSettings.autoplay
                ? e.addClass("ls-instant-autoplay")
                : e.addClass("ls-autoplay")
              : ie("<div>").appendTo(s).addClass("ls-playvideo"),
              t.is("iframe") &&
            ...
            switch (((i.is.mediaLayer = !0), i.mediaProperties.type)) {
              case "youtube":
                i.is.backgroundVideo
                  ? ((i.mediaProperties.options = ie.extend(
                      !0,
                      {
                        loop: 1,
                      ...
                      J.media[i.mediaProperties.type].defaults,
                      i.mediaProperties.embedOptions
                    )),
                    J.media.set.backgroundVideo(e, i))
                  : ((i.mediaProperties.options = ie.extend(
                      !0,
                      {},
                      J.media[i.mediaProperties.type].defaults,
          ...
          thumbnail: function (e, t) {
            switch (t) {
              ...
              case "hide":
                e.stop(!0, !0)
                  .delay(J.transitions.media.defaults.delay)
                  .fadeOut(J.transitions.media.defaults.fadeOut);
            }
          },
        },
        events: {
          start: function (e, t, i) {
            var s;
            J.api.hasEvent("mediaDidStart") &&
              !i.mediaProperties.alreadyStarted &&
              J.media.functions.allowedToPlay(e, i) &&
              (((s = J.api.eventData()).event.target = e[0]),
              J.api.triggerEvent("mediaDidStart", s),
              (i.mediaProperties.alreadyStarted = !0));
          },
          stop: function (e, t, i) {
            var s;
            J.api.hasEvent("mediaDidStop") &&
              i.mediaProperties.alreadyStarted &&
              (((s = J.api.eventData()).event.target = e[0]),
              J.api.triggerEvent("mediaDidStop", s),
        ...
        unmute: {
          set: function (e, t, i) {
            (("youtube" !== t && "vimeo" !== t) ||
              J.media.properties.allowToUnmute) &&
              J.gui.media.showUnmute(),
          ...
          multipleMediaElements: function () {
            ...
            (J.o.rememberUnmuteState
              ...
              J.gui.media.hideUnmute(),
              (J.media.properties.userDidUnmute = !0);
          },
          singleMediaElement: function (e) {
            var t,
              i = e.closest(".ls-layer").data(J.defaults.init.dataKey),
              s = !1;
        ...
        functions: {
          allowedToPlay: function (e, t) {
            ...
            return !!(
              J.slides.current.index === parseInt(e.attr("data-ls-slidein")) ||
              (t.is.backgroundVideo &&
                J.slides.next.index === parseInt(e.attr("data-ls-slidein"))) ||
          ...
          stopSingleMedia: function (e, t) {
            ...
            J.media[t.mediaProperties.type].stop(e, i, t, !0),
              J.media.functions.mediaEnded(i, e, t);
          },
              ...
              e &&
                e
                  ...
                  .replace(/([^=&]+)=([^&]*)/g, function (e, t, i) {
                    s[decodeURIComponent(t)] = ie.isNumeric(
          ...
          checkSlideshowState: function (e, t) {
            !t.is.static &&
              J.o.autoPauseSlideshow &&
              (J.functions.setStates(J.slideshow, { pausedByVideo: !0 }),
              "auto" == J.o.autoPauseSlideshow &&
                J.media.properties.playingInCurSlide++);
          },
          checkSlideshowWaiting: function () {
            ...
            i === e &&
            0 < i &&
            J.slideshow.state.pausedByVideo &&
            J.o.autoPauseSlideshow &&
            !J.timeouts.pausedVideos &&
            J.slideshow.state.running
              ? (J.timeouts.pausedVideos = setTimeout(function () {
                  J.slideshow.state.running
                    ? t.each(function () {
                        J.media.functions.mediaEnded(
                          ie(this),
                          ie(this).closest(".ls-layer"),
                          ie(this)
                            .closest(".ls-layer")
                            .data(J.defaults.init.dataKey)
                        );
              ...
              : J.timeouts.pausedVideos &&
                (clearTimeout(J.timeouts.pausedVideos),
                delete J.timeouts.pausedVideos);
          },
          playIfAllowed: function (e) {
            ...
            t.is.mediaLayer &&
              ((te.isMobile &&
                ...
                (("autoplay" in t.mediaSettings || !J.o.autoPlayVideos) &&
          ...
          stop: function (s) {
            ...
            J.layers.get("current,out,youtube").each(function () {
              ...
              (J.media.properties.playingInCurSlide = 0),
              (J.media.properties.endedInCurSlide = 0);
          },
          mediaEnded: function (e, t, i) {
            "auto" != J.o.autoPauseSlideshow ||
              i.is.backgroundVideo ||
              (i.is.static || J.media.properties.endedInCurSlide++,
              J.media.properties.endedInCurSlide ==
                J.media.properties.playingInCurSlide &&
                0 !== J.media.properties.playingInCurSlide &&
                J.functions.setStates(J.slideshow, { pausedByVideo: !1 })),
              J.media.set.dataAttribute(e, "not-playing"),
              J.media.events.stop(e, t, i);
          },
          removeFromTimeline: function (e) {
            J.transitions._slideTimeline.kill(null, e.closest(".ls-in-out")[0]),
              J.transitions._slideTimelineAlternate.kill(
                null,
        ...
        youtube: {
          ...
          init: function () {
            var f = 0;
            (this.$medias = J.slider.$hiddenWrapper
              .find(
                'iframe[src*="youtube-nocookie.com"], iframe[src*="youtube.com"], iframe[src*="youtu.be"], iframe[data-src*="youtube-nocookie.com"], iframe[data-src*="youtube.com"], iframe[data-src*="youtu.be"]'
              )
              .each(function () {
                ...
                var i,
                  ...
                  l,
                  d,
                  c = t.data(J.defaults.init.dataKey),
              ...
              this.$medias.length &&
                ((J.media.properties.$allMediaLayers =
                  J.media.properties.$allMediaLayers.add(
                    this.$medias.closest(".ls-layer")
                  )),
                (J.timeouts.loadYouTube = Math.floor(Date.now() / 1e3)),
                window.YT ||
                  ie("<script>")
                    .attr({
                ...
                (J.intervals.isYouTubeReady = setInterval(function () {
                  ...
                  3 < Math.floor(Date.now() / 1e3) - J.timeouts.loadYouTube
                    ? (clearInterval(J.intervals.isYouTubeReady),
                      delete J.intervals.isYouTubeReady,
                      delete J.timeouts.loadYouTube,
                      J.media.youtube.$medias
                        .closest(".ls-layer")
                        .each(function () {
                          var e = ie(this),
                            t = e.find("iframe"),
                          ...
                          e.on(
                            ...
                            ".ls-vpcontainer",
                            function () {
                              J.media.set.thumbnail(ie(this), "hide"),
                                J.media.functions.checkSlideshowState(e, i),
                                t.hide(),
                                J.media.youtube.play(
                                  e,
                            ...
                            .on("playBackgroundVideo." + B, function () {
                              J.media.youtube.play(
                                ...
                                J.layers.set.dataAttribute("add", e, "active");
                            })
                            .on("stopBackgroundVideo." + B, function () {
                              J.media.youtube.stop(
                                e,
                                i.mediaProperties.$media,
                                i,
                                !0
                  ...
                  s.mediaProperties.player = new YT.Player(i[0], {
                    events: {
                      ...
                      onStateChange: function (e) {
                        switch (e.data) {
                          case 0:
                            (s.mediaProperties.options.loop &&
                              ...
                              J.media.functions.mediaEnded(i, t, s);
                            break;
                          case 1:
                            J.media.events.start(i, t, s),
                        ...
                        1 === e.data
                          ? J.media.set.dataAttribute(i, "playing")
                          : J.media.set.dataAttribute(i, "not-playing"),
                          J.media.youtube.savePlayerState(s, e.data);
                      },
                    },
                  });
                });
          ...
          play: function (e, t, i, s, a) {
            void 0 !== t.attr("data-ls-muted-by-browser") &&
              J.media.unmute.singleMediaElement(t),
              i.mediaProperties.player
                ? i.mediaProperties.player.playVideo
                  ? (!i.is.backgroundVideo ||
                    ...
                    i.mediaSettings.muted
                      ? (J.o.rememberUnmuteState &&
                          J.media.properties.userDidUnmute) ||
                        (i.mediaProperties.player.mute(),
                        "offertounmute" == i.mediaSettings.muted &&
                          J.media.unmute.set(t, i.mediaProperties.type))
                      : a &&
                        (i.mediaProperties.player.mute(),
                        J.media.unmute.set(t, i.mediaProperties.type, !0)),
                    J.media.functions.allowedToPlay(t, i)
                      ? J.media.isPlayable(e) &&
                        i.mediaProperties.player.playVideo()
                      : J.media.youtube.stop(e, t, i, !0))
          ...
          stop: function (e, t, i, s) {
            i.mediaProperties.player &&
              ...
              s &&
                ...
                i.mediaProperties.player.pauseVideo()),
              i.is.backgroundVideo ||
                J.media.set.thumbnail(e.find(".ls-vpcontainer"), "show"),
              J.media.events.stop(t, e, i));
          },
        },
        vimeo: {
          defaults: {
          ...
          init: function () {
            var d,
              e,
              t = (this.$medias = J.slider.$hiddenWrapper.find(
                'iframe[src*="player.vimeo"], iframe[data-src*="player.vimeo"]'
              )),
              c = J.slider.$hiddenWrapper.find(
                '.ls-slide:eq(0) iframe[src*="player.vimeo"], .ls-slide:eq(0) iframe[data-src*="player.vimeo"]'
              ).length;
            t.length &&
              ((J.timeouts.loadVimeo = Math.floor(Date.now() / 1e3)),
              (J.media.properties.$allMediaLayers =
                J.media.properties.$allMediaLayers.add(t.closest(".ls-layer"))),
              (d = 0),
              ie("<script>")
                .attr({
                ...
                .appendTo("head"),
              (J.intervals.isVimeoReady = setInterval(function () {
                J.functions.setStates(J.slider, { waitingForVimeo: !0 }),
                  (window.Vimeo ||
                    3 < Math.floor(Date.now() / 1e3) - J.timeouts.loadVimeo) &&
                    (clearInterval(J.intervals.isVimeoReady),
                    delete J.intervals.isVimeoReady,
                    delete J.timeouts.loadVimeo,
                    e());
              }, 25)),
              (e = function () {
                var l = 0;
                J.media.vimeo.$medias.each(function () {
                  ...
                  function n(e) {
                    (s.mediaProperties.poster = e),
                      ...
                      J.media.set.properties(i, t, s);
                  }
                  o
                    ? n(o)
                    : ie.getJSON(r, function (e) {
                        n(e.thumbnail_url);
                      }),
                    i
                      .on(
                        ...
                        function () {
                          J.media.set.thumbnail(ie(this), "hide"),
                            J.media.functions.checkSlideshowState(i, s),
                            J.media.vimeo.play(i, t, s, e);
                        }
                      )
                      .on("playBackgroundVideo." + B, function () {
                        J.media.vimeo.play(i, t, s, e),
                          J.layers.set.dataAttribute("add", i, "active");
                      })
                      .on("stopBackgroundVideo." + B, function () {
                        J.media.vimeo.stop(i, t, s, !0),
                          J.layers.set.dataAttribute("add", i, "hidden");
                      })
                      .on("preloadBackgroundVideo." + B, function () {
                        J.media.vimeo.createPlayer(i, t, s, e, !0);
                      });
                }),
                  J.functions.setStates(J.slider, { waitingForVimeo: !1 });
              }));
          },
          createPlayer: function (e, t, i, s, a) {
            i.mediaProperties.playerState = "initializing";
            "controls" in i.mediaSettings &&
              ((i.mediaProperties.options.controls = i.mediaSettings.controls
                ? 1
                : 0),
              delete i.mediaSettings.controls),
              "loop" in i.mediaSettings &&
                    ...
                    (J.o.rememberUnmuteState && J.media.properties.userDidUnmute
                      ...
                      : (s.mediaProperties.player.setVolume(0),
                        "offertounmute" == s.mediaSettings.muted &&
                          J.media.unmute.set(i, s.mediaProperties.type))),
                  e
                    ? (s.mediaProperties.player.setVolume(0),
                      J.media.unmute.set(i, s.mediaProperties.type, !0))
                    : s.mediaProperties.player.getVolume().then(function (e) {
                        0 == e &&
                          "offertounmute" == s.mediaSettings.muted &&
                          J.media.unmute.set(i, s.mediaProperties.type);
                      }),
                  J.media.functions.allowedToPlay(i, s)
                    ? s.mediaProperties.player
                        .play()
                        .then(function () {})
                        .catch(function (e) {
                          switch (e.name) {
                            case "PasswordError":
                              window.console &&
                                (console.error(J.defaults.slider.errorText),
                                console.error(
        ...
        html5: {
          singleInit: function (t) {
            ...
            (o.mediaProperties = {
              ...
              0 < n.length
                ? n.each(function () {
                    (void 0 !== (e = ie(this).attr("type")) && !1 !== e) ||
                      ((i = ie(this).attr("src")),
                      (s = i.split(".")),
                      (a = s[s.length - 1].toLowerCase()),
                      ie(this).attr(
                        "type",
                        ie(this).parent()[0].tagName.toLowerCase() + "/" + a
                      )),
                      "" !== t[0].canPlayType(ie(this).attr("type")) &&
              ...
              o.mediaProperties.canBePlayed &&
                ...
                r
                  .on(
                    ...
                    function (e) {
                      J.media.set.thumbnail(ie(this), "hide"),
                        J.media.functions.checkSlideshowState(r, o),
                        J.media.html5.play(r, t, o);
                    }
                  )
                  .on("playBackgroundVideo." + B, function () {
                    J.media.html5.play(r, t, o),
                      J.layers.set.dataAttribute("add", r, "active");
                  })
                  .on("stopBackgroundVideo." + B, function () {
                    J.media.html5.stop(r, t, o, !0),
                      J.layers.set.dataAttribute("add", r, "hidden");
                  }));
          },
          init: function () {
            var e,
              t = J.slider.$hiddenWrapper.find("video, audio");
            (J.media.properties.$allMediaLayers =
              J.media.properties.$allMediaLayers.add(t.closest(".ls-layer"))),
              t.length &&
                ((e = 0),
                t.each(function () {
                  (ie(this)
                    .closest(".ls-layer")
                    .data(J.defaults.init.dataKey).is.mediaLayer = !0),
                    ie(this)
                      .attr("id", "ls-html5-" + ++e)
                      .attr("playsinline", ""),
                    ie(this)[0].pause();
          ...
          stop: function (e, t, i, s) {
            i.mediaProperties.canBePlayed &&
              (t[0].pause(),
              s && (t[0].currentTime = 0),
              i.is.backgroundVideo || J.media.set.thumbnail(ie(this), "show"),
              J.media.events.stop(t, e, i));
          },
        },
      }),
        ...
        init: function () {
          J.o.yourLogo &&
            (this.$element = ie("<img>")
              ...
              .appendTo($)
              .attr("style", J.o.yourLogoStyle)
              .css({ visibility: "hidden", display: "bock" })
              .on("load." + B, function () {
                var e = J.yourLogo.$element ? 500 : 0;
                J.timeouts.yourLogo = setTimeout(function () {
                  delete J.timeouts.yourLogo,
                    J.yourLogo.$element.data(
                      "originalWidth",
                      J.yourLogo.$element.width()
                    ),
                    J.yourLogo.$element.data(
                      "originalHeight",
                      J.yourLogo.$element.height()
                    ),
                    "auto" != J.yourLogo.$element.css("left") &&
                      J.yourLogo.$element.data(
                        "originalLeft",
                        J.yourLogo.$element[0].style.left
                      ),
                    "auto" != J.yourLogo.$element.css("right") &&
                      J.yourLogo.$element.data(
                        "originalRight",
                        J.yourLogo.$element[0].style.right
                      ),
                    "auto" != J.yourLogo.$element.css("top") &&
                      J.yourLogo.$element.data(
                        "originalTop",
                        J.yourLogo.$element[0].style.top
                      ),
                    "auto" != J.yourLogo.$element.css("bottom") &&
                      J.yourLogo.$element.data(
                        "originalBottom",
                        J.yourLogo.$element[0].style.bottom
                      ),
                    !1 !== J.o.yourLogoLink &&
                      ie("<a>")
                        .appendTo($)
                        .attr("href", J.o.yourLogoLink)
                        .attr("target", J.o.yourLogoTarget)
                        .css({ textDecoration: "none", outline: "none" })
                        .append(J.yourLogo.$element),
                    J.yourLogo.$element.css({
                      display: "none",
                      visibility: "visible",
                    }),
                    J.yourLogo.resize();
          ...
          var e = "auto",
            ...
            e =
              ...
              -1 != this.$element.data("originalLeft").indexOf("%")
                ...
                : parseInt(this.$element.data("originalLeft")) * J.resize.ratio,
            t =
            ...
            i =
              ...
              -1 != this.$element.data("originalTop").indexOf("%")
                ...
                : parseInt(this.$element.data("originalTop")) * J.resize.ratio,
            s =
      ...
      (J.gui = {
        navigation: {
          init: function () {
            J.o.navPrevNext && this.prevNext.init(),
              (J.o.navStartStop || J.o.navButtons) && this.bottom.init();
          },
          prevNext: {
            init: function () {
              ie(
                ...
                ie(
                  ...
                  .appendTo($),
                J.o.hoverPrevNext && this.setHover();
            },
            setHover: function () {
              $.find(".ls-nav-prev, .ls-nav-next").css({ display: "none" }),
                $.on("mouseenter." + B, function () {
                  J.gui.navigation.forceHide ||
          ...
          bottom: {
            init: function () {
              (this.wrapper = ie(
                ...
                J.o.navButtons &&
                  "always" != J.o.thumbnailNavigation &&
                  this.bullets.init(),
                J.o.navStartStop
                  ? this.createStartStop()
                  : "always" != J.o.thumbnailNavigation && this.createSides(),
                J.o.hoverBottomNav &&
                  "always" != J.o.thumbnailNavigation &&
                  this.setHover(),
                "always" == J.o.thumbnailNavigation &&
            ...
            bullets: {
              init: function () {
                var t = this;
                ie('<span class="ls-bottom-slidebuttons" />').appendTo(
                      ...
                      .on("mouseenter." + B, function () {
                        ...
                        $.find(".ls-thumbnail-hover-img").css({
                          ...
                          t.hoverImage
                            ...
                            .attr(
                              "src",
                              J.slides[e.data("index")].data.thumbnail
                            ),
                          t.hoverWrapper
                            .css({ display: "block" })
                            .stop()
                ...
                t.set.active(J.slides.first.index),
                  "hover" == J.o.thumbnailNavigation && t.set.hover();
              },
              set: {
                active: function (e) {
                  void 0 === e && (e = J.slides.current.index),
                    e--,
            ...
            createSides: function () {
              ie('<span class="ls-nav-sides ls-nav-sideleft" />').prependTo(
                $.find(".ls-bottom-nav-wrapper")
              ),
                ie('<span class="ls-nav-sides ls-nav-sideright" />').appendTo(
                  $.find(".ls-bottom-nav-wrapper")
                );
            },
            setHover: function () {
            ...
            switchHelper: function (e) {
              if (J.o.hoverBottomNav && !$.hasClass("ls-hover"))
                switch (e) {
                  case "on":
            ...
            thumbnails: {
              init: function () {
                (this.wrapper = ie(
                  '<div class="ls-gui-element ls-thumbnail-wrapper ' +
                    ("contain" !== J.o.tnFillMode ? "ls-thumbnail-fill" : "") +
                    '"></div>'
                ).appendTo($)),
                  ie(
                  ...
                  "ontouchstart" in window
                    ...
                    : this.$element
                        ...
                        .on("mouseleave." + B, function () {
                          ie(this).removeClass("ls-thumbnail-slide-hover"),
                            J.gui.navigation.bottom.thumbnails.scroll();
                        })
                        .on("mousemove." + B, function (e) {
                          e =
                            (parseInt(e.pageX - ie(this).offset().left) /
                              ie(this).width()) *
                            (ie(this).width() -
                              ie(this).find(".ls-thumbnail-slide").width());
                          ie(this)
                ...
                for (var e = 0; e < J.slides.count; e++) {
                  var t = e + 1,
                    ...
                    s = "";
                  "contain" !== J.o.tnFillMode &&
                    ((i =
                      "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"),
                    (s =
                      'style="background-image: url(' +
                      J.slides[t].data.thumbnail +
                      "); background-size: " +
                      J.o.tnFillMode +
                      ';"'));
                  i = ie(
                  ...
                  J.slides[t].data.tnAlt &&
                    i.find("img").attr("alt", J.slides[t].data.tnAlt),
                    i
                      .data("index", t)
                      .on("click." + B, function (e) {
                        e.preventDefault(),
                          $.layerSlider(ie(this).data("index"));
                      })
                      ...
                      i
                        .on("mouseenter." + B, function () {
                          ie(this)
                            .children()
                            .stop()
                            .fadeTo(300, J.o.tnActiveOpacity / 100);
                        })
                        .on("mouseleave." + B, function () {
                          ie(this).children().hasClass("ls-thumb-active") ||
                            ie(this)
                              .children()
                              .stop()
                              .fadeTo(300, J.o.tnInactiveOpacity / 100);
                        });
                }
                J.gui.navigation.bottom.buttonStart &&
                  J.gui.navigation.bottom.buttonStop &&
                  ((J.gui.navigation.bottom.wrapper = ie(
                  ...
                  J.gui.navigation.bottom.buttonStart
                    ...
                    .appendTo(J.gui.navigation.bottom.wrapper),
                  J.gui.navigation.bottom.buttonStop
                    .clone()
                    .on("click." + B, function (e) {
                      e.preventDefault(), $.layerSlider("stop");
                    ...
                    .appendTo(J.gui.navigation.bottom.wrapper)),
                  J.o.hoverBottomNav && this.setHover();
              },
              setHover: function () {
                var e = this;
                e.wrapper.css("display", "none"),
                  J.gui.navigation.bottom.wrapper &&
                    ((J.gui.navigation.bottom.wrapper =
                      "block" == J.gui.navigation.bottom.wrapper.css("display")
                        ? J.gui.navigation.bottom.wrapper
                        : $.find(".ls-above-thumbnails")),
                    J.gui.navigation.bottom.wrapper.css("display", "none")),
                  $.on("mouseenter." + B, function () {
                    $.addClass("ls-hover"),
                      J.gui.navigation.forceHide ||
                        (e.wrapper.stop(!0, !0).fadeIn(300),
                ...
                $.find(".ls-thumbnail-slide a:not(.ls-thumb-" + e + " )")
                  ...
                  .each(function () {
                    ie(this)
                      ...
                      .stop()
                      .fadeTo(750, J.o.tnInactiveOpacity / 100);
                  }),
                  $.find(".ls-thumbnail-slide a.ls-thumb-" + e)
                    .children()
                    .addClass("ls-thumb-active")
                    .stop()
                    .fadeTo(750, J.o.tnActiveOpacity / 100);
              },
              scroll: function () {
                var e;
              ...
              resize: function () {
                ...
                var e =
                    -1 == J.slider.initial.width.indexOf("%")
                      ? parseInt(J.slider.initial.originalWidth)
                      : $.width(),
                  t = $.find(".ls-thumbnail"),
                  e =
                    -1 == J.o.tnContainerWidth.indexOf("%")
                      ? parseInt(J.o.tnContainerWidth)
                      : parseInt((e / 100) * parseInt(J.o.tnContainerWidth));
        ...
        media: {
          init: function () {
            0 < J.media.properties.$allMediaLayers.length &&
              ie(
        ...
        skin: {
          load: function () {
            ...
            var e,
              t = J.o.skinsPath + J.o.skin + "/skin.css",
              i = ie("head").length ? ie("head") : ie("body");
            ie('link[href="' + t + '"]').length
              ? ((e = ie('link[href="' + t + '"]')),
                J.gui.skin.isLoaded ||
                  ((J.gui.skin.isLoaded = !0),
                  (J.timeouts.skinLoad1 = setTimeout(function () {
                    delete J.timeouts.skinLoad1, J.slider.init();
                  }, 150))))
              : (e = document.createStyleSheet
                  ? (document.createStyleSheet(t), ie('link[href="' + t + '"]'))
                  : ie(
              ...
              e.on("load." + B, function () {
                J.gui.skin.isLoaded ||
                  ((J.gui.skin.isLoaded = !0),
                  (J.timeouts.skinLoad2 = setTimeout(function () {
              ...
              M.on("load." + B, function () {
                J.gui.skin.isLoaded ||
                  ((J.gui.skin.isLoaded = !0),
                  (J.timeouts.skinLoad3 = setTimeout(function () {
          ...
          set: function () {
            (this.$element = ie(
              ...
              "block" != this.$element.css("display") ||
                ...
                (this.image = ie("<img>")
                  .attr("src", J.o.skinsPath + J.o.skin + "/shadow.png")
        ...
        timers: {
          init: function () {
            J.o.showBarTimer && this.bar.create(),
              J.o.showCircleTimer && this.circle.create();
            var e = !1;
            (e = J.o.showSlideBarTimer
              ? ie("<div>").insertAfter($)
              : ie(
                  '[data-slidebar-for="' +
                    $.attr("id") +
          ...
          slidebar: {
            ...
            create: function (e) {
              function i(e, t) {
                (a =
                  ...
                  a >
                    ...
                    (a =
                      "calc( 100% - " +
                      J.gui.timers.slidebar.sliderContainerElementWidth[t] +
                      "px )"),
                  o.$sliderContainerElement[t].css({ left: a }),
                  J.transitions._slideTimeline &&
                    J.transitions._slideTimeline.progress(
                      "string" == typeof a
                        ? J.transitions.layers.timeline.progress
                        : (a /
                            (o.containerElementWidth[t] -
                              o.sliderContainerElementWidth[t])) *
                            J.transitions.layers.timeline.progress
              ...
              function s(e) {
                "dragging" == J.gui.timers.slidebar.state &&
                  (J.transitions._slideTimeline &&
                    J.transitions.layers.timeline.state.finished &&
                    J.transitions._slideTimeline.progress() !==
                      J.transitions.layers.timeline.progress &&
                  ...
                  ie(document).off("mousemove." + B),
                  ie("body")
                    .prop("unselectable", !1)
                    .removeClass("ls-unselectable"),
                  (J.o.pauseLayers && !J.slideshow.state.running) ||
                    J.slider.state.isPaused ||
                    !J.transitions._slideTimeline ||
                    J.o.playByScroll ||
                    (!0 === J.transitions.layers.timeline.state.started
                      ? J.transitions.layers.timeline.resume()
                      : J.transitions.layers.timeline.play()),
                  (J.gui.timers.slidebar.state = !1));
              }
              var a,
                r = ie(document),
                o = this;
              ie.each(e, function (t, e) {
                (o.$containerElement[t] = ie(e).addClass(
                  "ls-slidebar-container " + B
                )),
                  (o.$element[t] = ie("<div>")
                    .addClass("ls-slidebar")
                    .appendTo(o.$containerElement[t])),
                  (o.$progressBarElement[t] = ie("<div>")
                    .addClass("ls-progressbar")
                    .appendTo(o.$element[t])),
                  (o.$sliderContainerElement[t] = ie("<div>")
                    .addClass("ls-slidebar-slider-container")
                    .appendTo(o.$containerElement[t])),
                  (o.$sliderElement[t] = ie("<div>")
                  ...
                  o.$containerElement[t].on(
                    ...
                    function (e) {
                      J.transitions.layers.timeline.pause(0),
                        ie("body")
                          .prop("unselectable", !0)
                          .addClass("ls-unselectable"),
                        ie(document).on("mousemove." + B, function (e) {
                          i(e, t);
                        }),
                        i(e, t),
                        (J.gui.timers.slidebar.state = "dragging");
                    }
                  ),
      ...
      (J.navigation = {
        ...
        set: {
          keyboard: function () {
            J.o.keybNav &&
              ie("body").on("keydown." + B, function (e) {
                ie(e.target).is(":input") ||
                  J.slider.isAnimating ||
                  J.slider.isPreloading ||
                  (37 == e.which
                    ? J.navigation.prev()
                    : 39 == e.which && J.navigation.next());
              });
          },
          touch: function () {
            "ontouchstart" in window &&
              J.o.touchNav &&
              (J.slider.$innerWrapper.on("touchstart." + B, function (e) {
                e = e.touches || e.originalEvent.touches;
                1 == e.length &&
                  (J.device.touchStartX = J.device.touchEndX = e[0].clientX);
              }),
              J.slider.$innerWrapper.on("touchmove." + B, function (e) {
                var t = e.touches || e.originalEvent.touches;
                1 == t.length && (J.device.touchEndX = t[0].clientX),
                  45 < Math.abs(J.device.touchStartX - J.device.touchEndX) &&
                    e.preventDefault();
              }),
              J.slider.$innerWrapper.on("touchend." + B, function (e) {
                45 < Math.abs(J.device.touchStartX - J.device.touchEndX) &&
                  (0 < J.device.touchStartX - J.device.touchEndX
        ...
        prev: function () {
          (!J.slider.isPopup ||
            (J.slider.isPopup && J.slider.state.popupIsVisible)) &&
            ((this.direction = "prev"),
            (this.forceDirection = "prev"),
            J.slideshow.set.prevNext("prev"));
        },
        next: function () {
          (!J.slider.isPopup ||
            (J.slider.isPopup && J.slider.state.popupIsVisible)) &&
            ...
            J.slideshow.set.prevNext("next"));
        },
        start: function () {
          J.functions.setStates(J.slideshow, { running: !0, paused: !1 }),
            !0 === J.slideshow.state.pausedByLastCycle &&
              J.functions.setStates(J.slideshow, { pausedByLastCycle: !1 }),
            J.gui.navigation.bottom.setStartStop("start"),
            J.slideshow.state.pausedByHover ||
              (1 !== J.transitions._slideTimeline.timeScale() &&
                J.transitions.layers.timeline.resume()),
            J.slideshow.start();
        },
        stop: function () {
          J.gui.navigation.bottom.setStartStop("stop"),
            J.o.pauseLayers && J.transitions.layers.timeline.pause(),
            J.slideshow.stop();
        },
      }),
      (J.preload = {
        init: function () {
          J.slider.$hiddenWrapper.find(".ls-slide img").each(function () {
            ...
            t.is(".ls-layer, .ls-bg") &&
              ...
              ie.isEmptyObject(s) ||
                (t.data(J.defaults.init.dataKey).attributes = s)),
              t.data("lazy-src")
        ...
        imagesOfSlide: function (e, t) {
          var i, s, a;
          !0 !== J.slides[e].wrapped
            ? ((this.slideIndex = e),
              t
                ? ((this.onCompleteCallback = t),
                  J.functions.setStates(J.slider, { preloadingImages: !0 }),
                  J.gui.loadingIndicator.show())
                : (this.onCompleteCallback = !1),
              J.slider.canShow && $.css({ visibility: "visible" }),
              (this.preImages = []),
              (i = this),
              J.slider.$hiddenWrapper
                .find(".ls-slide:eq(" + (i.slideIndex - 1) + ") *")
                .each(function () {
                  (s = ie(this)), (a = this);
                  var e,
                    t = s.data(J.defaults.init.dataKey);
                  s.is("img")
                    ? (s.data("src") && s.attr("src", s.data("src")),
                      ...
                      (t =
                        ...
                        s.is(".ls-bg") &&
                        ((e = t),
                        J.slides[i.slideIndex].data.$background.attr("src", e)),
                      J.preload.preImages.push([e, s]))
                    : "none" !== s.css("background-image") &&
                      -1 !== s.css("background-image").indexOf("url") &&
                      J.preload.preImages.push([
                        s
              ...
              J.transitions.firstSlide &&
                J.o.globalBGImage &&
                J.preload.preImages.push([J.o.globalBGImage, ie()]),
              this.thumbnailsAreLoaded || this.thumbnails(),
              0 === this.preImages.length ? this.onComplete() : this.start())
            : J.slider.shouldResize && t
            ? (J.resize.setLayers(J.layers.get("next, bg")), J.resize.layers(t))
            : t && t();
        },
        thumbnails: function () {
          for (
            var e = J.slider.thumbnails.filter(function (e, t, i) {
        ...
        start: function () {
          J.debugMode &&
            (J.debug.add("group", "preload"),
            J.debug.add("log", "preload.info", this.slideIndex)),
            ...
            var e,
              ...
              i = function () {
                ++t.preloadedImagesCount == t.preImages.length &&
                  (J.debugMode && J.debug.groupEnd(), t.onComplete());
              },
              s = function () {
                J.debugMode &&
                  ...
                  J.debug.add("log", "preload.success", e)),
              ...
              a = function () {
                J.debugMode &&
                  ...
                  J.debug.add("warn", "preload.fail", e)),
                  i();
              },
              r = 0;
        ...
        onComplete: function () {
          ...
          this.onCompleteCallback
            ? (J.layers.wrap(this.slideIndex),
              (function e() {
                var t, i, s;
                0 !== J.slides[a.slideIndex].$layers.length
                  ? (J.timeouts.waitForWrap = setTimeout(e, 100))
                  : (delete J.timeouts.waitForWrap,
                    J.functions.setStates(J.transitions.layers.parallax, {
                      ready: !0,
                    }),
                    ie(
                      ".ls-thumbnail-wrapper, .ls-nav-next, .ls-nav-prev, .ls-bottom-nav-wrapper"
                    ).css({ visibility: "visible" }),
                    (J.slides[a.slideIndex].wrapped = !0),
                    (t = !(
                      !window._layerSlider.globals.youTubeIsReady &&
                      J.layers.get("next,in,youtube,bgvideo").length
                    )),
                    (i = !(
                      !window._layerSlider.globals.vimeoIsReady &&
                      J.layers.get("next,in,vimeo,bgvideo").length
                    )),
                    (s = function () {
                      J.gui.loadingIndicator.hide(),
                        J.slider.shouldResize
                          ? (J.resize.setLayers(J.layers.get("next, bg")),
                            J.resize.layers(a.onCompleteCallback))
                          : a.onCompleteCallback();
                    }),
                    t && i
                      ? s()
                      : (J.intervals.waitForJSApisLoaded = setInterval(
                          function () {
                            (t || window._layerSlider.globals.youTubeIsReady) &&
                              (i || window._layerSlider.globals.vimeoIsReady) &&
                              (clearInterval(J.intervals.waitForJSApisLoaded),
                              delete J.intervals.waitForJSApisLoaded,
                              s());
                          },
                          50
                        )));
              })())
            : J.layers.wrap(this.slideIndex, !0),
            J.functions.setStates(J.slider, { preloadingImages: !1 });
        },
      }),
      (J.resize = {
        setLayers: function (e) {
          (this.$responsiveLayers = e.add(J.layers.get("active"))),
            J.slides.next.data.$backgroundVideo.length &&
              (this.$responsiveLayers = this.$responsiveLayers.add(
                J.slides.next.data.$backgroundVideo
              ));
        },
        all: function (e = {}) {
          return (
            !(J.slider.state.isHidden && !J.slider.isPopup) &&
            !!document.body.contains(L) &&
            (J.api.hasEvent("sliderWillResize") &&
              J.api.triggerEvent("sliderWillResize", J.api.eventData()),
            this.slider(!!e.forceToGetParentWidth),
            J.o.performanceMode && this.performance(),
            J.slider.isScene &&
              !J.slider.$spacingWrapper.is("[data-disabled-scene]") &&
              this.scene(),
            this.navigation(),
            this.layers(),
            this.yourLogo(),
            this.shadow(),
            this.timers(),
            J.o.allowRestartOnResize &&
              J.transitions.layers.timeline.shouldRestart &&
              (J.functions.resetSlideTimelines(),
              J.transitions.layers.timeline.create(!0),
              J.slider.isScrollScene &&
                J.transitions._slideTimeline &&
                J.transitions.scrollscene.animate()),
            void (
              J.api.hasEvent("sliderDidResize") &&
              J.api.triggerEvent("sliderDidResize", J.api.eventData())
            ))
          );
        },
        viewport: function () {
          M.scrollTop(
            Math.round(J.slider.offset.top) -
              (te.viewport.height - J.slider.height) / 2
          );
        },
        slider: function (e) {
          if (!document.body.contains(L)) return !1;
          te.viewport.width || M.trigger("resize.lsGlobal"),
            J.o.fixFloatedContainers && $.css("display", "none");
          var t,
            i,
            s,
            a =
              J.slider.$parentWithNumericWidthValue &&
              0 < J.slider.$parentWithNumericWidthValue.width() &&
              !e
                ? J.slider.$parentWithNumericWidthValue
                : J.functions.getSliderClosestParentElementWithNumericValueOfProperty(
                    "width"
                  ),
            r = J.slider.initial,
            o = J.slider.$parentWithNumericWidthValuePercent
              ? (a.width() / 100) * J.slider.$parentWithNumericWidthValuePercent
              : a.width(),
            n = r.type,
          ...
          switch (
            (J.o.fixFloatedContainers && $.css("display", "block"),
            -1 !== l.indexOf("%")
              ? (l = (o / 100) * parseInt(l))
              : -1 !== l.indexOf("vw") &&
                (l = (te.viewport.width / 100) * parseInt(l)),
            J.slider.state.inFullscreen
              ? ($[0].style.maxWidth = "")
              : 0 !== r.maxWidth && ($[0].style.maxWidth = l),
            l < (o -= d + e) && 0 <= l && (o = l),
            J.o.fitScreenWidth &&
              ("fullwidth" === n ||
                ("fullsize" === n &&
                  "fitheight" !== J.o.fullSizeMode &&
                  "fitwidth" !== J.o.fullSizeMode)) &&
              ((d = a.offset().left),
              (e = parseInt(a.css("padding-left")) || 0),
              (l = parseInt(a.css("border-left-width")) || 0),
              ($[0].style.maxWidth = "100vw"),
              ($[0].style.marginLeft = -(d + e + l) + "px"),
              (o = te.viewport.width)),
            (o -= r.skinWidth),
            te.getScreenSize(),
            J.slider.state.inFullscreen && (o = te.screen.width),
            n)
          ) {
            case "responsive":
              0 < J.o.maxRatio && (o = Math.min(r.width * J.o.maxRatio, o)),
                (t =
                  (J.slider.state.inFullscreen
                    ? (te.screen.ratio > r.ratio
                        ? (this.ratio = te.screen.height / r.height)
                        : (this.ratio = te.screen.width / r.width),
                      (o = Math.round(r.width * this.ratio)))
                    : (this.ratio = o / r.width),
                  Math.round(r.height * this.ratio)));
              break;
            case "fullwidth":
              t =
                o < J.o.responsiveUnder
                  ? ((this.ratio = o / J.o.responsiveUnder),
                    Math.round(r.height * this.ratio))
                  : J.slider.state.inFullscreen
                  ? te.screen.ratio > r.layersWidth / r.height
                    ? ((this.ratio = te.screen.height / r.height),
                      te.screen.height)
                    : ((this.ratio = te.screen.width / r.layersWidth),
                      r.height * this.ratio)
                  : ((this.ratio = 1), r.height);
              break;
            case "fullsize":
              switch (J.o.fullSizeMode.toLowerCase()) {
                ...
                case "hero":
                  ...
                  var u = ie(J.o.calculateOffsetFrom).length
                    ? ie(J.o.calculateOffsetFrom).height() +
                      ie(J.o.calculateOffsetFrom)[0].getBoundingClientRect().top
                    : 0;
                  u && p.css("top", u),
                    (t = te.viewport.height - r.skinHeight - (u || c)) <= 0 &&
                      (t = te.viewport.height - r.skinHeight);
                  break;
                case "fitheight":
                  (o = a.width() - r.skinWidth),
                    (t = a.height() - r.skinHeight);
                  break;
                case "fitwidth":
                  (o = a.width() - r.skinWidth),
                    (t = te.viewport.height - r.skinHeight);
              ...
              o / t < r.ratio
                ? (this.ratio = o / r.layersWidth)
                : (this.ratio = t / r.layersHeight);
              break;
            case "fixed":
            case "fixedsize":
              (this.ratio = 1),
          ...
          (this.ratio =
            J.o.maxRatio && 0 < J.o.maxRatio && this.ratio > J.o.maxRatio
              ? J.o.maxRatio
              : this.ratio),
            (L.style.width = o + "px"),
            (L.style.height = t + "px"),
            (J.slider.width = o),
            (J.slider.height = t),
            J.slider.$layersWrapper.css({
              "--sw": J.slider.width + "px",
              "--sh": J.slider.height + "px",
            }),
            te.isMobile
              ? 768 <= te.viewport.width ||
                te.viewport.width > te.viewport.height
            ...
            J.o.marginTop &&
              (i =
                -1 != J.o.marginTop.indexOf("sh") ||
                -1 != J.o.marginTop.indexOf("%")
                  ? (J.slider.height / 100) * parseInt(J.o.marginTop)
                  : J.o.marginTop),
            J.o.marginBottom &&
              (s =
                -1 != J.o.marginBottom.indexOf("sh") ||
                -1 != J.o.marginBottom.indexOf("%")
                  ? (J.slider.height / 100) * parseInt(J.o.marginBottom)
                  : J.o.marginBottom),
            J.slider.$spacingWrapper.css({ marginTop: i, marginBottom: s });
        },
        performance: function () {
          var e = parseInt(J.o.performanceModeThreshold);
          -1 !== J.o.performanceModeThreshold.indexOf("sh") ||
          -1 !== J.o.performanceModeThreshold.indexOf("%")
            ? (J.performance.threshold = J.slider.height * (e / 100))
            : -1 !== J.o.performanceModeThreshold.indexOf("vh")
            ? (J.performance.threshold = te.viewport.height * (e / 100))
            : -1 !== J.o.performanceModeThreshold.indexOf("px")
            ? (J.performance.threshold = e)
            : (J.performance.threshold = J.slider.height * e),
            (J.performance.threshold = Math.max(
              parseInt(J.performance.threshold),
              0
            ));
        },
        scene: function () {
          var e;
          J.slider.isScrollScene && J.o.sceneDuration
            ? (e =
                Math.round(
                  J.slider.height +
                    (J.o.sceneDuration * J.slider.height) /
                      (J.o.sceneSpeed / 100)
                ) + "px")
            : J.slider.isSticky &&
              (-1 !== J.o.sceneHeight.indexOf("sh") ||
              -1 !== J.o.sceneHeight.indexOf("%")
                ? ((e = J.slider.height * (parseInt(J.o.sceneHeight) / 100)),
                  (e = Math.round(Math.max(J.slider.height, e))),
                  (e += "px"))
                : -1 === J.o.sceneHeight.indexOf("px") &&
                  -1 === J.o.sceneHeight.indexOf("vh")
                ? ((e = J.slider.height * (J.o.sceneHeight || 2)),
                  (e = Math.round(Math.max(J.slider.height, e))),
                  (e += "px"))
                : (e = J.o.sceneHeight)),
            e && J.slider.$spacingWrapper.css({ height: e }),
            $.css({ top: J.transitions.scrollscene.stickLimit });
        },
        borderRadius: function (e, i) {
          ie.isNumeric(e) && (e = e.toString());
          var s = "";
          return (
            ie.each(e.split(" "), function (e, t) {
        ...
        shadows: function (e, t) {
          for (var i = e.split(" "), s = 0; s < i.length; s++)
            -1 !== i[s].indexOf("px") &&
              (i[s] = Math.ceil(parseInt(i[s]) * t) + "px");
        ...
        calculateRatio: function (e, t) {
          return (
            e.settings.minresponsiveratio &&
              t < e.settings.minresponsiveratio &&
              (t = e.settings.minresponsiveratio),
            e.settings.maxresponsiveratio &&
              t > e.settings.maxresponsiveratio &&
              (t = e.settings.maxresponsiveratio),
            (e.settings.calculatedratio = t)
          );
        },
        layers: function (e) {
          if (
            (J.slider.hasPinnedLayers &&
              (J.slider.$layersWrapper.css({
                clip:
                  "rect(0px " +
                  J.slider.width +
              ...
              J.slider.$layersWrapper &&
                J.slider.$layersWrapper.is(".ls-layers-clip") &&
                J.slider.$layersWrapper.removeClass("ls-layers-clip")),
            J.o.animateFirstSlide &&
              J.slideshow.firstStart &&
              "inside" !== J.slider.position.toViewport)
          )
            return (
              J.functions.setStates(J.slider, { readyForStart: !0 }),
          ...
          if (this.$responsiveLayers) {
            ...
            for (
              ...
              !y.is("img") ||
                ("auto" !== b.width && "auto" !== b.height) ||
                ((_ = v.elements.$_innerWrappers).addClass(
                  "ls-force-display-block ls-force-visibility-hidden"
                ),
                "auto" === b.width && (b.width = y.width()),
                "auto" === b.height && (b.height = y.height()),
                _.removeClass(
                  "ls-force-display-block ls-force-visibility-hidden"
                )),
                (t =
                  "responsive" === s.type && -1 !== J.o.maxRatio
                    ? s.width
                    : s.layersWidth),
                (I =
                  "responsive" === s.type && -1 !== J.o.maxRatio
              ...
              var T,
                ...
                P = a,
                O = r,
                I = v.is.insideLayerGroup
                  ? ((C = k = !1),
                    ($ = L = 0),
                    (t = P = S.responsive.width),
                    (O = S.responsive.height))
                  : ((t = T), I);
              v.is.pinned &&
                (J.slider.get.offset(),
                ("responsive" !== s.type &&
                  ...
                  ("fullsize" !== s.type ||
                    ("fitheight" !== J.o.fullSizeMode &&
                      !1 !== J.o.fitScreenWidth))) ||
                  (k
                    ? ((t = P = te.viewport.width), (p = 0))
                    : ((P = J.slider.width),
                      (p = J.slider.offset.left),
                      (t = s.width))),
                C
                  ? ((I = O = te.viewport.height), (u = 0))
                  : ((O = J.slider.height),
                    (u = (te.viewport.height - J.slider.height) / 2 || 0),
                    (I = s.height)));
              var L = k ? 0 : p,
                $ = C ? 0 : u,
                B = {
                ...
                W = {},
                _ = { borderRadius: B.borderRadius };
              if (
                ((k || C) &&
                  (b.percentHeight || b.percentWidth) &&
                  v.is.imageLayer &&
                  (b.percentHeight &&
                    !b.percentWidth &&
                ...
                (("number" == typeof b.width && b.width < 0) ||
                  "auto" == b.width ||
                  "" == b.sWidth) &&
                  J.debugMode &&
                  J.debug.add("warn", "resize.width", [m + 1, b.width]),
                (("number" == typeof b.height && b.height < 0) ||
                  "auto" == b.height ||
                  "" == b.sHeight) &&
                  J.debugMode &&
                  J.debug.add("warn", "resize.height", [m + 1, b.height]),
                (B.fontSize = b.fontSize * x),
                v.is.textLayer &&
                  (te.isMobile && B.fontSize < v.styleSettings.minmobilefontsize
                    ? (B.fontSize = v.styleSettings.minmobilefontsize)
                    : B.fontSize < v.styleSettings.minfontsize &&
                      (B.fontSize = v.styleSettings.minfontsize),
                  (T = B.fontSize / b.fontSize),
                  (B.fontSize += "px"),
                  -1 !== b.lineHeight.indexOf("px") &&
                    (B.lineHeight = parseFloat(b.lineHeight) * T + "px"),
                  -1 !== b.letterSpacing.indexOf("px") &&
                    (B.letterSpacing = parseFloat(b.letterSpacing) * T + "px"),
                  -1 !== b.textStrokeWidth.indexOf("px") &&
                    (B.textStrokeWidth =
                      parseFloat(b.textStrokeWidth) * T + "px"),
                  "" == b.sWidth &&
                    ((B.width = "auto"),
                ...
                if (v.is.slideBackground) {
                  ...
                  switch (
                    ...
                    case "cover":
                      b.ratio < o
                        ? ((B.width = a), (B.height = B.width / b.ratio))
                        : ((B.height = r), (B.width = B.height * b.ratio));
                      break;
                    case "contain":
                      b.ratio < o
                        ? ((B.height = r), (B.width = B.height * b.ratio))
                  ...
                  var A,
                    z = J.slides[v.is.onSlide].data.backgroundPosition;
                  switch (
                    (A = (void 0 !== z ? z : J.o.slideBGPosition).split(" "))[0]
                  ) {
                    case "left":
                      B.x = 0;
                      break;
                    ...
                    default:
                      -1 !== A[0].indexOf("%")
                        ? (B.x =
                            ((J.slider.width - B.width) / 100) * parseInt(A[0]))
                        : (B.x = parseInt(A[0]));
                  }
                  if (void 0 !== A[1])
                    switch (A[1]) {
                      ...
                      default:
                        -1 !== A[1].indexOf("%")
                          ? (B.y =
                              ((J.slider.height - B.height) / 100) *
                              parseInt(A[1]))
                          : (B.y = parseInt(A[1]));
                    }
                  (B.transform =
                    "translateX(" + B.x + "px) translateY(" + B.y + "px)"),
                    (B["-ms-transform"] =
                      "translateX(" + B.x + "px) translateY(" + B.y + "px)"),
                    (B["-webkit-transform"] =
                      "translateX(" + B.x + "px) translateY(" + B.y + "px)");
                ...
                !v.mediaProperties ||
                  ("youtube" !== v.mediaProperties.type &&
                    "vimeo" !== v.mediaProperties.type) ||
                  ((F = B.width / B.height),
                  (z = { width: B.width, height: B.height }),
                  b.ratio < F
                    ? ((z.height = B.width / b.ratio),
                      (z.marginTop = (B.height - z.height) / 2))
                    : ((z.width = B.height * b.ratio),
                      (z.marginLeft = (B.width - z.width) / 2)),
                  v.mediaProperties.$media.css(z)),
                  ...
                  "auto" == B.width
                    ? (B.outerWidth = Math.ceil(y.outerWidth()))
                    : (B.outerWidth =
                        B.width +
                        J.layers.toNum(B.paddingLeft, B.fontSize) +
                        J.layers.toNum(B.paddingRight, B.fontSize) +
                        J.layers.toNum(B.borderLeftWidth, B.fontSize) +
                        J.layers.toNum(B.borderRightWidth, B.fontSize)),
                  "auto" == B.height
                    ? (B.outerHeight = Math.ceil(y.outerHeight()))
                    : (B.outerHeight =
                        B.height +
                        J.layers.toNum(B.paddingTop, B.fontSize) +
                        J.layers.toNum(B.paddingBottom, B.fontSize) +
                        J.layers.toNum(B.borderTopWidth, B.fontSize) +
                        J.layers.toNum(B.borderBottomWidth, B.fontSize)),
                  ...
                  v.is.insideLayerGroup &&
                    (S.elements.$_allWrappers.removeClass(
                      "ls-force-display-block ls-force-no-transform ls-force-width-auto ls-force-height-auto ls-force-left-0 ls-force-full-size"
                    ),
                    w.removeClass("ls-force-no-transform")),
                  (M.width = W.width = B.outerWidth),
                  (M.height = W.height = B.outerHeight),
                  -1 != b.left.indexOf("%")
                    ? "100%" === b.left
                      ? (B.left =
                          0 === L
                            ? (P / 100) * parseFloat(b.left) - B.outerWidth
                            : L +
                              ((t * x) / 100) * parseFloat(b.left) -
                              B.outerWidth)
                      : "0%" === b.left
                      ? (B.left = 0 === L ? 0 : L)
                      : (B.left =
                          0 === L
                            ? (P / 100) * parseFloat(b.left) - B.outerWidth / 2
                            : L +
                              ((t * x) / 100) * parseFloat(b.left) -
                              B.outerWidth / 2)
                    : (B.left = L + parseFloat(b.left) * x),
                  (M.left = B.left),
                  -1 != b.top.indexOf("%")
                    ? "100%" === b.top
                      ? (B.top =
                          0 === $
                            ? (O / 100) * parseFloat(b.top) - B.outerHeight
                            : $ +
                              ((I * x) / 100) * parseFloat(b.top) -
                              B.outerHeight)
                      : "0%" === b.top
                      ? (B.top = 0 === $ ? 0 : $ + 0)
                      : (B.top =
                          0 === $
                            ? (O / 100) * parseFloat(b.top) - B.outerHeight / 2
                            : $ +
                              ((I * x) / 100) * parseFloat(b.top) -
                              B.outerHeight / 2)
                    : (B.top = $ + parseFloat(b.top) * x),
                  (M.top = B.top);
              v.textIn.$nodesForBackgroundClip &&
                ...
                (I = I && !(g.style.width = "auto")),
                v.elements.$_innerWrappers.removeClass("ls-force-no-transform"),
                O.removeClass(
                  "ls-force-visibility-hidden ls-force-display-block"
                )),
                (B.fontSize =
                  parseFloat(B.fontSize) / te.automaticFontSizeRatio + "px"),
                (v.responsive = B),
                (n[m] = B),
                v.is.smartBG &&
                  ...
                  (n[m]["--sw"] = (k ? J.slider.width : s.width * x) + "px"),
                  (n[m]["--sh"] = (C ? J.slider.height : s.height * x) + "px"),
                  (n[m]["--x"] =
                    -B.left -
                ...
                v.is.slideBackground ||
                  v.is.backgroundVideo ||
                  ((v.settings.wrapperData.responsive = M),
                  (l[m] = M),
                  (d[m] = W),
                  (c[m] = _));
            }
            for (var D = 0, V = n.length; D < V; D++) {
              ...
              R.css(n[D]),
                E.is.slideBackground || E.is.backgroundVideo
                  ? (E.is.slideBackground || E.is.backgroundVideo) &&
                    (E.elements.$bgOuterWrapper.css({
                  ...
                  : (R.find(".split-item").css(c[D]),
                    this.wrappers(R, E, l[D], d[D]));
            }
        ...
        wrappers: function (e, t, i, s) {
          i && t.elements.$outerStyleWrapper.css(i),
            ...
            ee.TweenMax.set(t.elements.$wrapper[0], {
              autoCSS: !1,
              css: {
                transformPerspective:
                  t.transformPerspective.layer * J.resize.ratio,
              },
            }),
            t.loop.enabled &&
              ee.TweenMax.set(t.elements.$loopWrapper[0], {
                autoCSS: !1,
                css: {
                  transformPerspective:
                    t.transformPerspective.loop * J.resize.ratio,
                },
              }),
            t.hover.enabled &&
              ee.TweenMax.set(e[0], {
                ...
                css: {
                  transformPerspective:
                    t.transformPerspective.hover * J.resize.ratio,
                },
              }),
            t.textIn.nodes &&
              ee.TweenMax.set(t.textIn.nodes, {
                autoCSS: !1,
                css: {
                  transformPerspective:
                    t.transformPerspective.text * J.resize.ratio,
                },
              }),
            t.textOut.nodes &&
              ee.TweenMax.set(t.textOut.nodes, {
                autoCSS: !1,
                css: {
                  transformPerspective:
                    t.transformPerspective.text * J.resize.ratio,
            ...
            t.parallax.enabled &&
              ee.TweenMax.set(t.elements.$parallaxWrapper[0], {
                autoCSS: !1,
                css: {
                  transformPerspective:
                    t.transformPerspective.parallax * J.resize.ratio,
                },
              }),
            t.scroll.enabled &&
              ee.TweenMax.set(t.elements.$scrollTransformWrapper[0], {
                autoCSS: !1,
                css: {
                  transformPerspective:
                    t.transformPerspective.scroll * J.resize.ratio,
                },
              });
        },
        ...
        transformProperties: function (e, t, i, s, a, r) {
          if ("object" == typeof s.x) {
            ...
            "string" == typeof s.x
              ? -1 !== s.x.indexOf("random") ||
                s.x.charAt(0) === J.defaults.init.openingBracket
                ? (i.x = J.functions.convert.randomProperties(s.x, "x", e, t))
          ...
          if ("object" == typeof s.y) {
            ...
            "string" == typeof s.y
              ? -1 !== s.y.indexOf("random") ||
                s.y.charAt(0) === J.defaults.init.openingBracket
                ? (i.y = J.functions.convert.randomProperties(s.y, "y", e, t))
          ...
          if ((a && (i = a), "object" == typeof s.transformOrigin || r)) {
            ...
            if (r) {
              ...
              a.addClass(
                ...
                (c = J.functions.convert.nodesTransformOrigin(
                  s.transformOrigin,
                  r,
                  t,
                  e.data(J.defaults.init.dataKey).elements.$outerStyleWrapper
                )),
                a.removeClass(
                  "ls-force-visibility-hidden ls-force-display-block ls-fix-textnodes"
                );
              ...
              for (var p = 0; p < s.transformOrigin.length; p++)
                c[p] = J.functions.convert.transformOrigin(
                  s.transformOrigin[p],
                  e,
                  t,
                  e.data(J.defaults.init.dataKey).elements.$outerStyleWrapper
            ...
            "string" == typeof s.transformOrigin &&
              (i.transformOrigin = J.functions.convert.transformOrigin(
                s.transformOrigin,
                e,
                t,
                e.data(J.defaults.init.dataKey).elements.$outerStyleWrapper
        ...
        styleProperties: function (e, t, i) {
          void 0 !== i.width &&
            (ie.isNumeric(i.width)
              ? (t.width = parseInt(i.width) * e.settings.calculatedratio)
              : "string" == typeof i.width &&
                -1 !== i.width.indexOf("%") &&
                (t.width = (J.slider.width / 100) * parseInt(i.width))),
            void 0 !== i.height &&
              (ie.isNumeric(i.height)
                ? (t.height = parseInt(i.height) * e.settings.calculatedratio)
                : "string" == typeof i.height &&
                  -1 !== i.height.indexOf("%") &&
                  (t.height = (J.slider.height / 100) * parseInt(i.height))),
            i.borderRadius &&
              (t.borderRadius = J.resize.borderRadius(
                i.borderRadius,
        ...
        getXY: function (e, t, i, s, a) {
          var r = 0,
            ...
            n = t.responsive,
            l =
              t.settings.wrapperData && t.settings.wrapperData.responsive
                ? t.settings.wrapperData.responsive
                : {
                    marginLeft: this.convertSingleValue(
                      o.marginLeft,
                      this.ratio
                    ),
                    marginTop: this.convertSingleValue(o.marginTop, this.ratio),
                    marginRight: this.convertSingleValue(
                      o.marginRight,
                      this.ratio
                    ),
                    marginBottom: this.convertSingleValue(
                      o.marginBottom,
                      this.ratio
                    ),
                  };
          if (
            (n.outerWidth || (n.outerWidth = Math.ceil(e.outerWidth())),
            n.outerHeight || (n.outerHeight = Math.ceil(e.outerHeight())),
            o && n && l)
          )
            switch (i) {
              case "left":
                r =
                  ...
                  !parseInt(o.left) ||
                  "100%" === o.left
                    ? -n.left - n.outerWidth - parseInt(l.marginLeft)
                    : (-parseFloat(o.left) / 100) * J.slider.width -
                      n.outerWidth / 2 -
                      parseInt(l.marginLeft);
                break;
              case "right":
                r =
                  -1 == o.left.indexOf("%") ||
                  !parseInt(o.left) ||
                  "100%" === o.left
                    ? J.slider.width - n.left - parseInt(l.marginLeft)
                    : (1 - parseFloat(o.left) / 100) * J.slider.width +
                      n.outerWidth / 2 -
                      parseInt(l.marginLeft);
                break;
              case "top":
                r =
                  ...
                  !parseInt(o.top) ||
                  "100%" === o.top
                    ? -n.top - n.outerHeight - parseInt(l.marginTop)
                    : (-parseFloat(o.top) / 100) * J.slider.height -
                      n.outerHeight / 2 -
                      parseInt(l.marginTop);
                break;
              case "bottom":
                r =
                  -1 == o.top.indexOf("%") ||
                  !parseInt(o.top) ||
                  "100%" === o.top
                    ? J.slider.height - n.top - parseInt(l.marginTop)
                    : (1 - parseFloat(o.top) / 100) * J.slider.height +
                      n.outerHeight / 2 -
                      parseInt(l.marginTop);
                break;
              case "width":
              ...
              default:
                r =
                  -1 !== i.indexOf("%")
                    ? (n["outer" + s] / 100) * parseInt(i)
                    : -1 !== i.indexOf("sw")
                    ? (parseFloat(i.split("sw")[0]) / 100) * J.slider.width
                    : -1 !== i.indexOf("sh")
                    ? (parseFloat(i.split("sh")[0]) / 100) * J.slider.height
                    : -1 !== i.indexOf("lw")
                    ? (n.outerWidth / 100) * parseFloat(i.split("lw")[0])
                    : -1 !== i.indexOf("lh")
                    ? (n.outerHeight / 100) * parseFloat(i.split("lh")[0])
                    : parseFloat(i) *
                      (a
                        ? 1
        ...
        navigation: function () {
          "always" == J.o.thumbnailNavigation &&
            J.gui.navigation.bottom.thumbnails.resize();
        },
        shadow: function () {
          J.gui.shadow.show && J.gui.shadow.show(),
            J.gui.shadow.$element && J.gui.shadow.resize();
        },
        yourLogo: function () {
        ...
        timers: function () {
          if (0 < J.gui.timers.slidebar.$containerElement.length)
            for (
              var e = 0, t = J.gui.timers.slidebar.$containerElement.length;
              e < t;
              e++
            )
              (J.gui.timers.slidebar.containerElementWidth[e] =
                J.gui.timers.slidebar.$containerElement[e].width()),
                (J.gui.timers.slidebar.elementWidth[e] =
                  J.gui.timers.slidebar.$element[e].width());
        },
      }),
      (J.transitions = {
        firstSlide: !0,
        timelines: {
          ...
          set: function (e, t) {
            for (var i in this[e])
              J.transitions[this[e][i]] &&
                t(J.transitions[this[e][i]], this[e][i]);
          },
        },
        start: function () {
          return (
            !!document.body.contains(L) &&
            (J.slider.isPopup && J.slider.state.popupIsWaitingForDelay
              ? !(J.slider.state.waitingForPopupTimer = !0)
              : ((J.device.scroll.directionAtSlideTransitionStart =
                  J.device.scroll.direction),
                "always" == J.o.thumbnailNavigation &&
                  (J.gui.navigation.bottom.thumbnails.change(),
                  "ontouchstart" in window ||
                    J.gui.navigation.bottom.thumbnails.scroll()),
        ...
        slide: {
          ...
          init: function () {
            var e, t, i;
            J.functions.setStates(J.slider, { animatingSlides: !0 }),
              J.transitions.layers.parallax.reset(),
              J.slider.$layersWrapper
                .children('.ls-parallax[data-ls-parallax="active"]')
                .each(function () {
                  ie(this).find(".ls-layer").data(J.defaults.init.dataKey)
                    .settings.slideOut === J.slides.current.index &&
                    ie(this).attr("data-ls-parallax", "disbaled");
                }),
              (J.transitions.curSlide = J.slides.current),
              (J.transitions.nextSlide = J.slides.next),
              (J.transitions._slideTransition = new ee.TimelineMax({
                paused: !0,
                onComplete: function () {
                  J.transitions.slide.onComplete();
                },
              })),
              ((J.transitions.nextSlide.data &&
                J.transitions.nextSlide.data.transitionorigami) ||
                J.slider.isScrollScene) &&
                (J.o.animateFirstSlide = !1),
              J.transitions.firstSlide &&
                J.o.animateFirstSlide &&
                ((J.transitions.curSlide = ie.extend(
                  !0,
                  {},
                  J.transitions.nextSlide
                )),
                delete J.transitions.curSlide.data.$background,
                (J.transitions.curSlide.data.backgroundColor = "transparent")),
              J.transitions.firstSlide && !J.o.animateFirstSlide
                ? (void 0 !== J.transitions.nextSlide.data.$background &&
                    ((e = (i = J.transitions.nextSlide.data.$background.data(
                      J.defaults.init.dataKey
                    )).kenBurns.zoom
                      ? i.kenBurns.from.scale
                      : 1),
                    (t = i.kenBurns.zoom ? i.kenBurns.from.rotation : 0),
                    (i = J.transitions.nextSlide.filter.from || "none"),
                    J.transitions._slideTransition.set(
                      J.transitions.nextSlide.data.$background[0],
                      { "-webkit-filter": i, filter: i },
                      0
                    ),
                    J.transitions._slideTransition.fromTo(
                      J.transitions.nextSlide.data.$background.closest(
                        ".ls-bg-wrap"
                      )[0],
                      J.o.sliderFadeInDuration,
                      {
                        autoCSS: !1,
                        css: {
                          scale: e,
                ...
                ? (this.start(!0),
                  J.debugMode &&
                    J.debug.add(
                      ...
                      J.transitions.nextSlide.index
                    ))
                : void 0 === J.transitions.curSlide.data.$background &&
                  void 0 === J.transitions.nextSlide.data.$background &&
                  "transparent" ==
                    J.transitions.curSlide.data.backgroundColor &&
                  "transparent" == J.transitions.nextSlide.data.backgroundColor
                ? this.start(!0)
                : ("x" === J.o.clipSlideTransition
                    ? te.$overflowWrapper.addClass("ls-overflowx-hidden")
                    : "y" === J.o.clipSlideTransition
                    ? te.$overflowWrapper.addClass("ls-overflowy-hidden")
                    : !0 === J.o.clipSlideTransition &&
                      te.$overflowWrapper.addClass("ls-overflow-hidden"),
                  void 0 !== J.transitions.curSlide.data.$background &&
                    ((e =
                      J.transitions.curSlide.data.$background.closest(
                        ".ls-bg-wrap"
                      )[0]._gsTransform),
                    ((t = J.transitions.curSlide.data.$background.data(
                      J.defaults.init.dataKey
                    )).responsive.filter =
                      J.transitions.curSlide.data.$background[0].style.filter),
                  ...
                  (J.transitions.slide.$wrapper = ie("<div>")
                    .addClass("ls-slide-transition-wrapper")
                    .css({ width: J.slider.width, height: J.slider.height })),
          ...
          start: function (e) {
            var t,
              i = !(
                !J.slides.current.index ||
                !J.slides.current.data.$backgroundVideo.length
              ),
              s = !(
                !J.slides.next.index ||
                !J.slides.next.data.$backgroundVideo.length
            ...
            !J.slideshow.firstStart &&
              J.api.hasEvent("slideChangeDidStart") &&
              J.api.triggerEvent("slideChangeDidStart", J.api.eventData()),
              e ||
                (void 0 !== J.transitions.nextSlide.data.transitionDuration
                  ? (a = J.transitions.nextSlide.data.transitionDuration)
                  : void 0 !== J.o.slideTransitionDuration &&
                    ie.isNumeric(J.o.slideTransitionDuration) &&
                    -1 < J.o.slideTransitionDuration &&
                    (a = J.o.slideTransitionDuration / 1e3),
                ie.isNumeric(a) &&
                  (0 === a && (a += 1e-5),
                  J.transitions._slideTransition.duration(a)),
                J.transitions.firstSlide &&
                  J.o.animateFirstSlide &&
                  J.o.firstSlideDuration &&
                  J.transitions._slideTransition.duration(
                    J.o.firstSlideDuration / 1e3
                  ),
                J.debugMode &&
                  J.debug.options.transitionDuration &&
                  J.transitions._slideTransition.duration(
                    J.debug.options.transitionDuration
                  ),
                0.25 < J.transitions.layers.timeline.timeScaleModifier &&
                  ((r =
                    (r =
                      J.transitions._slideTransition.duration() /
                      (0.75 +
                        J.transitions.layers.timeline.timeScaleModifier)) < 0.5
                      ? 0.5
                      : r),
                  J.transitions._slideTransition.duration(r)));
            var e =
                J.transitions._slideTransition.duration() /
                J.transitions._slideTransition.timeScale(),
              a = e,
              r =
                J.transitions.nextSlide.data.timeShift ||
                (void 0 !== J.o.slideTimeShift &&
                ie.isNumeric(J.o.slideTimeShift) &&
                J.o.slideTimeShift < 0
                  ? J.o.slideTimeShift / 1e3
                  : 0);
            0 < r ? (r = 0) : Math.abs(r) > e && (r = -e),
              J.transitions.firstSlide &&
                J.o.animateFirstSlide &&
                !1 !== J.o.firstSlideTimeShift &&
                J.o.firstSlideTimeShift <= 0 &&
                (r = J.o.firstSlideTimeShift / 1e3),
              (J.transitions.nextSlide.data.calculatedTimeShift = r),
              (r =
                J.transitions.firstSlide && !J.o.animateFirstSlide
                  ? J.o.sliderFadeInDuration + 0.01
                  : (a + r) * J.transitions._slideTransition.timeScale()),
              (i || s) &&
                J.transitions.media.changeBackgroundVideo(
                  J.transitions.firstSlide,
                  i && s
                ),
              J.transitions._slideTransition.call(
                function () {
                  !J.slideshow.firstStart &&
                    J.api.hasEvent("slideChangeWillComplete") &&
                    J.api.triggerEvent(
                      "slideChangeWillComplete",
                      J.api.eventData()
                    ),
                    J.slideshow.should.change ||
                      J.transitions.layers.timeline.prepare(),
                    J.media.functions.stop(!0),
                    J.slides.set.slideIndexes(),
                    J.o.hashChange &&
                      (document.location.hash =
                        J.slides[J.slides.current.index].data.deeplink ||
                        "_no-deeplink-found_"),
                    J.slideshow.start(),
                    !J.transitions.firstSlide &&
                      J.slides.prev.index &&
                      J.slides.prev.data.$backgroundVideo.length &&
                      !J.slides.prev.data.$backgroundVideo.data(
                        J.defaults.init.dataKey
                      ).mediaProperties.willBePaused &&
                      (J.slides.prev.data.$backgroundVideo.trigger(
                        "stopBackgroundVideo"
                      ),
                      J.slides.prev.data.$backgroundVideo
                        .data(J.defaults.init.dataKey)
                        .elements.$bgWrapper.css({ display: "none" })),
                    J.slideshow.should.change ||
                      (J.slides.next.data.$backgroundVideo.length &&
                        J.slides.next.data.$backgroundVideo.data(
                          J.defaults.init.dataKey
                        ).mediaProperties &&
                        !J.slides.next.data.$backgroundVideo.data(
                          J.defaults.init.dataKey
                        ).mediaProperties.isPreloaded &&
                        (J.slides.next.data.$backgroundVideo.trigger(
              ...
              J.transitions._slideTransition.play(),
              J.slideshow.forceFastChange &&
                J.transitions._slideTransition.progress(1),
              void 0 !== J.transitions.curSlide.data &&
                void 0 !== J.transitions.curSlide.data.$background &&
                ((t = J.transitions.curSlide.data.$background.data(
                  J.defaults.init.dataKey
                )),
                (J.timeouts.applyBG = setTimeout(function () {
                  delete J.timeouts.applyBG,
                    J.transitions.curSlide.data.$background
                      .closest(".ls-bg-wrap")
                      .hide(),
                    t.kenBurns.zoom &&
                      ee.TweenMax.set(
                        J.transitions.curSlide.data.$background[0],
          ...
          onComplete: function () {
            var e;
            void 0 !== J.transitions.nextSlide.data.$background &&
              J.transitions.nextSlide.data.$background
                .closest(".ls-bg-wrap")
                .show(),
              "transparent" !== J.transitions.nextSlide.data.backgroundColor
                ? J.slider.$slideBGColorWrapper.css(
                    "background-color",
                    J.transitions.nextSlide.data.backgroundColor
                  )
                : J.slider.$slideBGColorWrapper.css(
                    "background-color",
                    "transparent"
              ...
              J.o.leaveOverflow ||
                te.$overflowWrapper.removeClass(
                  "ls-overflowx-hidden ls-overflowy-hidden ls-overflow-hidden"
                ),
              this.$wrapper &&
                (this.$wrapper.html("").remove(), (this.$wrapper = !1)),
              J.gui.navigation.bottom.bullets.set.active(),
              0 < J.o.cycles &&
                (J.slideshow.hasOwnProperty("cycleSlideIndex")
                  ? J.slideshow.cycles.check(J.transitions.nextSlide.index) &&
                    (J.navigation.stop(),
                    J.functions.setStates(J.slideshow, {
                      pausedByLastCycle: !0,
                    }),
                    J.o.forceCycles && (J.slideshow.curCycle = 1))
                  : J.slideshow.cycles.set()),
              J.functions.setStates(J.slider, {
                animatingSlides: !1,
                changingSlides: !1,
              }),
              !J.slideshow.firstStart &&
                J.api.hasEvent("slideChangeDidComplete") &&
                J.api.triggerEvent("slideChangeDidComplete", J.api.eventData()),
              (J.slideshow.firstStart = !1),
              (J.slideshow.forceFastChange = !1),
              J.slideshow.forceFastChangeCallback &&
                (J.slideshow.forceFastChangeCallback(),
                (J.slideshow.forceFastChangeCallback = !1)),
              J.slideshow.should.change
                ? J.navigation.forceDirection
                  ? (void 0 !== J.transitions.curSlide.data &&
                      void 0 !== J.transitions.curSlide.data.$background &&
                      ((e = J.transitions.curSlide.data.$background.data(
                        J.defaults.init.dataKey
                      )),
                      J.transitions.curSlide.data.$background
                        .closest(".ls-bg-wrap")
                    ...
                    J.slideshow.changeTo(
                      J.slideshow.get.slideInSequence(
                        J.navigation.forceDirection
                      ),
                      !0
                    ),
                    (J.navigation.forceDirection = !1))
                  : J.slideshow.forceSlideChangeTo
                  ? J.slideshow.changeTo(J.slideshow.forceSlideChangeTo, !0, !0)
                  : J.preload.imagesOfSlide(J.slides.next.index)
                : J.preload.imagesOfSlide(J.slides.next.index);
          },
          normal: {
            select: {
              transitionType: function () {
                var e, t, i;
                J.o.slideTransition
                  ? J.transitions.slide.normal.setTransition(
                      J.o.slideTransition.type,
                      J.o.slideTransition.obj
                    )
                  : ((i =
                      !!J.transitions.nextSlide.data.transition2d &&
                      J.transitions.nextSlide.data.transition2d
                        .toString()
                        .split(",")),
                    J.device.touchPrev && J.o.slideOnSwipe
                      ? ((J.device.touchPrev = !1), this.transition("2d", "1"))
                      : J.device.touchNext && J.o.slideOnSwipe
                      ? ((J.device.touchNext = !1), this.transition("2d", "1"))
                      : J.slides.next.data.$background ||
                        (i &&
                          (!i ||
                            -1 != i.indexOf("1") ||
                            -1 != i.indexOf("2") ||
                            -1 != i.indexOf("3") ||
                            -1 != i.indexOf("4")))
                      ? J.browser.supports3D() &&
                        (J.transitions.nextSlide.data.transition3d ||
                          J.transitions.nextSlide.data.customtransition3d)
                        ? J.transitions.nextSlide.data.transition3d &&
                          J.transitions.nextSlide.data.customtransition3d
                        ...
                        : J.transitions.nextSlide.data.transition2d &&
                          J.transitions.nextSlide.data.customtransition2d
                        ? ((e = Math.floor(2 * Math.random())),
                          (t = [
              ...
              transition: function (e, t) {
                J.debugMode && J.debug.add("group", "slideTransition.info"),
                  (t += "");
                var i,
                  s,
                  a = -1 == e.indexOf("custom") ? J.t : J.ct,
                  r = "3d";
                -1 != e.indexOf("2d") && (r = "2d"),
                  (s =
                    -1 != t.indexOf("last")
                      ...
                      : -1 != t.indexOf("all")
                      ? Math.floor(
                          Math.random() * J.functions.countProp(a["t" + r])
                        )
                      : ((t = (i = t.split(",")).length),
                        parseInt(i[Math.floor(Math.random() * t)]) - 1)),
                  void 0 === a["t" + r][s] &&
                    (J.debugMode &&
                      J.debug.add("warn", "slideTransition.customTransition", [
                        r.toUpperCase() +
                    ...
                    (s = 0)),
                  J.debugMode &&
                    J.debug.add("log", "slideTransition.info", [
                      r.toUpperCase() +
                        (-1 === e.indexOf("custom") ? "" : " (CUSTOM)"),
                      s + 1,
                      a["t" + r][s].name,
                    ]),
                  J.transitions.slide.normal.setTransition(r, a["t" + r][s]);
              },
            },
            setTransition: function (e, t) {
              ...
              var i,
                ...
                m =
                  !!J.transitions.curSlide.data.$background &&
                  J.functions.getURL(J.transitions.curSlide.data.$background),
                f =
                  !!J.transitions.nextSlide.data.$background &&
                  J.functions.getURL(J.transitions.nextSlide.data.$background),
                g =
                  J.o.playByScroll && "up" === J.device.scroll.direction
                    ? "to"
                    : "from";
              if (n.rc) {
                switch (typeof n.rc) {
                  case "number":
                    J.slider.width > J.slider.height
                      ? ((d = n.rc),
                        (l = Math.floor(
                          J.slider.width / (J.slider.height / n.rc)
                        )))
                      : ((l = n.rc),
                        (d = Math.floor(
                          J.slider.height / (J.slider.width / n.rc)
                        )));
                    break;
                  case "string":
                    (a = parseInt(n.rc)),
                      (l = Math.floor(J.slider.width / a)),
                      (d = Math.floor(J.slider.height / a));
                }
                (n.cols = l), (n.rows = d);
              } else {
                switch (l) {
                  ...
                  case "string":
                    l =
                      Math.floor(
                        Math.random() *
                          (parseInt(n.cols.split(",")[1]) -
                            parseInt(n.cols.split(",")[0]) +
                            1)
                      ) + parseInt(n.cols.split(",")[0]);
                    break;
                  default:
                    l =
                      Math.floor(Math.random() * (n.cols[1] - n.cols[0] + 1)) +
                      n.cols[0];
                }
                switch (d) {
                  case "number":
                  ...
                  case "string":
                    d =
                      Math.floor(
                        Math.random() *
                          (parseInt(n.rows.split(",")[1]) -
                            parseInt(n.rows.split(",")[0]) +
                            1)
                      ) + parseInt(n.rows.split(",")[0]);
                    break;
                  default:
                    d =
                      Math.floor(Math.random() * (n.rows[1] - n.rows[0] + 1)) +
                      n.rows[0];
                }
                te.isMobile &&
                  J.o.optimizeForMobile &&
                  (15 <= l
                    ? (l = 7)
                    : 5 <= l
                    ? (l = 4)
              ...
              J.debugMode &&
                !J.o.slideTransition &&
                (J.debug.add("log", "slideTransition.properties", [
                  [l, d],
                  l * d,
                ]),
                J.debug.groupEnd()),
                (i = Math.floor(J.slider.width / l)),
                (s = Math.floor(J.slider.height / d)),
                (l = Math.floor(J.slider.width / i)),
                (d = Math.floor(J.slider.height / s)),
                (r = J.slider.width - i * l),
                (o = J.slider.height - s * d),
                "prev" == p &&
                  ((t = {
                    random: "random",
                    forward: "reverse",
                  ...
                  "2d" === e &&
                    n.transition &&
                    "scale" === n.transition.type &&
                    ((t.forward = "forward"), (t.reverse = "reverse")),
                  n.tile &&
                    n.tile.sequence &&
                    (n.tile.sequence = t[n.tile.sequence]),
                  ie.each(["animation", "before", "after"], function (e, t) {
                    n[t] &&
                      n[t].transition &&
                      ((t = n[t].transition).rotateX &&
              ...
              ("transparent" === J.transitions.nextSlide.data.backgroundColor ||
                ...
                "2d" == e &&
                  ((y = -1 != n.name.toLowerCase().indexOf("carousel")),
                  (v = -1 != n.name.toLowerCase().indexOf("crossfad")),
                  (this.$curTiles = ie("<div>")
                    .addClass("ls-curtiles")
                    .appendTo(J.transitions.slide.$wrapper)),
                  (this.$nextTiles = ie("<div>")
              ...
              for (var S = 0; S < l * d; S++) {
                var b,
                  ...
                  k = ie("<div>")
                    ...
                    .css({ width: i + x, height: s + T })
                    .data("style", { width: i + x, height: s + T })
                    .appendTo(J.transitions.slide.$wrapper),
                  u = (c[S], S % l == 0 ? u + 1 : u),
                  h = S % l == 0 ? 1 : h + 1;
                if ("3d" == e) {
                  ...
                  var C,
                    ...
                    $ =
                      Math.abs(Math.abs(h - l / 2 - 0.5) - l / 2 - 0.5) *
                      Math.abs(Math.abs(u - d / 2 - 0.5) - d / 2 - 0.5);
                  k.css({ zIndex: $ }),
                    (C = O / 2),
                    (P = I / 2),
                    (T =
                      ($ =
                        "horizontal" == n.animation.direction
                          ? 90 < Math.abs(n.animation.transition.rotateY) &&
                            "large" != n.tile.depth
                            ? Math.floor(O / 7) + x
                            : O
                          : 90 < Math.abs(n.animation.transition.rotateX) &&
                            "large" != n.tile.depth
                          ? Math.floor(I / 7) + T
                          : I) / 2),
                    this.createCuboids(
                    ...
                    "vertical" == n.animation.direction &&
                    90 < Math.abs(n.animation.transition.rotateX)
                      ? this.createCuboids(
                          "ls-3d-back",
                          k.find(".ls-3d-box"),
                    ...
                    (O = k.find(".ls-3d-front")),
                    ($ =
                      "horizontal" == n.animation.direction
                        ? 90 < Math.abs(n.animation.transition.rotateY)
                          ? k.find(".ls-3d-back")
                          : 0 < n.animation.transition.rotateY
                          ? k.find(".ls-3d-left")
                          : k.find(".ls-3d-right")
                        : 90 < Math.abs(n.animation.transition.rotateX)
                        ? k.find(".ls-3d-back")
                        : 0 < n.animation.transition.rotateX
                        ? k.find(".ls-3d-bottom")
                        : k.find(".ls-3d-top")),
                    (I = c[S] * n.tile.delay),
                    (T = J.transitions.slide.$wrapper.find(
                      ".ls-3d-container:eq( " + S + " ) .ls-3d-box"
                    )),
                    n.before && n.before.transition
                      ? ((n.before.transition.delay = n.before.transition.delay
                          ? (n.before.transition.delay + I) / 1e3
                          : I / 1e3),
                        L.to(
                          T[0],
                          n.before.duration / 1e3,
                          J.functions.convert.transition(
                            n.before.transition,
                            n.before.easing
                          )
                        ))
                      : (n.animation.transition.delay = n.animation.transition
                          .delay
                          ? (n.animation.transition.delay + I) / 1e3
                          : I / 1e3),
                    L.to(
                      T[0],
                      n.animation.duration / 1e3,
                      J.functions.convert.transition(
                        n.animation.transition,
                        n.animation.easing
                      )
                    ),
                    n.after &&
                      (n.after.transition || (n.after.transition = {}),
                      L.to(
                        T[0],
                        n.after.duration / 1e3,
                        J.functions.convert.transition(
                          n.after.transition,
                          n.after.easing,
                          "after"
                    ...
                    J.transitions._slideTransition.add(L, 0);
                } else {
                  var B,
                    M,
                    W,
                  ...
                  switch (
                    (-1 != n.name.toLowerCase().indexOf("mirror") &&
                      S % 2 == 0 &&
                      (p = "prev" == p ? "next" : "prev"),
                    "prev" == p &&
                      (Z = {
                    ...
                    case "right":
                      ...
                      break;
                    case "topleft":
                      (R = k.data("style").height),
                        (N = 0),
                        (E = k.data("style").width),
                        (Y = 0);
                      break;
                    case "topright":
                      (R = k.data("style").height),
                  ...
                  switch (
                    ((this.scale2D =
                      void 0 !== n.transition.scale ? n.transition.scale : 1),
                    1 == y &&
                      1 != this.scale2D &&
                      ((R /= 2), (N /= 2), (E /= 2), (Y /= 2)),
                    (n.transition.rotate ||
                      n.transition.rotateX ||
                      n.transition.rotateY ||
                      1 != this.scale2D) &&
                    "slide" != n.transition.type
                    ...
                    n.transition.hasOwnProperty("opacity")
                      ? ((D = k.appendTo(this.$curTiles)),
                        (F = k.clone().appendTo(this.$nextTiles)),
                        (O = ie("<div>").addClass("ls-curtile").appendTo(D)))
                      : (F = k.appendTo(this.$nextTiles)),
                    ($ = ie("<div>").addClass("ls-nexttile").appendTo(F)),
                    (A = (c[S] * n.tile.delay) / 1e3),
                    (L = n.transition.rotate || 0),
                    (z = n.transition.rotateX || 0),
                    (D = n.transition.rotateY || 0),
                    "prev" == p && ((L = -L), (z = -z), (D = -D)),
                    n.transition.type)
                  ) {
                    case "fade":
                    ...
                    case "mixed":
                      (X = 0),
                        (H = 1) == this.scale2D && (N = Y = 0),
                        (B =
                          void 0 !== n.transition.scaleX
                            ? n.transition.scaleX
                            : void 0 !== n.transition.scale
                            ? n.transition.scale
                            : 1),
                        (M =
                          void 0 !== n.transition.scaleY
                            ? n.transition.scaleY
                            : void 0 !== n.transition.scale
                            ? n.transition.scale
                            : 1);
                        ...
                        (void 0 !== J.transitions.nextSlide.data.$background &&
                          (-1 !=
                            J.transitions.nextSlide.data.$background
                              ...
                              .toLowerCase()
                              .indexOf("png") ||
                            J.transitions.nextSlide.data.$background.width() <
                              J.slider.width ||
                            J.transitions.nextSlide.data.$background.height() <
                              J.slider.height))) &&
                      (q.opacity = 0),
                    ("slide" != n.transition.type && 1 != y) ||
                    -1 != n.name.toLowerCase().indexOf("mirror")
                      ? "scale" == n.transition.type &&
                        ((q.scaleX = W || B),
                        (q.scaleY = _ || M),
                      ...
                      : ((V = 0 !== L ? -L : 0),
                        ...
                        (q.opacity = X)),
                    n.transition.hasOwnProperty("opacity") &&
                      (q.opacity = n.transition.opacity),
                    void 0 !== O &&
                      J.transitions._slideTransition.to(
                        O[0],
                        n.transition.duration / 1e3,
                        {
                          autoCSS: !1,
                ...
                (V = (S % l) * i),
                  (q = Math.floor(S / l) * s),
                  void 0 !== J.transitions.curSlide.data.$background &&
                    ((b = J.transitions.curSlide.data.$background.data(
                      J.defaults.init.dataKey
                    )),
                    "3d" === e ||
                    ("2d" === e &&
                      (!0 === v ||
                        ...
                        n.transition.hasOwnProperty("opacity")))
                      ? O.append(
                          ie('<div style="position: absolute;">')
                            .css({
                              width: J.slider.width,
                              height: J.slider.height,
                              left: -V,
                  ...
                  "transparent" ===
                    J.transitions.curSlide.data.backgroundColor ||
                    J.transitions.curSlide.data.$backgroundVideo.length ||
                    ("3d" === e ||
                    ("2d" === e &&
                      (!0 === v || "slide" === n.transition.type || !0 === y))
                      ? O
                      : this.$curTiles
                    ).css(
                      "background-color",
                  ...
                  void 0 !== J.transitions.nextSlide.data.$background &&
                    ((b = (A = J.transitions.nextSlide.data.$background.data(
                      J.defaults.init.dataKey
                    )).kenBurns[g]),
                    $.append(
                      ie('<div style="position: absolute;">')
                        ...
                        .append(
                          ie("<img>")
                            ...
                            .css({
                              ...
                              filter:
                                J.transitions.nextSlide.filter.from || "none",
                              transform:
                                "translateX(" +
                                A.responsive.x +
                                "px) translateY(" +
                  ...
                  "transparent" ===
                    J.transitions.nextSlide.data.backgroundColor ||
                    J.transitions.nextSlide.data.$backgroundVideo.length ||
                    $.css(
                      "background-color",
                      J.transitions.nextSlide.data.backgroundColor
                    );
              }
              J.transitions.slide.$wrapper.prependTo(
                J.o.preferBlendMode
                  ? J.slider.$layersWrapper
                  : J.slider.$innerWrapper
              ),
                J.transitions.slide.start();
            },
            createCuboids: function (e, t, i, s, a, r, o, n, l, d) {
              ...
              d &&
                ...
                ie("<div>").addClass(e).css(o).appendTo(t);
            },
          },
        },
        layers: {
          setZIndex: function (e, t, i) {
            t.original._zIndex ||
              (t.original._zIndex = parseInt(
                t.elements.$outerWrapper.css("zIndex")
              )),
              i !== parseInt(t.elements.$outerWrapper.css("zIndex")) &&
                t.elements.$outerWrapper.css({ zIndex: i });
          },
          in: {
            onStart: function (e) {
              var t = e.data(J.defaults.init.dataKey);
              t.hover.enabled && J.transitions.layers.hover.enable(e),
                J.layers.set.dataAttribute("add", e, "animating-in"),
                t.in.zIndex &&
                  J.transitions.layers.setZIndex(e, t, t.in.zIndex),
                "instant" === t.mediaSettings.autoplay &&
                  J.media.functions.playIfAllowed(e);
            },
            onComplete: function (e) {
              ...
              "instant" !== t.mediaSettings.autoplay &&
                J.media.functions.playIfAllowed(e),
                t.in.zIndex &&
                  J.transitions.layers.setZIndex(e, t, t.original._zIndex),
                J.layers.set.dataAttribute("remove", e, "animating-in"),
                J.layers.set.dataAttribute("add", e, "active");
            },
          },
          out: {
            forced: function () {
              var a, r, o, n, e, t, i;
              J.transitions._forceLayersOut &&
                (J.transitions._slideTimeline &&
                  ((a = new ee.TimelineMax({
                    paused: !0,
                  ...
                  (i = J.layers.get("current, out, notstatic, active")),
                  (t = J.layers.get("current, out, active")),
                  (i = ie().add(e).add(i)),
                  i.each(function () {
                    var e,
                      t = ie(this).data(J.defaults.init.dataKey);
                    if (
                      (t.loop._timeline &&
                        (J.transitions._slideTimeline.remove(t.loop._timeline),
                      ...
                      for (var i = 0; i < r.length; i++)
                        n = n.concat(
                          J.transitions._slideTimeline.getTweensOf(r[i], !0),
                          J.transitions._slideTimelineAlternate.getTweensOf(
                            r[i],
                            !0
                          )
                        );
                  ...
                  a.play().seek(100),
                  J.transitions._slideTimeline.eventCallback("onStart", null),
                  J.transitions._slideTimeline.eventCallback(
                    "onComplete",
                    null
                  ),
                  J.transitions._slideTimeline.eventCallback(
                  ...
                  J.transitions._slideTimeline.eventCallback("onUpdate", null),
                  J.transitions._slideTimeline.stop().clear(),
                  J.transitions._slideTimelineAlternate.stop().clear()),
                ("prev" === J.navigation.direction
                  ? J.transitions._forceLayersOutMirror
                  : J.transitions._forceLayersOut
                ).play(),
                J.slideshow.forceFastChange &&
                  (J.transitions._forceLayersOut.progress(1),
                  J.transitions._forceLayersOutMirror.progress(1))),
                J.slider.$layersWrapper
                  .find(".ls-link")
                  .css({ display: "none" });
            },
            onStart: function (e) {
              var t = e.data(J.defaults.init.dataKey);
              t.out.zIndex
                ? J.transitions.layers.setZIndex(e, t, t.out.zIndex)
                : t.in.zIndex &&
                  J.transitions.layers.setZIndex(e, t, t.original._zIndex),
            ...
            onComplete: function (e) {
              var t = e.data(J.defaults.init.dataKey);
              (!J.slider.state.changingSlides &&
                t.settings.slideOut === J.slides.current.index) ||
                J.transitions.layers.reset(e, t),
                t.hover.enabled && J.transitions.layers.hover.disable(e),
                J.layers.set.dataAttribute("remove", e, "animating-out"),
                J.layers.set.dataAttribute("add", e, "hidden");
            },
          },
          reset: function (e, t) {
            t.original._zIndex &&
              ...
              t.clip.enabled &&
                (t.loop.enabled &&
                  ee.TweenMax.set(t.elements.$loopWrapper[0], t.clip.style),
                t.inClipFromCSS.clipPath ||
                  ee.TweenMax.set(t.elements.$clipWrapper[0], t.clip.style)),
              ee.TweenMax.set(
          ...
          timeline: {
            ...
            create: function (e) {
              var t,
                ...
                a = e ? "current" : "next";
              if (
                ((J.transitions.curNext = a),
                J.o.allowRestartOnResize
                  ? J.slider.isScrollScene &&
                    (J.transitions.layers.timeline.shouldRestart = !0)
                  : (J.transitions.layers.timeline.shouldRestart = !1),
                J.transitions.layers.timeline.resetStates(),
                ...
                (J.transitions._slideTimeline = new ee.TimelineMax({
                  paused: !0,
                  onStart: function () {
                    J.api.hasEvent("slideTimelineDidStart") &&
                      J.api.triggerEvent(
                  ...
                  onComplete: function () {
                    J.o.playByScroll &&
                      J.o.playByScrollSkipSlideBreaks &&
                      ("next" === J.slideshow.direction
                        ? J.transitions.layers.timeline.scrollForward(!0)
                        : J.transitions.layers.timeline.scrollBackwards(
                            !0,
                            !0
                          ));
                  },
                  onReverseComplete: function () {
                    J.api.hasEvent("slideTimelineDidReverseComplete") &&
                      J.api.triggerEvent(
                        "slideTimelineDidReverseComplete",
                        J.api.eventData()
                      ),
                      J.transitions.layers.timeline.shouldReplay &&
                        ((J.transitions.layers.timeline.shouldRestart = !1),
                        J.transitions._slideTimeline.play()),
                      J.o.playByScroll &&
                        J.o.playByScrollSkipSlideBreaks &&
                        J.transitions.layers.timeline.scrollBackwards(!0, !1);
                  },
                  onUpdate: function (e) {
                    J.api.hasEvent("slideTimelineDidUpdate") &&
                      J.api.triggerEvent("slideTimelineDidUpdate", e);
                  },
                  onUpdateParams: ["{self}"],
                })),
                ...
                (this.progress = 1),
                J.transitions.timelines.set("prevforce", function (e, t) {
                  e.progress(1).kill().clear(!0), (e = null);
                }),
                J.transitions._forceLayersOut &&
                  (J.transitions._forceLayersOutPrevious =
                    J.transitions._forceLayersOut),
                J.transitions._forceLayersOutMirror &&
                  (J.transitions._forceLayersOutMirrorPrevious =
                    J.transitions._forceLayersOutMirror),
                (J.transitions._forceLayersOut = new ee.TimelineMax({
                  paused: !0,
                  autoRemoveChildren: !0,
                })),
                ...
                (t = J.layers.get(a + ", in, notactive")),
                (i = J.layers
                  .get(a + ", out, notstatic")
                  .add(J.layers.get(a + ", out, active, static"))),
                (e = J.layers.get(a + ", in, bgonly, notactive")),
                (s = ie().add(t).add(i).add(e)),
                this.addLayers(
                  t,
                  "in",
                  J.transitions._slideTimeline,
                  J.transitions._forceLayersOut,
                  J.transitions._slideTimelineAlternate,
                  J.transitions._forceLayersOutMirror
                ),
                this.addLayers(
                  i,
                ...
                J.slides[a].data &&
                -1 !== J.slides[a].data.duration &&
                J.slides[a].data.duration < this.totalDuration
                  ? ((this.progress =
                      J.slides[a].data.duration / this.totalDuration),
                    J.debugMode &&
                      J.debug.add("warn", "slideTimeline.duration", [
                        J.slides[a].data.duration,
                        this.totalDuration,
                      ]))
                  : J.transitions._slideTimeline.duration() >
                      this.totalDuration &&
                ...
                -1 === J.slides[a].data.duration
                  ? (J.o.slideDuration &&
                    ie.isNumeric(J.o.slideDuration) &&
                    -1 < J.o.slideDuration
                      ? (this.totalDuration = J.o.slideDuration / 1e3)
                      : 0 === this.totalDuration &&
                        (this.totalDuration =
                          J.o.slideDurationWithoutLayers / 1e3),
                    J.o.inLayerPreview &&
                      (J.o.hasInfiniteLoop &&
                      "loop-transition" === J.o.layerPreviewPresetType
                        ? (this.totalDuration += 5)
                        : "ending-transition" === J.o.layerPreviewPresetType
                        ? (this.totalDuration += 0.25)
                        : "hover-transition" !== J.o.layerPreviewPresetType &&
                          (this.totalDuration += 0.5)),
                    (J.slides[a].data.duration = this.totalDuration),
                    (J.slides[J.slides[a].index].data.duration =
                      this.totalDuration))
                  : (this.totalDuration = J.slides[a].data.duration),
                !J.functions.getData("slideDuration", this.totalDuration))
              )
                return !1;
              J.slider.isScrollScene &&
                (J.o.sceneDuration ||
                  ((J.o.sceneDuration = this.totalDuration), J.resize.scene()),
                J.slider.$spacingWrapper.attr(
                  "data-scene-duration",
                  J.o.sceneDuration
                )),
                this.addLayers(
                ...
                !0 === J.transitions.layers.timeline.shouldRestart &&
                  J.debugMode &&
                  J.debug.add(
                    "warn",
                    "slideTimeline.restart",
                    J.o.allowRestartOnResize ? "enabled" : "disabled"
                  );
              for (var r, o = 0; o < s.length; o++)
                ie(s[o]).data(J.defaults.init.dataKey).parallax.enabled &&
                  ie(s[o])
                    .data(J.defaults.init.dataKey)
              ...
              J.transitions.layers.parallax.trigger(),
                J.transitions.layers.scroll.reset(),
                J.transitions.layers.scroll.trigger(),
                J.api.hasEvent("slideTimelineDidCreate") &&
                  J.api.triggerEvent("slideTimelineDidCreate", {
                    slideTimeline: J.transitions._slideTimeline,
                    layersOnSlideTimeline: s,
                    slideTimelineDuration: this.totalDuration,
                  }),
                J.transitions.timers.create(),
                J.transitions.timers.bar._transition &&
                  J.transitions._slideTimeline.add(
                    J.transitions.timers.bar._transition.play(),
                    0
                  ),
                J.transitions.timers.circle._transition &&
                  J.transitions._slideTimeline.add(
                    J.transitions.timers.circle._transition.play(),
                    0
                  ),
                J.transitions.timers.slidebar._transition &&
                  J.transitions._slideTimeline.add(
                    J.transitions.timers.slidebar._transition.play(),
                    0
                  ),
                J.transitions._slideTimeline.call(
                  function () {
                    if (!J.transitions._slideTimeline.reversed()) {
                      ...
                      if (J.api.hasEvent("slideTimelineDidComplete"))
                        if (
                          (J.o.inLayerPreview &&
                            J.o.hasInfiniteLoop &&
                            J.layers.get("current, in").each(function () {
                              (e = ie(this).data(J.defaults.init.dataKey))
                                .loop &&
                                e.loop._timeline &&
                      ...
                      J.functions.setStates(J.transitions.layers.timeline, {
                        ...
                        !J.slideshow.isPaused() && J.slideshow.state.running
                          ? J.slideshow.changeTo(J.slides.next.index)
                          : J.slideshow.state.pausedByLastCycle &&
                            J.transitions.timers.reverse();
                    }
                  },
                  [],
                ...
                J.slides.next.data.$link &&
                  J.slides.next.data.$link.css({ display: "block" }),
                ((!J.o.startInViewport ||
                  ("inside" !== J.slider.position.toViewport &&
                    !J.o.playByScrollStart &&
                    J.slider.state.waitForGettingInViewport)) &&
                  J.o.startInViewport) ||
                  (!(
                    J.slider.isPopup &&
                    J.slider.state.popupIsVisible &&
                    J.slider.state.popupShouldStart
                  ) &&
                    J.slider.isPopup) ||
                  (J.o.pauseLayers && J.slideshow.isPaused()
                    ? J.transitions.layers.timeline.pause(0)
                    : J.slider.isScrollScene ||
                      J.transitions.layers.timeline.play(),
                  J.o.playByScroll &&
                    "up" === J.device.scroll.directionAtSlideTransitionStart &&
                    J.transitions._slideTimeline.progress(1)),
                J.transitions._slideTimelineAlternate.play(),
                J.slider.isScrollScene && J.slider.set.offset(),
                ...
                J.slides[a].data.globalhover &&
                  ((r = J.layers
                    .get(a + ",in,notactive")
                    .add(J.layers.get("static,active"))),
                  $.on("mouseenter.globalhover" + B, function () {
                    r.each(function () {
                      J.transitions.layers.hover.mouseEnter(
                        ie(this),
                        ie(this).data(J.defaults.init.dataKey)
                      );
                    });
                  }),
                  $.on("mouseleave.globalhover" + B, function () {
                    r.each(function () {
                      J.transitions.layers.hover.mouseLeave(
                        ie(this),
                        ie(this).data(J.defaults.init.dataKey)
                      );
                    });
                  ...
                  $.on("mousemove.globalhover" + B, function () {
                    r.each(function () {
                      J.transitions.layers.hover.mouseMove(
                        ie(this),
                        ie(this).data(J.defaults.init.dataKey)
                      );
                    });
            ...
            prepare: function () {
              J.slides.next.data.overflow &&
              "hidden" !== J.slides.next.data.overflow
                ? (J.slider.$layersWrapper.addClass("ls-visible"),
                  J.slider.$slideBGWrapper.addClass("ls-visible"))
            ...
            getTiming: function (e, t, i, s) {
              ...
              var a,
                ...
                n,
                l,
                d = J.defaults.layer.timelineHierarchy,
                c = 0;
              if (
                (-1 !== t.indexOf("*") && (l = "*"),
                -1 !== t.indexOf("/") && (l = "/"),
                ...
                if (
                  ...
                  J.debugMode &&
                    (d[a] || J.debug.add("warn", "layerTransition.timing1", a),
                    -1 === d[i][1].indexOf(d[a][0]) &&
                      J.debug.add("warn", "layerTransition.timing3", [
                        a,
                        d[a],
                        i,
                        d[i],
                ...
                d[(a = ie.trim(t))] && -1 !== d[i][1].indexOf(d[a][0])
                  ? (c = s
                      ? 0
                      : "number" == typeof e.timeline[a]
                      ? e.timeline[a]
                  ...
                  : J.debugMode &&
                    (d[a]
                      ...
                      : J.debug.add("warn", "layerTransition.timing1", a));
              return (
                (c != c || c < 0) &&
                  (J.debugMode &&
                    J.debug.add("warn", "layerTransition.timing2", [i, a, c]),
                  (c = 0)),
                c
              );
            },
            addLayers: function (e, t, i, s, a, r) {
              for (var o = 0, n = e.length; o < n; o++) {
                var l,
                  ...
                  S =
                    (f.elements.$scrollWrapper,
                    f.elements.$scrollTransformWrapper,
                    f.settings.skipViewport && J.slideshow.state.changed < 1
                      ? a
                      : i),
                  b =
                    "loop" == f.settings.skipViewport &&
                    J.slideshow.state.changed < 1
                      ? a
                      : i,
                ...
                if (
                  (f.should.reset && J.transitions.layers.reset(m, f),
                  m.hasClass("ls-bg"))
                )
                  f.kenBurns.zoom &&
                    i.fromTo(
                      m.closest(".ls-bg-wrap"),
                      J.transitions.nextSlide.data.duration +
                        J.transitions.nextSlide.data.calculatedTimeShift,
                      { autoCSS: !1, css: f.kenBurns.from },
                      {
                        autoCSS: !1,
                        css: f.kenBurns.to,
                    ...
                    (ie.isEmptyObject(f.filter.values.bgFrom) &&
                      ie.isEmptyObject(f.filter.values.bgTo)) ||
                      (f.filter.transitions.bg ||
                        (f.filter.transitions.bg =
                          J.transitions.layers.filters.createTransition(
                            f,
                            "bg",
                            f.filter.values.bgFrom,
                            f.filter.values.bgTo
                          )),
                      S.to(
                        [{ p: 0 }, h],
                        J.transitions.nextSlide.data.duration,
                  ...
                  switch (t) {
                    case "in":
                      if (
                        (f.in.enabled
                          ? ((f.settings.timelineIsCalculated &&
                              !f.settings.recalculateTimeline) ||
                              ("startAtFirst" ==
                                f.settings.recalculateTimeline &&
                                ((f.settings.recalculateTimeline = !1),
                                (f.settings.timelineIsCalculated = !1)),
                              "number" != typeof f.in.startAt &&
                                (f.in.startAt = 0),
                              "number" != typeof f.in.startAtFirst &&
                                (f.in.startAtFirst = 0),
                              (f.timeline.transitioninstart =
                                J.transitions.firstSlide && f.in.startAtFirst
                                  ? f.in.startAtFirst
                                  : f.in.startAt),
                              (f.timeline.transitioninend =
                                f.timeline.transitioninstart + f.in.duration)),
                            J.transitions.firstSlide &&
                              f.in.startAtFirst &&
                              (f.settings.recalculateTimeline = "startAtFirst"),
                            J.resize.performTransformOperations(
                              f.inLayerToCSS,
                              T
                            ),
                            f.in.mirror &&
                              "prev" === J.navigation.direction &&
                              J.resize.mirrorTransitionProperties({
                                transitionProperties: T,
                                transitionPropertiesShouldBeConverted: k,
                                transitionType: "normal",
                                mirrorProperties: f.in.mirror,
                              }),
                            J.resize.transformProperties(m, f, T, k),
                            J.resize.styleProperties(
                              f,
                              f.inLayerStyleFromCSS,
                              f.inLayerStyleShouldBeConvertedFrom
                            ),
                            J.resize.styleProperties(
                              f,
                              f.inLayerStyleToCSS,
                              f.inLayerStyleShouldBeConvertedTo
                            ),
                            (T.transformPerspective =
                              f.transformPerspective.layer *
                              f.settings.calculatedratio),
                            f.clip.enabled &&
                              ((f.clip.style.css.clipPath =
                                J.functions.convert.clipProperties(
                                  f.clip.style.css.clipPath,
                                  f,
                                  m,
                                  !0
                                )),
                              f.inClipFromCSS.clipPath ||
                                f.clip.style.css.clipPath ===
                                  f.clip.default.css.clipPath ||
                                (f.inClipFromCSS.clipPath =
                                  f.clip.default.css.clipPath)),
                            f.inClipFromCSS.clipPath &&
                              ((f.inClipFromCSS.clipPath =
                            ...
                            ie.isEmptyObject(f.filter.values.in)
                              ? ie.isEmptyObject(f.filter.values.out) ||
                                m.css("filter", f.original.filter)
                              : (f.filter.transitions.in ||
                                  (f.filter.transitions.in =
                                    J.transitions.layers.filters.createTransition(
                                      f,
                                      "in",
                                      f.filter.values.in,
                                      f.filter.values.style
                                    )),
                                S.to(
                                  [{ p: 0 }, h],
                                  f.in.duration,
                                  {
                                    ...
                                    onUpdate:
                                      J.transitions.layers.filters.animate,
                                    onUpdateParams: [
                                      "{self}",
                                      f.filter.transitions.in,
                                    ],
                            ...
                            f.is.smartBG &&
                              -1 !== f.styleSettings.smartbg.indexOf("in") &&
                              ((f.inLayerStyleFrom.css["--x"] =
                                parseInt(f.responsive["--x"]) - T.x + "px"),
                              (f.inLayerStyleTo.css["--x"] =
                                parseInt(f.responsive["--x"]) + "px"),
                              (f.inLayerStyleFrom.css["--y"] =
                                parseInt(f.responsive["--y"]) - T.y + "px"),
                              (f.inLayerStyleTo.css["--y"] =
                                parseInt(f.responsive["--y"]) + "px")),
                            0 === f.timeline.transitioninstart &&
                            0 === f.in.duration
                              ? ((f.inLayerTo.css.transformOrigin =
                                  x.css.transformOrigin),
                                (f.inLayerTo.css.transformPerspective =
                                  x.css.transformPerspective),
                                S.set(
                                  g[0],
                                  f.inLayerTo,
                                  f.timeline.transitioninstart
                          ...
                          : ((f.timeline.transitioninstart = 0),
                            (f.timeline.transitioninend = 0)),
                        f.is.textLayer &&
                          ((f.textIn.type || f.textOut.type) &&
                            J.transitions.layers.splitType.resetNodes(m, f),
                          f.textIn.enabled &&
                            ((p = !(
                              !f.textIn.mirror ||
                              "prev" !== J.navigation.direction
                            ...
                            f.in.enabled ||
                              S.to(
                                g[0],
                                0,
                                ie.extend(!0, {}, f.inLayerTo, f.init.wrapper),
                                f.timeline.textinstart
                              ),
                            (d =
                              J.transitions.layers.splitType.setNodesSequence(
                                f.textIn.type.split("_"),
                                f.textIn.ns
                              )),
                            (f.textIn.nodes = p ? d[1] : d[0]),
                            p &&
                              J.resize.mirrorTransitionProperties({
                            ...
                            (I.transformPerspective =
                              f.transformPerspective.text *
                              f.settings.calculatedratio),
                            ie.isEmptyObject(L.random) ||
                              J.transitions.layers.splitType.setRandomProperties(
                                m,
                                f,
                                L.random,
                                I,
                            ...
                            delete I.random,
                            f.settings.timelineIsCalculated ||
                              ((f.timeline.textinstart = this.getTiming(
                                f,
                                f.textIn.startAt,
                                "textinstart"
                              )),
                              (f.timeline.textinend =
                                f.timeline.textinstart +
                                (f.textIn.nodes.length - 1) *
                                  f.textIn.shiftNodes +
                                f.textIn.duration)),
                            I.color
                              ? (f.textInNodesToCSS.color = f.original.color)
                              : f.textOutNodesTo.color &&
                                (I.color = f.original.color),
                            S.set(
                              h,
                              f.textIn.layerStyle,
                              f.timeline.textinstart
                            ...
                            window.getSelection &&
                              ...
                              S.addCallback(
                                ...
                                f.timeline.textinstart + 0.001,
                                [h]
                              ),
                            S.addCallback(
                              function (e) {
                                J.layers.set.dataAttribute(
                                  "add",
                                  e,
                                  "text-animating-in"
                                );
                        ...
                        f.is.keyframe &&
                          J.o.playByScroll &&
                          i.addPause(f.timeline.allinend(), function () {
                            setTimeout(function () {
                              delete J.timeouts.scroll,
                                (J.transitions.layers.timeline.timeScaleModifier = 0),
                                (J.device.scroll.timeout = 250);
                            }, 500);
                          }),
                        f.parallax.enabled && "auto" == f.parallax.event)
                      ) {
                        J.transitions.layers.parallax.auto();
                        var M = new ee.TimelineMax({ paused: !0 }),
                          W = {
                            repeat:
                              -1 == f.parallax.count
                                ? -1
                        ...
                        switch (
                          ((f.settings.timelineIsCalculated && !f.is.static) ||
                            ((f.timeline.autoparallaxstart = this.getTiming(
                              f,
                              f.parallax.startAt,
                              "autoparallaxstart"
                            )),
                            (f.timeline.autoparallaxend =
                              -1 !== f.parallax.count &&
                              f.timeline.autoparallaxstart +
                                f.parallax.duration * f.parallax.count)),
                          (f.parallax._timeline = M),
                          (f.parallax.dummy = { x: 0, y: -10 }),
                          f.parallax.path)
                        ) {
                          default:
                          case "circle":
                        ...
                        (W.onUpdate = function (e, t, i, s, a, r, o) {
                          ...
                          M.to(
                            f.parallax.dummy,
                            -1 == f.parallax.path.indexOf("linear")
                              ? f.parallax.duration
                              : f.parallax.duration / 2,
                            W
                          ),
                          i.addCallback(
                            function (e) {
                      ...
                      f.loop.enabled &&
                        ...
                        (f.settings.timelineIsCalculated && !f.is.static) ||
                          ((f.timeline.loopstart = this.getTiming(
                            f,
                            f.loop.startAt,
                            "loopstart"
                          )),
                          (f.timeline.loopend =
                            -1 !== f.loop.count &&
                            f.timeline.loopstart +
                              (f.loop.repeat + 1) * f.loop.duration +
                              f.loop.repeat * f.loop.repeatDelay)),
                        (f.loop._timeline = c),
                        J.resize.transformProperties(m, f, f.loopToCSS, {
                          x: f.loopLayerShouldBeConverted.x,
                          y: f.loopLayerShouldBeConverted.y,
                        }),
                        ((f.loopToCSS.x && 0 !== f.loopToCSS.x) ||
                          (f.loopToCSS.y && 0 !== f.loopToCSS.y)) &&
                          (J.transitions.layers.timeline.shouldRestart = !0),
                        (f.loopFromCSS.transformOrigin =
                          J.functions.convert.transformOrigin(
                            f.loopLayerShouldBeConverted.transformOrigin,
                            m,
                            f,
                            m.data(J.defaults.init.dataKey).elements
                              .$outerStyleWrapper
                          )),
                        (f.loopFromCSS.transformPerspective =
                          f.transformPerspective.loop *
                          f.settings.calculatedratio),
                        ie.isEmptyObject(f.filter.values.loop) ||
                          (f.filter.transitions.loop ||
                            (f.filter.transitions.loop =
                              J.transitions.layers.filters.createTransition(
                                f,
                                "loop",
                                ie.isEmptyObject(f.filter.values.afterIn)
                                  ? f.filter.values.style
                                  : f.filter.values.afterIn,
                                f.filter.values.loop
                              )),
                          c.to(
                            [{ p: 0 }, h],
                            f.loop.duration,
                        ...
                        f.is.smartBG &&
                          -1 !== f.styleSettings.smartbg.indexOf("loop") &&
                          c.fromTo(
                            h,
                            f.loop.duration,
                            { "--lx": "0px", "--ly": "0px" },
                        ...
                        -1 !== f.loop.repeat &&
                        ("looplayers" === J.o.pauseOnHover ||
                          J.gui.timers.slidebar.$element ||
                          J.o.playByScroll)
                          ? (b.add(c, f.timeline.loopstart), c.play())
                          : b.addCallback(
                              function (e) {
                                e.play();
                              },
                        ...
                        f.is.static &&
                          ((f.timeline.staticfrom = f.timeline.transitioninend),
                          (f.timeline.staticto = "100%"),
                          f.settings.timelineIsCalculated ||
                            ((l = Math.max(f.timeline.allinandloopend(), 0)),
                    ...
                    case "out":
                      f.is.textLayer &&
                        f.textOut.enabled &&
                        ((p = J.transitions.layers.splitType.setNodesSequence(
                          f.textOut.type.split("_"),
                          f.textOut.ns
                        )),
                        (f.textOut.nodes = p[0]),
                        J.resize.transformProperties(
                          ...
                          f,
                          f.textOutNodesTo,
                          f.textOutShouldBeConverted,
                          f.textOutNodesFrom,
                          f.textOut.nodes
                        ),
                        f.textOut.mirror
                          ? ((f.textOut.nodesMirror = p[1]),
                            J.resize.mirrorTransitionProperties({
                              transitionProperties: $,
                          ...
                          : (f.textOut.nodesMirror = p[0]),
                        (f.textOutNodesFrom.transformPerspective =
                          f.transformPerspective.text *
                          f.settings.calculatedratio),
                        ie.isEmptyObject(f.textOutShouldBeConverted.random) ||
                          J.transitions.layers.splitType.setRandomProperties(
                            m,
                            f,
                            f.textOutShouldBeConverted.random,
                            f.textOutNodesTo,
                            "Out"
                          ),
                        ie.isEmptyObject(f.textOutNodesTo.random) ||
                          J.transitions.layers.splitType.setRandomProperties(
                            m,
                            f,
                            f.textOutNodesTo.random,
                            f.textOutNodesTo,
                            "Out"
                          ),
                        delete f.textOutNodesTo.random,
                        f.textOut.mirror &&
                          (ie.isEmptyObject(B.random) ||
                            J.transitions.layers.splitType.setRandomProperties(
                              m,
                              f,
                              B.random,
                          ...
                          delete $.random),
                        f.settings.timelineIsCalculated ||
                          ((f.timeline.textoutstart = this.getTiming(
                            f,
                            f.textOut.startAt,
                            "textoutstart"
                          )),
                          (f.timeline.textoutend =
                            f.timeline.textoutstart +
                            (f.textOut.nodes.length - 1) *
                              f.textOut.shiftNodes +
                            f.textOut.duration)),
                        f.clip.enabled &&
                          !f.loopClipToCSS.clipPath &&
                          f.clip.style.css.clipPath ==
                        ...
                        f.textOutNodesTo.color &&
                          (f.textOutNodesFrom.color = f.original.color),
                        (M = function (e) {
                          J.layers.set.dataAttribute(
                            "add",
                            e,
                        ...
                        (u = [m]),
                        -1 !== f.textOut.startAt.indexOf("slidechangeonly") &&
                        (!f.is.static ||
                          (f.is.static &&
                            f.settings.slideOut === J.slides.next.index))
                          ? (s.set(h, f.textOut.layerStyle, 0),
                            r.set(h, f.textOut.layerStyle, 0),
                            (p = new ee.TimelineMax()).addCallback(M, 0, u),
                            p.staggerFromTo(
                              f.textOut.nodes,
                              f.textOut.duration,
                              f.textOutNodesFrom,
                            ...
                            p.timeScale(
                              p.duration() / J.o.forceLayersOutDuration
                            ),
                            s.add(p, 0),
                            s.to(
                              g[0],
                              0,
                              f.reset.wrapperOnTimelineEnd,
                              J.o.forceLayersOutDuration
                            ),
                            (p = new ee.TimelineMax()).addCallback(M, 0, u),
                            p.staggerFromTo(
                              f.textOut.nodesMirror,
                              f.textOut.duration,
                              f.textOutNodesFrom,
                              $,
                              f.textOut.shiftNodes,
                            ...
                            r.add(p, 0))
                          : (i.addCallback(M, f.timeline.textoutstart, u),
                            i.set(
                              h,
                              f.textOut.layerStyle,
                              f.timeline.textoutstart
                            ),
                            i.staggerFromTo(
                              f.textOut.nodes,
                        ...
                        f.out.enabled &&
                          ...
                          J.resize.transformProperties(
                            ...
                            f,
                            f.outLayerToCSS,
                            f.outLayerShouldBeConverted,
                            f.outLayerFromCSS
                          ),
                          J.resize.styleProperties(
                            f,
                            f.outLayerStyleFromCSS,
                            f.outLayerStyleShouldBeConvertedFrom
                          ),
                          J.resize.styleProperties(
                            f,
                            f.outLayerStyleToCSS,
                            f.outLayerStyleShouldBeConvertedTo
                          ),
                          (f.outLayerFromCSS.transformPerspective =
                            f.transformPerspective.layer *
                            f.settings.calculatedratio),
                          f.out.mirror &&
                            (J.resize.performTransformOperations(
                          ...
                          f.is.smartBG &&
                            -1 !== f.styleSettings.smartbg.indexOf("out") &&
                            ((f.outLayerStyleFrom.css["--x"] =
                              parseInt(f.responsive["--x"]) + "px"),
                            (f.outLayerStyleTo.css["--x"] =
                              parseInt(f.responsive["--x"]) -
                              f.outLayerToCSS.x +
                              "px"),
                            (f.outLayerStyleFrom.css["--y"] =
                              parseInt(f.responsive["--y"]) + "px"),
                            (f.outLayerStyleTo.css["--y"] =
                              parseInt(f.responsive["--y"]) -
                              f.outLayerToCSS.y +
                              "px")),
                          ie.isEmptyObject(f.filter.values.out) ||
                            f.filter.transitions.out ||
                            (f.filter.transitions.out =
                              J.transitions.layers.filters.createTransition(
                                f,
                                "out",
                                ie.isEmptyObject(f.filter.values.afterLoop)
                                  ? ie.isEmptyObject(f.filter.values.afterIn)
                                    ? f.filter.values.style
                                    : f.filter.values.afterIn
                                  : f.filter.values.afterLoop,
                                f.filter.values.out
                              )),
                          f.clip.enabled &&
                            !f.outClipToCSS.clipPath &&
                            f.clip.style.css.clipPath !==
                              f.clip.default.css.clipPath &&
                            (f.outClipToCSS.clipPath =
                              f.clip.default.css.clipPath),
                          ...
                          "slidechangeonly" !== f.out.startAt
                            ? ((f.settings.timelineIsCalculated &&
                                !f.is.static) ||
                                (f.is.static
                                  ? ((f.timeline.staticfrom = 0),
                                    (f.timeline.transitionoutstart =
                                      this.getTiming(
                                        f,
                                        f.out.startAt,
                                        "transitionoutstart",
                                    ...
                                    (f.timeline.staticto =
                                      f.timeline.transitionoutstart))
                                  : (f.timeline.transitionoutstart = Math.max(
                                      this.getTiming(
                                        f,
                                        f.out.startAt,
                                        "transitionoutstart"
                              ...
                              (f.outLayerStyleTo.onComplete = function (e, t) {
                                t.is.mediaLayer &&
                                  t.mediaProperties.$media[0].hasAttribute(
                                    "data-ls-playing"
                                  ) &&
                                  J.media.functions.stopSingleMedia(e, t);
                              }),
                              (f.outLayerStyleTo.onCompleteParams = [m, f]),
                              i.fromTo(
                                g[0],
                                f.out.duration,
                                f.outLayerFrom,
                          ...
                          (!f.is.static ||
                            (f.is.static &&
                              f.settings.slideOut === J.slides.next.index)) &&
                            (s.fromTo(g[0], u, f.outLayerFrom, f.outLayerTo, 0),
                            s.fromTo(
                              h,
                              u,
                              f.outLayerStyleFrom,
                            ...
                            f.outClipToCSS.clipPath &&
                              (s.to(y[0], u, f.outClipTo, 0),
                              r.to(y[0], u, f.outClipTo, 0)),
                            ie.isEmptyObject(f.filter.values.out) ||
                              (s.to(
                                [{ p: 0 }, h],
                                f.out.duration,
                        ...
                        (l = Math.max(f.timeline.alloutandloopend(), 0)),
                        (this.totalDuration = Math.max(this.totalDuration, l)),
                        (f.settings.timelineIsCalculated = !0);
                  }
              }
            },
            play: function () {
            ...
            pause: function (e) {
              e = ie.isNumeric(e) ? e : 0.75;
              J.transitions._slideTimeline &&
                (ee.TweenMax.to(J.transitions._slideTimeline, e, {
                  timeScale: 0,
                  onComplete: function (e) {
                    e.pause();
                  },
                ...
                J.functions.setStates(this, { paused: !0, stopped: !1 }));
            },
            resume: function () {
              J.transitions._slideTimeline &&
                (this.state.paused && J.transitions._slideTimeline.play(),
                ee.TweenMax.to(J.transitions._slideTimeline, 0.75, {
                  timeScale: 1,
                }),
                J.functions.setStates(this, { paused: !1, stopped: !1 }));
            },
            reverse: function () {
              J.transitions._slideTimeline &&
                J.transitions._slideTimeline.reverse();
            },
            scrollForward: function (e) {
              e || (this.play(), this.modifyTimeScale()),
                J.transitions._slideTimeline &&
                  (J.slider.isBusy() ||
                    (0 !== J.transitions._slideTimeline.totalDuration() &&
                      1 !== J.transitions._slideTimeline.progress()) ||
                    "down" !== J.device.scroll.direction ||
                    ((J.slideshow.direction = "next"),
                    (e = J.slideshow.sequence.normalized).indexOf(
                      J.slides.current.index
                    ) ===
                    e.length - 1
                      ? ((J.slider.positionToViewport = "under"),
                        J.device.scroll.enable(),
                        (J.slideshow.direction = "prev"))
                      : J.navigation.next()));
            },
            scrollBackwards: function (e, t) {
              (e && !t) || (this.reverse(), this.modifyTimeScale()),
                J.transitions._slideTimeline &&
                  (J.slider.isBusy() ||
                    (0 !== J.transitions._slideTimeline.totalDuration() &&
                      0 !== J.transitions._slideTimeline.progress()) ||
                    "up" !== J.device.scroll.direction ||
                    ((J.slideshow.direction = "prev"),
                    0 ===
                    J.slideshow.sequence.normalized.indexOf(
                      J.slides.current.index
                    )
                      ? ((J.slider.positionToViewport = "over"),
                        J.device.scroll.enable(),
                        (J.slideshow.direction = "next"))
                      : J.navigation.prev()));
            },
            modifyTimeScale: function () {
              J.transitions._slideTimeline &&
                ee.TweenMax.to(J.transitions._slideTimeline, 0.25, {
          ...
          hover: {
            ...
            createTimeline: function (e, t) {
              ...
              (t.hover._timeline = new ee.TimelineMax({
                ...
                (t.hover._tween = ee.TweenMax.fromTo(
                  e[0],
                  t.hover.durationIn,
                  t.hoverFrom,
                  t.hoverTo
                ...
                e.next().is(".ls-layer-link")
                  ? ((i = e.next()),
                    ...
                    (t.hover._linkTween = ee.TweenMax.fromTo(
                      i[0],
                      t.hover.durationIn,
                      s,
                      a
                ...
                t.hover.alwaysOnTop &&
                  ((a = { zIndex: 9999 }),
                  J.browser.isSafari && (a.transform = "translateZ(999999px)"),
          ...
          parallax: {
            ...
            init: function () {
              ...
              $.on("mouseenter." + B, function () {
                ...
                (t.defaults.scrollModifier *= J.o.parallaxScrollReverse
                  ? -1
                  : 1);
            },
            addLayer: function (e, t, i, s) {
              switch (
                (this.state.enabled ||
                  (J.functions.setStates(this, { enabled: !0 }), this.init()),
                ie.extend(
                  !0,
                  t,
                ...
                (t.event && t.event.match(/(cursor|scroll|auto)/)) ||
                  (t.event = "cursor"),
                t.path.match(
            ...
            addShadow: function () {
              var e,
                t,
                i,
                s = J.gui.shadow.$element,
                a = (
                  J.slides.current && J.slides.current.parallax
                    ? J.slides.current
                    : J.slides.next
                ).index;
              J.slides[a].data.$background &&
                J.slides[a].data.$background.data(J.defaults.init.dataKey)
                  .parallax.enabled &&
                J.slides[a].data.overflow &&
                "hidden" !== J.slides[a].data.overflow &&
                ((e = "50% -" + 0.25 * J.slider.height + "px 0"),
                (i =
                  void 0 !==
                  (t = J.slides[a].data.$background.data(
                    J.defaults.init.dataKey
                  ).parallax).rotation
                    ? 2 * t.rotation
                    : void 0 !== J.slides[a].parallax.rotation
                    ? 2 * J.slides[a].parallax.rotation
                    : 2 * this.defaultProperties.rotation),
                s.data(J.defaults.init.dataKey, {
                  parallax: ie.extend(
                    !0,
                    {},
                    this.defaultProperties,
                ...
                ee.TweenMax.set(s[0], {
                  transformOrigin: e,
                  transformPerspective:
                    s.data(J.defaults.init.dataKey).parallax
                      .transformPerspective * J.resize.ratio,
                }),
                "3d" === J.slides[a].parallax.type || "3d" === t.type
              ...
              ie()
                ...
                .each(function () {
                  ...
                  ee.TweenMax.set(ie(this)[0], {
                    transformOrigin: J.functions.convert.transformOrigin(
                      t.transformOrigin,
                      i.data(J.defaults.init.dataKey).elements.$wrapper,
                      s,
                      e
                    ),
                    transformPerspective:
            ...
            trigger: function () {
              M.trigger("scroll.parallax" + B),
                M.trigger("touchmove.parallax" + B);
            },
            auto: function () {
            ...
            scroll: function () {
              ...
              J.slider.state.inFullscreen && (e = 0),
                this.transformPropertiesCalculated ||
                  this.calculateTransformProperties(),
            ...
            mouseMove: function (e) {
              ...
              this.transformPropertiesCalculated
                ? (J.slider.state.animatingSlides ||
                    ...
                    !J.gui.shadow.$element ||
                    this.addShadow(),
                  (t = J.slider.offset.left + J.slider.width / 2),
                  (i = J.slider.offset.top + J.slider.height / 2),
                  (t = e.pageX - t),
                  (i = e.pageY - i),
            ...
            animate2D: function (a, r, e) {
              this.wrappers[e].$2d.each(function () {
                ...
                "active" === s.attr("data-ls-parallax") &&
                  ((t = (e = s.data(J.defaults.init.dataKey).parallax).x
                    ? -a * (e.distance / 2e3) * parseInt(e.level)
                    : 0),
                  (i = e.y ? -r * (e.distance / 2e3) * parseInt(e.level) : 0),
                  ee.TweenMax.to(s[0], e.durationMove, { x: t, y: i }));
              });
            },
            animate3D: function (o, n, e) {
              this.wrappers[e].$3d.each(function () {
                ...
                "active" === r.attr("data-ls-parallax") &&
                  ((s = (e = r.data(J.defaults.init.dataKey).parallax).x
                    ? ((i = -o / (4e3 / e.rotation)),
                  ...
                  (a = e.y
                    ...
                    : (t = 0)),
                  ee.TweenMax.to(r[0], e.durationMove, {
                    rotationX: t,
                    rotationY: i,
                    x: s,
                    y: a,
            ...
            reset: function () {
              ie()
                ...
                .each(function () {
                  var e = ie(this);
                  e.find(".ls-layer[data-ls-hidden]").length &&
                    ee.TweenMax.set(e[0], {
                      x: 0,
                      y: 0,
                      rotationX: 0,
                    ...
                    e.find(".ls-layer[data-ls-parallax-reset]").length &&
                      ee.TweenMax.to(
                        e[0],
                        ie(this).data(J.defaults.init.dataKey).parallax
                          .durationLeave,
                        { x: 0, y: 0, rotationX: 0, rotationY: 0 }
                      );
                }),
                J.gui.shadow.$element && this.removeShadow(),
          ...
          scroll: {
            ...
            addLayer: function (e, t, i, s) {
              this.state.enabled ||
                (J.functions.setStates(this, { enabled: !0 }), this.init()),
                ie.extend(!0, t, this.defaultProperties, i.scroll),
                ...
                t.shouldBeConverted.transformOriginAlt ||
                  (t.shouldBeConverted.transformOriginAlt =
                    t.shouldBeConverted.transformOrigin),
                (t.ease = J.functions.convert.easing(t.ease)),
                (t.easeRev = J.functions.convert.easing(t.easeRev || t.ease)),
                (t.durationRev = t.durationRev || t.duration),
                (i.scroll = t),
            ...
            getCenter: function (e, t) {
              var i = "project";
              switch (
                ((((J.slider.isScrollScene || J.slider.isSticky) &&
                  "scene" === t) ||
                  "document" === t) &&
                  (i = t),
                e)
            ...
            setCenter: function (e, t) {
              return "project" !== e.getPosition ||
                (e.center && this.defaults.centerLayers !== e.center)
                ? this.getCenter(
                    e.center || this.defaults.centerLayers,
                    e.getPosition
                  )
                : t;
            },
            setY: function (e, t) {
              return (J.slider.isScrollScene || J.slider.isSticky) &&
                "scene" === e.getPosition
                ? -t
                : "document" === e.getPosition
                ? t
                : J.slider.state.inFullscreen
                ? 0
                : t - J.slider.offset.top;
            ...
            scroll: function (o) {
              var n, l;
              J.slider.state.isNotDisplayed ||
                J.slider.state.isHidden ||
                ((l = (n = this).getCenter(this.defaults.centerLayers)),
                this.transformPropertiesCalculated ||
                  this.calculateTransformProperties(),
                this.$wrappers.each(function () {
                  ...
                  ((-1 !==
                    J.slider.position.toViewportYForSkipViewportLayers.indexOf(
                      "inside"
                    ) &&
                    r.skipViewport) ||
                    !n.state.paused) &&
                    ...
                    (t = {
                      ...
                      onUpdate: function (e, t) {
                        ...
                        r.layerPositionToCenter !== e &&
                          n.setTransformProperties(ie(t), r, e),
                          (r.layerPositionToCenter = e);
                      },
                    ...
                    r.x &&
                      (i.x = n.calculateTransformations(
                        (-e * r.x) / 20,
                        "x",
                        r,
                        -e
                    ...
                    r.y &&
                      (i.y = n.calculateTransformations(
                        (-e * r.y) / 20,
                        "y",
                        r,
                        -e
                    ...
                    r.rotation &&
                      (i.rotation = n.calculateTransformations(
                        (e * r.rotation) / 40,
                        "rotation",
                        r,
                        -e
                    ...
                    r.rotationX &&
                      (i.rotationX = n.calculateTransformations(
                        (e * r.rotationX) / 40,
                        "rotationX",
                        r,
                        -e
                    ...
                    r.rotationY &&
                      (i.rotationY = n.calculateTransformations(
                        (e * r.rotationY) / 40,
                        "rotationY",
                        r,
                        -e
                    ...
                    r.skewX &&
                      (i.skewX = n.calculateTransformations(
                        (-e * r.skewX) / 40,
                        "skewX",
                        r,
                        -e
                    ...
                    r.skewY &&
                      (i.skewY = n.calculateTransformations(
                        (-e * r.skewY) / 40,
                        "skewY",
                        r,
                        -e
                    ...
                    r.scaleX &&
                      (i.scaleX = n.calculateTransformations(
                        1 - (e * r.scaleX) / -4e3,
                        "scaleX",
                        r,
                        e
                    ...
                    r.scaleY &&
                      (i.scaleY = n.calculateTransformations(
                        1 - (e * r.scaleY) / -4e3,
                        "scaleY",
                        r,
                        e
                    ...
                    r.opacity &&
                      (i.opacity = n.calculateTransformations(
                        1 -
                          (e *
                    ...
                    (e =
                      "down" === te.scroll.direction
                        ? r.duration
                        : r.durationRev),
                    o || 0 == e
                      ? (ee.TweenMax.set(s[0], t), ee.TweenMax.set(a[0], i))
                      : (ee.TweenMax.to(s[0], e, t),
                        ee.TweenMax.to(a[0], e, i)));
                }));
            },
            ...
            calculateTransformProperties: function () {
              ...
              this.$wrappers.each(function () {
                var e = ie(this),
                  ...
                  i =
                    (e.find(".ls-layer").data(J.defaults.init.dataKey),
                    s.setCenter(t, s.getCenter(s.defaults.centerLayers))),
                  i = s.setY(t, i) <= 0 ? "+" : "-";
          ...
          filters: {
            createTransition: function (e, t, i, s) {
              var a,
                r = new J.defaults.layer.properties.filter(),
                o = {};
              for (a in r)
                switch (t) {
                  case "in":
            ...
            animate: function (e, t) {
              ...
              if ("object" == typeof t) {
                ...
                ee.TweenMax.set(e.target, { "-webkit-filter": a, filter: a });
              }
            },
          },
          splitType: {
            ...
            setRandomProperties: function (e, t, i, s, a) {
              for (var r in i) {
                for (
                  var o = [], n = 0, l = t["text" + a].nodes.length;
                  n < l;
                  n++
                )
                  o[n] = J.functions.convert.randomProperties(i[r], r, e, t);
        ...
        media: {
          ...
          changeBackgroundVideo: function (e, t) {
            ...
            J.slides.current.index &&
              J.slides.current.data.$backgroundVideo.length &&
              ((r = (i = J.slides.current.data.$backgroundVideo).data(
                J.defaults.init.dataKey
              ).elements.$bgWrapper),
              t &&
                ((i.data(J.defaults.init.dataKey).mediaProperties.willBePaused =
                  !0),
                r.fadeOut(J.transitions.media.defaults.fadeOut, function () {
              ...
              J.slides.next.data.$backgroundVideo.length &&
                ((a = (s = J.slides.next.data.$backgroundVideo).data(
                  J.defaults.init.dataKey
                ).elements.$bgWrapper),
                (r = s.data(J.defaults.init.dataKey).elements.$bgOuterWrapper),
                (te.isMobile &&
                  (($.hasClass("ls-device-is-phone") &&
                ...
                e || t
                  ? a.fadeIn(J.transitions.media.defaults.fadeOut)
                  : a.css({ display: "block" }),
                (s.data(J.defaults.init.dataKey).mediaProperties.isPreloaded =
                  !0));
          },
        },
        timers: {
          ...
          create: function (e) {
            (this.curNext = e || "next"),
              this.reset(),
              J.gui.timers.bar.$element && this.bar.createTransition(),
              J.gui.timers.circle.$element && this.circle.createTransition(),
              J.gui.timers.slidebar.$element &&
          ...
          reverse: function () {
            var e;
            J.slides.current &&
              J.slides.current.data &&
              J.transitions._slideTimeline &&
              ((e = J.transitions._slideTimeline.progress()),
              (e =
                (J.slides.current.data.duration * e) /
                this.defaults.reverseDuration),
              J.gui.timers.bar.$element &&
                this.bar._transition &&
                (J.transitions._slideTimeline.remove(
                  J.transitions.timers.bar._transition
                ),
                this.bar._transition.reverse().timeScale(e)),
              J.gui.timers.circle.$element &&
          ...
          bar: {
            ...
            createTransition: function () {
              this._transition = ee.TweenMax.fromTo(
                J.gui.timers.bar.$element[0],
                J.slides[J.transitions.curNext].data.duration,
                  ...
                  onComplete: function (e) {
                    (e.target.style.width = "100%"),
                      (e.target.style.width =
                        "calc( 100% - " + J.slider.initial.skinWidth + "px )");
                  },
                  onCompleteParams: ["{self}"],
                  onUpdate: function (e) {
                    e.target.style.width =
                      Math.min(J.slider.width, J.slider.width * e.progress()) +
                      "px";
                  },
                  onUpdateParams: ["{self}"],
                }
          ...
          circle: {
            reset: function () {
              this._transition &&
                (J.gui.timers.circle.$element.stop(!0, !0),
                this._transition.kill(),
                (this._transition = !1));
            },
            createTransition: function () {
              var e = J.gui.timers.circle.$element.find(
                  ".ls-ct-right .ls-ct-rotate"
                )[0],
                t = J.gui.timers.circle.$element.find(
                  ".ls-ct-left .ls-ct-rotate"
                )[0],
                i = J.slides[J.transitions.curNext].data.duration;
              this._transition = new ee.TimelineMax({ paused: !0 })
                .fromTo(
                  J.gui.timers.circle.$element[0],
                  J.transitions.timers.defaults.fadeInDuration,
                  {
                    autoCSS: !1,
                    immediateRender: !0,
                  ...
                  },
                  {
                    ...
                    css: {
                      opacity:
                        J.gui.timers.circle.$element.data("original").opacity,
                    },
                  }
                )
                .fromTo(
          ...
          slidebar: {
            ...
            createTransition: function () {
              ...
              (i._transition = new ee.TimelineMax({
                ...
                ie.each(
                  J.gui.timers.slidebar.$sliderContainerElement,
                  function (t, e) {
                    i._transition.add(
                      ee.TweenMax.fromTo(
                        J.gui.timers.slidebar.$sliderContainerElement[t][0],
                        J.slides[J.transitions.curNext].data.duration,
                        { autoCSS: !1, css: { left: 0 } },
                        {
                          ...
                          onComplete: function (e) {
                            e.target.style.left =
                              "calc( 100% - " +
                              J.gui.timers.slidebar.sliderContainerElementWidth[
                                t
                              ] +
                              "px )";
                          },
                          ...
                          onUpdate: function (e) {
                            e.target.style.left =
                              (J.gui.timers.slidebar.containerElementWidth[t] -
                                J.gui.timers.slidebar
                      ...
                      i._transition.add(
                        ee.TweenMax.fromTo(
                          J.gui.timers.slidebar.$progressBarElement[t][0],
                          J.slides[J.transitions.curNext].data.duration,
                          { autoCSS: !1, css: { width: 0 } },
                          {
                            ...
                            onUpdate: function (e) {
                              e.target.style.width =
                                J.gui.timers.slidebar.elementWidth[t] *
                                  e.progress() +
                                "px";
                            },
                            onUpdateParams: ["{self}"],
        ...
        scrollscene: {
          animate: function (e) {
            var t, i;
            J.transitions._slideTimeline &&
              ((t = J.slider.wrapperOffset.height - J.slider.height),
              (i =
                te.scroll.top + this.stickLimit - J.slider.wrapperOffset.top),
              (e = Math.max(1e-4, (J.o.sceneDuration / t) * i)),
              (t = ee.Quart.easeOut),
              (i =
                this.initialized && !this.immediateRender
                  ? J.o.smoothScrollDuration / 1e3
                  : 0),
              J.transitions._slideTimeline.tweenTo(e, { ease: t }).duration(i),
              (this.initialized = !0),
      ...
      (J.plugins = {
        load: function () {
          var e, s;
          J.o.plugins && 0 !== J.o.plugins.length
            ? ((e = J.o.plugins[0]),
              (s = "object" == typeof e ? e.namespace : e),
              window._layerSlider.plugins[s]
                ? (J.plugins.init(s, e, !0), J.plugins.load())
                : J.browser.usesFileProtocol || "object" != typeof e
                ? (J.browser.usesFileProtocol
                    ? window.console &&
                      (console.error(
                        J.defaults.slider.errorText,
                ...
                ? -1 === window._layerSlider.pluginsLoaded.indexOf(s) &&
                  ...
                  ? (window._layerSlider.pluginsBeingLoaded.push(s),
                    ie.ajax({
                      ...
                      dataType: "script",
                      success: function () {
                        J.plugins.init(e.namespace, e, !0),
                  ...
                  : (J[s] ||
                    -1 !== window._layerSlider.pluginsNotLoaded.indexOf(s)
                      ...
                      : J.plugins.init(s, e),
                    J.plugins.load())
                : J.plugins.checkLoaded(s))
            : J.slider.check.initialized();
        },
        init: function (e, t, i) {
          (J.initializedPlugins[e] = new window._layerSlider.plugins[e](
            J,
            $,
            B,
            t.settings
            ...
            window._layerSlider.checkVersions(
              J.initializedPlugins[e].pluginData.requiredLSVersion,
              J.plugin.version
            )
              ? (t.css &&
                  i &&
                ...
                J.initializedPlugins[e].init && J.initializedPlugins[e].init())
              : window.console &&
                console.error(
                  J.defaults.slider.errorText,
                  e,
        ...
        checkLoaded: function (e) {
          J.intervals.pluginLoaded = setInterval(function () {
            (-1 === window._layerSlider.pluginsLoaded.indexOf(e) &&
              ...
              (clearInterval(J.intervals.pluginLoaded),
              delete J.intervals.pluginLoaded,
              J.plugins.load());
          }, 100);
        },
      }),
      ...
      (J.slider = {
        ...
        load: function () {
          if (!document.body.contains(L)) return !1;
          J.api.hasEvent("sliderWillLoad") &&
            J.api.triggerEvent("sliderWillLoad"),
            J.slider.set.global();
        },
        set: {
          global: function () {
            var e;
            (J.originalMarkup = $[0].outerHTML),
              (J.userInitOptions = J.functions.convert.properties(
                J.functions.convert.oldProperties(i)
              )),
              (J.meta = {}),
              (J.o = ie.extend(
                !0,
                {},
                J.defaults.init.options,
                J.userInitOptions
              )),
              (J.o.forceLayersOutDuration /= 1e3),
              (J.o.forceLayersOutDuration =
                0 < J.o.forceLayersOutDuration
                  ? J.o.forceLayersOutDuration
                  : 0.75),
              (J.o.sliderFadeInDuration /= 1e3),
              window.console &&
                !0 !== J.o.hideWelcomeMessage &&
            ...
            -1 !== document.location.hash.indexOf("debug") &&
              ...
              (window._layerSlider.currentScript ||
                ...
                (window._layerSlider.scriptPath = (
                  ...
                  .replace(/\/[^\/]*$/, "")),
              J.o.silentMode &&
                ((J.slider.$silentWrapper = ie(
                  "<ls-silent-wrapper></ls-silent-wrapper>"
                )),
                J.slider.$silentWrapper.append($).prependTo("body")),
              "string" == typeof J.o.getData && (J.o.getData = [J.o.getData]),
              "object" == typeof J.o.plugins
                ? J.plugins.load()
                : J.slider.check.initialized();
          },
          styles: function () {
            ...
            switch (
              (J.debugMode && J.debug.add("group", "sliderInit.style"),
              J.o.width
                ? (e =
                    -1 == J.o.width.indexOf("%")
                      ? parseInt(J.o.width)
                      : J.o.width)
                : S.width
                ? (e = -1 == S.width.indexOf("%") ? parseInt(S.width) : S.width)
                : 0 < P
                ? ((e = P),
                  J.debugMode && J.debug.add("warn", "sliderInit.noWidth", P))
                : ((e = x),
                  J.debugMode && J.debug.add("warn", "sliderInit.noWidth2", x)),
              (i = e),
              J.o.height
                ? (t =
                    -1 == J.o.height.indexOf("%")
                      ? parseInt(J.o.height)
                      : J.o.height)
                : S.height
                ? (t =
                    -1 == S.height.indexOf("%") ? parseInt(S.height) : S.height)
                : 0 < O
                ? ((t = O),
                  J.debugMode && J.debug.add("warn", "sliderInit.noHeight", O))
                : ((t = T),
                  J.debugMode &&
                    J.debug.add("warn", "sliderInit.noHeight2", C)),
              (s = t),
              (a =
                "" !== S.maxWidth
                  ? -1 !== S.maxWidth.indexOf("px")
                    ? parseInt(S.maxWidth)
                    : S.maxWidth
                  : 0),
              void 0 === J.userInitOptions.type &&
                ((0 < P && 0 < O) || ("100%" === e && "100%" === t)
                  ? (I = "fullsize")
                  : P <= 0 &&
                    O <= 0 &&
                    (J.o.responsiveUnder <= 0 ||
                      (0 < J.o.responsiveUnder && J.o.sliderVersion))
                  ? (I =
                      void 0 !== J.o.responsive && !1 === J.o.responsive
                        ? "fixedsize"
                        : "responsive")
                  : 0 < J.o.responsiveUnder && (I = "fullwidth")),
              I)
            ) {
              case "fullwidth":
                -1 !== e.indexOf("%") &&
                  (J.debugMode &&
                    J.debug.add("warn", "sliderInit.percWidth", [I, e, x]),
                  (e = x)),
                  P <= 0 &&
                    ((P = e),
                    J.debugMode &&
                      J.debug.add("warn", "sliderInit.conWidth", [I, e])),
                  J.o.responsiveUnder <= 0 &&
                    ((J.o.responsiveUnder = P),
                    J.debugMode &&
                      J.debug.add("warn", "sliderInit.fullwidth", P)),
                  -1 !== t.indexOf("%") &&
                    ((o = C / (100 / parseInt(t))),
                    J.debugMode &&
                      J.debug.add("warn", "sliderInit.fullwidth2", [I, t, o]),
                    (t = o)),
                  O <= 0 && (O = t);
                break;
              case "fullsize":
                -1 !== e.indexOf("%") &&
                  ((r = 0 < P ? P : k),
                  J.debugMode &&
                    J.debug.add("warn", "sliderInit.fullsize", [I, e, r, k, P]),
                  (e = r)),
                  P <= 0 &&
                    ((P = e),
                    J.debugMode &&
                      J.debug.add("warn", "sliderInit.conWidth", [I, e])),
                  -1 !== t.indexOf("%") &&
                    ((o = 0 < O ? O : M.height() / (100 / parseInt(t))),
                    J.debugMode &&
                      J.debug.add("warn", "sliderInit.fullsize2", [
                        I,
                        t,
                        o,
                        M.height(),
                  ...
                  O <= 0 &&
                    ((O = t),
                    J.debugMode &&
                      J.debug.add("warn", "sliderInit.conHeight", [I, t]));
                break;
              case "fixedsize":
                break;
              default:
                (J.userInitOptions.type = J.o.type = I = "responsive"),
                  (J.o.responsiveUnder = -1) !== e.indexOf("%") &&
                    ((e = x),
                    J.debugMode &&
                      J.debug.add("warn", "sliderInit.percWidth", [I, e, x])),
                  -1 !== t.indexOf("%") &&
                    ((e = T),
                    J.debugMode &&
                      J.debug.add("warn", "sliderInit.responsive", [I, t, T])),
                  J.debugMode &&
                    0 < P &&
                    J.debug.add("warn", "sliderInit.conWidth2", [I, P]),
                  J.debugMode &&
                    0 < O &&
                    J.debug.add("warn", "sliderInit.conHeight2", [I, O]);
            }
            $.addClass("ls-container ls-" + I),
              $.parent().addClass("ls-direction-fix"),
              J.userInitOptions.slideBGSize ||
                "responsive" !== I ||
                !J.userInitOptions.hasOwnProperty("sliderVersion") ||
                J.userInitOptions.sliderVersion ||
                ((J.o.slideBGSize = "auto"),
                J.debugMode && J.debug.add("warn", "sliderInit.bgCover", I)),
              (J.o.slideBGSize = J.o.slideBGSize.replace(
                "100% 100%",
                "stretch"
              )),
              (n = 0 < P ? P : e),
              ...
              (d =
                "auto" === (y = L.style.marginLeft)
                  ? "auto"
                  : "" === y
                  ? parseInt(b.getPropertyValue("margin-left"))
                  : parseInt(L.style.marginLeft)) ===
                (c =
                  "auto" === (g = L.style.marginRight)
                    ? "auto"
                    : "" === g
                    ? parseInt(b.getPropertyValue("margin-right"))
                    : parseInt(L.style.marginRight)) &&
                ("" === y && "" === g && ((p = d), (c = d = "auto")),
              ...
              J.debugMode &&
                (J.debug.add("log", "sliderInit.style", [
                  e,
                  t,
                  i,
                  s,
                ...
                p && J.debug.add("warn", "sliderInit.margin", p)),
              ie("html").attr("id")
                ? ie("body").attr("id") || ie("body").attr("id", "ls-global")
                : ie("html").attr("id", "ls-global"),
              "static" !== b.getPropertyValue("position") &&
                "absolute" !== b.getPropertyValue("position") &&
                (L.style.position = "relative"),
              J.o.insertSelector && $[J.o.insertMethod](J.o.insertSelector),
              (J.slider.$hiddenWrapper = ie(
                ...
                .addClass($.attr("class"))
                .prependTo("body")),
              (J.slider.$innerWrapper = ie('<div class="ls-inner"></div>')),
              (J.slider.$slideBGColorWrapper = ie(
                '<div class="ls-slide-bgcolor"></div>'
              ).appendTo(J.slider.$innerWrapper)),
              (J.slider.$layersWrapper = ie(
                '<div class="ls-layers"></div>'
              ).appendTo(J.slider.$innerWrapper)),
              (J.slider.$bgVideosWrapper = ie(
                '<div class="ls-background-videos"></div>'
              ).appendTo(J.slider.$layersWrapper)),
              (J.slider.$slideBGWrapper = ie(
                '<div class="ls-slide-backgrounds"></div>'
              ).appendTo(J.slider.$layersWrapper)),
              J.slider.$innerWrapper.appendTo($),
              !0 === J.o.hideOnMobile && te.isMobile
                ? ($.addClass("ls-forcehide"),
                  $.closest(".ls-wp-fullwidth-container").addClass(
                    "ls-forcehide"
                  ),
                  (J.o.autoStart = !1))
                : J.slider.check.showHide();
            b = !1;
            if (
              (-1 == J.o.globalBGColor.indexOf("gradient")
                ? J.slider.$innerWrapper.css({
                    backgroundColor: J.o.globalBGColor,
                  })
                : ((b = J.o.globalBGColor),
                  (J.o.globalBGColor = "transparent")),
              J.o.globalBGImage
                ? J.slider.$innerWrapper.css({
                    backgroundImage:
                      "url( " + J.o.globalBGImage + " )" + (b ? ", " + b : ""),
                ...
                : b && J.slider.$innerWrapper.css({ backgroundImage: b }),
              "transparent" != J.o.globalBGColor ||
                !1 !== J.o.globalBGImage ||
                b ||
                J.slider.$innerWrapper.css({ background: "none transparent" }),
              "sticky" === J.o.scene || "scroll" === J.o.scene)
            ) {
              if (J.o.scene)
                switch (((J.slider.isScene = !0), J.o.scene)) {
                  case "scroll":
          ...
          options: function () {
            var t, i, s, a, r, e;
            ie("html").find('meta[content*="WordPress"]').length &&
              (J.meta.wpVersion = ie("html")
                .find('meta[content*="WordPress"]')
                .attr("content")
                .split("WordPress")[1]),
              window.LS_Meta && window.LS_Meta.v
                ? (J.meta.lswpVersion = window.LS_Meta.v)
                : ie("html").find('script[src*="layerslider"]').length &&
                  -1 !=
                    ie("html")
                      .find('script[src*="layerslider"]')
                      .attr("src")
                      .indexOf("?") &&
                  (J.meta.lswpVersion = ie("html")
                    .find('script[src*="layerslider"]')
                    .attr("src")
                    .split("?")[1]
                    .split("=")[1]),
              "undefined" != typeof layerSliderTransitions &&
                (J.t = ie.extend({}, layerSliderTransitions)),
              "undefined" != typeof layerSliderCustomTransitions &&
                (J.ct = ie.extend({}, layerSliderCustomTransitions)),
              J.debugMode &&
                ("undefined" != typeof layerCustomSliderTransitions
                  ? (J.debug.add("log", "sliderInit.customTransitions", !1),
                    "undefined" == typeof layerSliderTransitions &&
                      J.debug.add("warn", "sliderInit.slideTransitions"))
                  : "undefined" == typeof layerSliderTransitions &&
                    J.debug.add("warn", "sliderInit.noSlideTransitions")),
              "number" == typeof J.o.parallaxCenterDegree &&
                (J.transitions.layers.parallax.defaults.centerDegree =
                  J.o.parallaxCenterDegree),
              "number" == typeof J.o.parallaxSensitivity &&
                (J.transitions.layers.parallax.defaults.sensitive =
                  J.o.parallaxSensitivity),
              J.o.parallaxCenterLayers &&
                (J.transitions.layers.parallax.defaults.centerLayers =
                  J.o.parallaxCenterLayers),
              J.o.scrollCenterLayers &&
                (J.transitions.layers.scroll.defaults.centerLayers =
                  J.o.scrollCenterLayers),
              J.slider.isSticky &&
                (ie.extend(J.o, { allowFullscreen: !1, playByScroll: !1 }),
                J.slider.isScrollScene &&
                  ie.extend(J.o, {
              ...
              te.isMobile && (J.o.pauseOnHover = !1),
              J.o.startInViewport &&
                ((J.slider.state.waitForGettingInViewport = !0),
                J.o.playByScroll &&
                  ((J.slider.positionToViewport =
                    te.scroll.top >
                    J.slider.offset.top -
                      (te.viewport.height - J.slider.height) / 2
                      ? "under"
                    ...
                    function (e) {
                      te.isMobile
                        ? ((s = e.originalEvent.touches[0].clientY),
                          a < s
                            ? (J.device.scroll.direction = "up")
                            : s < a && (J.device.scroll.direction = "down"),
                          (r = a - s),
                          (a = s))
                        : (0 < e.originalEvent.deltaY
                            ? (J.device.scroll.direction = "down")
                            : (J.device.scroll.direction = "up"),
                          (r = e.originalEvent.deltaY)),
                        0 !== Math.abs(r) &&
                          (J.device.scroll.lastDirection
                            ? J.device.scroll.lastDirection !==
                                J.device.scroll.direction &&
                              ((J.device.scroll.lastDirection =
                                J.device.scroll.direction),
                            ...
                            : (J.device.scroll.lastDirection =
                                J.device.scroll.direction),
                          "inside" === J.slider.positionToViewport &&
                            (J.resize.viewport(),
                            0 <= r
                              ? J.transitions.layers.timeline.scrollForward()
                              : J.transitions.layers.timeline.scrollBackwards(),
                            t &&
                              (clearTimeout(J.timeouts.scroll),
                              (t = !1),
                              (J.transitions.layers.timeline.timeScaleModifier =
                                J.transitions.layers.timeline
                                  .timeScaleModifier < i
                                  ? J.transitions.layers.timeline
                                      .timeScaleModifier + 0.25
                                  : i),
                              (J.timeouts.scroll2 = setTimeout(function () {
                                delete J.timeouts.scroll2,
                                  (t = !0),
                                  (J.device.scroll.timeout =
                                    50 < J.device.scroll.timeout
                                      ? J.device.scroll.timeout - 50
                                      : 50);
                              }, J.device.scroll.timeout)))),
                          J.slider.check.positionToViewport(),
                          (J.timeouts.checkPosition = setTimeout(function () {
                            J.slider.check.positionToViewport();
                          }, 25)));
                    }
                  ))),
              (J.slider.canShow = !0),
              te.automaticFontSizeRatio ||
                ((e = ie(
          ...
          events: function () {
            M.on("scroll." + B, function () {
              ...
              M.on("resize." + B, function () {
                J.slider.check.showHide(),
                  (J.transitions.scrollscene.immediateRender = !0),
                  "inside" === J.slider.positionToViewport &&
                    J.o.playByScroll &&
                    J.resize.viewport(),
                  J.slider.shouldResize &&
                    (!te.isMobile ||
                      (te.isMobile &&
                        te.viewport.width !== te.viewport.lastWidth) ||
                      J.slider.isPopup) &&
                    J.resize.all(),
                  J.slider.set.offset(),
                  J.slider.isScene && J.resize.scene(),
                  J.slider.isPopup ||
                    (J.timeouts.resize && clearTimeout(J.timeouts.resize),
                    J.resize.once
                      ? (J.resize.once = !1)
                      : (J.timeouts.resize = setTimeout(function () {
                          (J.resize.once = !0),
                            M.trigger("resize." + B),
                            J.api.methods("resetScroll");
                        }, 100)));
              }),
              J.debugMode &&
                (M.off(".debug" + B),
                M.on("resize.debug" + B, function () {
                  J.debug.add("log", "resize.window", te.viewport.width, !0);
                })),
              M.on("hashchange." + B, function () {
                document.location.hash &&
                  J.slides.deeplink(document.location.hash);
              }),
              J.slider.set.offset(),
              M.trigger("resize." + B),
              J.o.refreshWaypoint && window.Waypoint && Waypoint.refreshAll();
          },
          offset: function () {
            if ("none" !== $.css("display")) {
              ...
              if (
                (J.slider.get.offset(e),
                J.slider.get.position(e),
                0 < J.slider.position.left - te.viewport.width
                  ? J.slider.position.left - te.viewport.width >
                    J.performance.threshold
                    ? (J.slider.position.toViewportX = "after")
                    : (J.slider.position.toViewportX = "insideLimit")
                  : J.slider.position.right < 0
                  ? J.slider.position.right < -J.performance.threshold
                    ? (J.slider.position.toViewportX = "before")
                    : (J.slider.position.toViewportX = "insideLimit")
                  : (J.slider.position.toViewportX = "inside"),
                0 < J.slider.position.top - te.viewport.height
                  ? J.slider.position.top - te.viewport.height >
                    J.performance.threshold
                    ? (J.slider.position.toViewportY = "below")
                    : (J.slider.position.toViewportY = "insideLimit")
                  : J.slider.position.bottom < 0
                  ? J.slider.position.bottom < -J.performance.threshold
                    ? (J.slider.position.toViewportY = "above")
                    : (J.slider.position.toViewportY = "insideLimit")
                  : (J.slider.position.toViewportY = "inside"),
                (J.slider.position.toViewportYForSkipViewportLayers =
                  J.slider.position.toViewportY),
                J.slider.state.waitForGettingInViewport &&
                  (J.slider.position.middle < te.viewport.height &&
                  0 < J.slider.position.middle
                    ? ((J.slider.position.toViewportY = "inside") ===
                        J.slider.position.toViewportX &&
                        (J.slider.position.toViewport = "inside"),
                      (J.slider.state.waitForGettingInViewport = !1),
                      J.transitions._slideTimeline &&
                        J.transitions._slideTimeline.play(),
                      J.o.animateFirstSlide &&
                        J.slideshow.firstStart &&
                        J.slider.state.readyForStart &&
                        (J.resize.layers(J.api.resumeCallback),
                        (J.api.resumeCallback = !1)),
                      J.debugMode &&
                        J.debug.add("log", "slideshow.inviewport", !1))
                    : (J.slider.position.toViewportY = "outside")),
                (-1 !== J.slider.position.toViewportX.indexOf("inside") &&
                  "insideLimit" == J.slider.position.toViewportY) ||
                (-1 !== J.slider.position.toViewportY.indexOf("inside") &&
                  "insideLimit" == J.slider.position.toViewportX)
                  ? ((J.slider.position.toViewport = "insideLimit"),
                    (J.slider.position.toViewportForPerformance = "inside"))
                  : "inside" == J.slider.position.toViewportX &&
                    "inside" == J.slider.position.toViewportY
                  ? ((J.slider.position.toViewport = "inside"),
                    (J.slider.position.toViewportForPerformance = "inside"))
                  : ((J.slider.position.toViewport = "outside"),
                    (J.slider.position.toViewportForPerformance = "outside")),
                J.o.performanceMode &&
                  t !== J.slider.position.toViewportForPerformance &&
                  ("inside" === J.slider.position.toViewportForPerformance
                    ? ((J.performance.sliderIsInviewport = !0),
                      J.api.methods("resumeSlider", "performanceMode"))
                    : ((J.performance.sliderIsInviewport = !1),
                      J.api.methods("pauseSlider", "performanceMode"))),
                (J.slider.isScrollScene || J.slider.isSticky) &&
                  !J.slider.$spacingWrapper.is("[data-disabled-scene]"))
              ) {
                ...
                (J.transitions.scrollscene.stickLimit = s),
                  (J.slider.wrapperPosition = {
                    left: t.left,
                    top: t.top,
                    middleForScrollTransition:
                      t.top + t.height / 2 - te.viewport.height / 2,
                  }),
                  ...
                  (J.slider.state.shouldAnimateScrollSnene = !1),
                  t.top > s
                    ? ("disabled" !== J.slider.state.sticky ||
                        (J.slider.isScrollScene &&
                          !J.transitions.scrollscene.initialized)) &&
                      ((J.slider.state.sticky = "disabled"),
                      (J.slider.state.shouldAnimateScrollSnene = !0))
                    : t.bottom - J.slider.height - s < 0
                    ? ("over" !== J.slider.state.sticky ||
                        (J.slider.isScrollScene &&
                          !J.transitions.scrollscene.initialized)) &&
                      ((J.slider.state.sticky = "over"),
                      (J.slider.state.shouldAnimateScrollSnene = !0))
                    : t.top <= s &&
                      t.bottom > -s &&
                      ("enabled" !== J.slider.state.sticky &&
                        (J.slider.state.sticky = "enabled"),
                      (J.slider.state.shouldAnimateScrollSnene = !0)),
                  J.slider.isScrollScene &&
                    J.transitions._slideTimeline &&
                    J.slider.state.shouldAnimateScrollSnene &&
                    J.transitions.scrollscene.animate();
              }
              J.slider.state.isNotDisplayed &&
                ((J.slider.state.isNotDisplayed = !1),
                J.resize.all(),
                J.slider.check.positionToViewport(),
                M.trigger("scroll"));
        ...
        check: {
          initialized: function () {
            J.debugMode &&
              ...
              J.slider.initialized ||
                ((J.slider.initialized = !0), this.skins());
          },
          skins: function () {
            J.o.skin && "" !== J.o.skin && J.o.skinsPath && "" !== J.o.skinsPath
              ? J.gui.skin.load()
              : J.slider.init();
          },
          showHide: function () {
            (te.isMobile && !1 !== J.o.hideOnMobile) ||
              (te.viewport.width < J.o.hideUnder ||
              (te.viewport.width > J.o.hideOver && 0 < J.o.hideOver)
                ? J.slider.hide()
                : J.slider.show());
          },
          visibility: function () {
            !!J.slider.$innerWrapper.width()
              ? J.slider.state.isHidden &&
                ((J.slider.state.isHidden = !1),
                J.resize.all({ forceToGetParentWidth: !0 }))
              : (J.slider.state.isHidden = !0);
          },
          positionToViewport: function () {
            var e;
            delete J.timeouts.checkPosition,
              J.o.playByScroll &&
                J.device.scroll.direction &&
                ((e =
                  "down" === J.device.scroll.direction
                ...
                ((("down" === J.device.scroll.direction
                  ...
                  : te.scroll.top) < e &&
                  (("up" === J.device.scroll.direction &&
                    "under" === J.slider.positionToViewport) ||
                    ("down" === J.device.scroll.direction &&
                      "over" === J.slider.positionToViewport))) ||
                  te.document.height <= te.viewport.height ||
                  (J.slider.height < te.viewport.height &&
                    (("up" === J.device.scroll.direction &&
                      te.scroll.top <= 0 &&
                      J.slider.offset.top + J.slider.height / 2 <
                        te.viewport.height / 2) ||
                      ("down" === J.device.scroll.direction &&
                        te.scroll.top >=
                          te.document.height - te.viewport.height &&
                        J.slider.offset.top + J.slider.height / 2 >
                          te.scroll.top + te.viewport.height / 2)))) &&
                  ((J.slider.positionToViewport = "inside"),
                  J.resize.viewport(),
                  J.device.scroll.disable()));
          },
        },
        init: function () {
          clearTimeout(J.timeouts.skinLoad1),
            clearTimeout(J.timeouts.skinLoad2),
            clearTimeout(J.timeouts.skinLoad3),
            clearTimeout(J.timeouts.skinLoad4),
            J.slider.set.styles(),
            J.slider.set.options(),
            J.slides.init(),
            J.device.fullscreen.set(),
            J.media.init(),
            J.gui.timers.init(),
            J.gui.loadingIndicator.init(),
            J.preload.init(),
            J.gui.shadow.init(),
            J.navigation.init(),
            J.slideshow.init(),
            J.slides.set.firstSlide(),
            J.gui.navigation.init(),
            J.gui.media.init(),
            J.resize.slider(),
            J.yourLogo.init(),
            J.slider.set.events(),
            J.api.hasEvent("sliderDidLoad") &&
              J.api.triggerEvent("sliderDidLoad", J.api.eventData()),
            J.functions.setStates(J.slider, { isLoaded: !0 }),
            J.slider.state.shouldBeDestroyed
              ? J.api.methods("destroy")
              : ((J.intervals.checkSliderVisibility = setInterval(function () {
                  J.slider.check.visibility();
                }, 500)),
                J.slideshow.changeTo(J.slides.first.index));
        },
        hide: function () {
          $.addClass("ls-forcehide"),
      ...
      (J.functions = {
        getData: function (e, t) {
          return (
            !J.o.getData ||
            -1 === J.o.getData.indexOf(e) ||
            (J.api.triggerEvent("getData", { property: e, value: t }),
            !J.o.destroyAfter) ||
            (J.api.methods("destroy", !0), !1)
          );
        },
        convert: {
          transformOrigin: function (e, t, i, s) {
            for (
              var a = (d = ie.trim(e)).split(" "),
                r = s[0].style,
                o = "",
                n = ["Left", "Top"],
                l = [J.slider.width, J.slider.height],
                d = d
                ...
                s = function (e, t) {
                  for (
                    var t = ie(d[t]),
                      ...
                      a = (n = ie.trim(e)).split(" "),
                      r = "",
                      o = [J.slider.width, J.slider.height],
                      n = J.functions.convert.specialValuesOfTransformOrigin(n),
                      l = 0;
                    l < n.length;
                    l++
                  )
          ...
          easing: function (e, t) {
            return "string" != typeof e
              ...
              : (-1 !== (e = e.toLowerCase()).indexOf("swing") ||
                -1 !== e.indexOf("linear")
                  ? (i = ee.Linear.easeNone)
                  : ((s = e.match(/(easeinout|easein|easeout)(.+)/)[2]),
                    (s = ee[s.charAt(0).toUpperCase() + s.slice(1)]),
          ...
          transition: function (e, t, i, s) {
            ...
            return (
              ...
              (a.ease = J.functions.convert.easing(t)),
              a
            );
          },
          properties: function (e, t) {
            if ("string" == typeof e)
              return J.functions.convert._properties(e, t);
          ...
          _properties: function (e, t) {
            ...
            if (
              -1 !==
              ["disable", "disabled", "false", "undefined", "null"].indexOf(e)
            )
              return !1;
            if (
              "string" != typeof e ||
              -1 === e.indexOf(J.defaults.init.staggerSplitChar) ||
              e.charAt(0) === J.defaults.init.openingBracket
            )
              return t
                ? "" + parseInt(e) == "NaN"
                  ? 0
                ...
                : e;
            for (
              var i = e.split(J.defaults.init.staggerSplitChar), s = [], a = 0;
              a < i.length;
              a++
            )
              s[a] = ie.isNumeric(i[a])
                ? parseFloat(ie.trim(i[a]))
                : ie.trim(i[a]);
            return s;
          },
            ...
            (-1 === t.indexOf("height") &&
              ...
              -1 !== e.indexOf(")")
                ? (e = e
                    .split("(")[1]
                    .split(")")[0]
                    .replace(",", J.defaults.init.rangeSplitChar))
                : e.charAt(0) === J.defaults.init.openingBracket &&
                  e.charAt(e.length - 1) === J.defaults.init.closingBracket &&
                  (e = e.substring(1, e.length - 1)),
              (e = e.replace(/,/g, ".").replace(/٫/g, "."));
            var o,
              n =
                -1 === t.indexOf("scale") && -1 === t.indexOf("opacity")
                  ? 1
                  : 100,
              l = e;
            return (
              -1 !== e.indexOf(J.defaults.init.randomSplitChar)
                ? (l =
                    (l = (o = e.split(J.defaults.init.randomSplitChar))[
                      Math.floor(Math.random() * o.length)
                    ].trim()).charAt(0) === J.defaults.init.openingBracket &&
                    l.charAt(l.length - 1) === J.defaults.init.closingBracket
                      ? J.functions.convert.randomProperties(l, t, i, s)
                      : parseFloat(i ? J.resize.getXY(i, s, l, a, r) : l))
                : -1 !== e.indexOf(J.defaults.init.rangeSplitChar) &&
                  (((o = e.split(J.defaults.init.rangeSplitChar))[0] =
                    parseFloat(
                      (i ? J.resize.getXY(i, s, o[0], a, r) : o[0]) * n
                    )),
                  (o[1] = parseFloat(
                    (i ? J.resize.getXY(i, s, o[1], a, r) : o[1]) * n
                  )),
                  o.sort(function (e, t) {
                    return e - t;
                  }),
                  (l =
                    Math.floor(Math.random() * (o[1] - o[0] + 1) + o[0]) / n)),
              l
            );
          },
          clipProperties: function (e, t, i, s) {
            ...
            for (
              var a,
                ...
                d = ie.isNumeric(t.original.width)
                  ? t.original.width
                  : i.outerWidth(),
                c = ie.isNumeric(t.original.height)
                  ? t.original.height
                  : i.outerHeight(),
                p = function (e) {
                  return Math.round(100 * (e + Number.EPSILON)) / 100;
                },
                u = s && -1 !== o.indexOf("rect") ? 0 : 100,
                h = 0;
              h < n.length;
              h++
            )
              if (-1 === (a = n[h].trim()).indexOf(" ")) {
                if ("number" == typeof parseInt(a))
                  switch ((0 === parseInt(a) && (a = "0%"), h)) {
                    case 0:
                      -1 === a.indexOf("%") &&
                        (a = p(parseInt(a) / (c / 100)) + "%"),
                        (l[0][1] = a),
                        (l[1][1] = a);
                      break;
                    case 1:
                      -1 !== a.indexOf("%")
                        ? ((l[1][0] = 100 - parseInt(a) + "%"),
                          (l[2][0] = 100 - parseInt(a) + "%"))
                        : (-1 === a.indexOf("%") &&
                            (a =
                              p(Math.abs(parseInt(a) / (d / 100) - u)) + "%"),
                          (l[1][0] = a),
                          (l[2][0] = a));
                      break;
                    case 2:
                      -1 !== a.indexOf("%")
                        ? ((l[2][1] = 100 - parseInt(a) + "%"),
                          (l[3][1] = 100 - parseInt(a) + "%"))
                        : (-1 === a.indexOf("%") &&
                            (a =
                              p(Math.abs(parseInt(a) / (c / 100) - u)) + "%"),
                          (l[2][1] = a),
                          (l[3][1] = a));
                      break;
                    case 3:
                      -1 === a.indexOf("%") &&
                        (a = p(parseInt(a) / (d / 100)) + "%"),
                        (l[0][0] = a),
                        (l[3][0] = a);
                  }
              } else
                -1 === (r = a.split(" "))[0].indexOf("%") &&
                  (r[0] = p(parseInt(r[0]) / (d / 100)) + "%"),
                  (l[h][0] = r[0]),
                  -1 === r[1].indexOf("%") &&
                    (r[1] = p(parseInt(r[1]) / (c / 100)) + "%"),
                  (l[h][1] = r[1]);
            for (var m = "polygon(", f = 0; f < l.length; f++)
              (m += l[f].join(" ")), f < l.length - 1 && (m += ",");
            return (m += ")");
          },
        },
        getSliderClosestParentElementWithNumericValueOfProperty: function (e) {
          for (
            ...
            if (
              ...
              if (
                -1 !== t.indexOf("px") &&
                (0 < parseInt(t) || J.slider.isPopup)
              )
                return (
                  (J.slider.$parentWithNumericWidthValue = ie(i[r])), ie(i[r])
                );
              -1 !== t.indexOf("%") &&
                ((a = (a / 100) * parseInt(t)),
                (J.slider.$parentWithNumericWidthValuePercent = a));
            }
        },
        sortArray: function (e, t, i) {
          ...
          switch (i) {
            case "forward":
              for (s = 0; s < e; s++) for (a = 0; a < t; a++) c.push(s + a * e);
              break;
            case "reverse":
              for (s = e - 1; -1 < s; s--)
            ...
            case "radial-out":
              for (l = e / 2, d = t / 2, s = 0; s < e; s++)
                for (a = 0; a < t; a++)
                  c.push(
                    Math.floor(Math.abs(d - a - 0.5)) +
                      Math.floor(Math.abs(l - s - 0.5))
                  );
              break;
            case "radial-in":
              for (l = e / 2, d = t / 2, s = 0; s < e; s++)
                for (a = 0; a < t; a++)
                  c.push(
                    Math.floor(d - Math.ceil(Math.abs(d - a - 0.5))) +
                      Math.floor(l - Math.ceil(Math.abs(l - s - 0.5)))
                  );
          }
          return c;
        },
        ...
        setStates: function (e, t, i) {
          if (e && e.state) {
            ...
            e == J.slideshow &&
              (J.api.hasEvent("slideshowStateDidChange") &&
                J.api.triggerEvent(
              ...
              i != s &&
                (i
                  ? J.api.hasEvent("slideshowDidPause") &&
                    J.api.triggerEvent("slideshowDidPause", J.api.eventData())
                  : (J.slideshow.start(),
                    J.api.hasEvent("slideshowDidResume") &&
                      J.api.triggerEvent(
                        "slideshowDidResume",
                        J.api.eventData()
                      ))));
        ...
        clearTimers: function () {
          for (var e in J.timeouts)
            clearTimeout(J.timeouts[e]), delete J.timeouts[e];
          for (var t in J.intervals)
            clearInterval(J.intervals[t]), delete J.intervals[t];
        },
        clearTimelines: function () {
          J.transitions.timelines.set("all", function (e, t) {
            e.pause().clear().kill(), delete J.transitions[t];
          }),
            ee.TweenMax.killTweensOf(
              $.find(
          ...
          J.transitions.timelines.set("layers", function (e, t) {
            ...
            $.find(".ls-layer:not(.ls-bg-video)").each(function () {
              ...
              if (
                ...
                parseInt(e.attr("data-ls-slidein")) !== J.slides.current.index
              )
                return !0;
      ...
      (J.device = {
        scroll: {
          ...
          preventDefaultForScrollKeys: function (e) {
            if (-1 !== J.device.scroll.keys.indexOf(e.keyCode))
              return J.device.scroll.preventDefault(e), !1;
          },
        },
        ...
        fullscreen: {
          enter: function () {
            J.functions.setStates(J.slider, { inFullscreen: !0 }),
              ie("body, html").addClass("ls-fullscreen"),
              J.slider.fullscreenWrapper.requestFullscreen(),
              $.trigger("mouseleave"),
              J.device.removeSelection();
          },
          exit: function () {
            J.functions.setStates(J.slider, { inFullscreen: !1 }),
              J.resize.all(),
              ie("body, html").removeClass("ls-fullscreen"),
              J.device.removeSelection();
          },
          toggle: function () {
            J.device.fullscreen.element()
              ? (J.device.fullscreen.exit(), document.exitFullscreen())
              : J.device.fullscreen.enter();
          },
          set: function () {
            J.o.allowFullscreen &&
              ...
              (J.slider.$fullscreenWrapper = $.closest(
                ".ls-fullscreen-wrapper"
              )),
              (J.slider.fullscreenWrapper = J.slider.$fullscreenWrapper[0]),
              (J.slider.$spacingWrapper = J.slider.$fullscreenWrapper),
              (J.slider.fullscreenWrapper.requestFullscreen =
                J.slider.fullscreenWrapper.requestFullscreen ||
                J.slider.fullscreenWrapper.webkitRequestFullscreen ||
                J.slider.fullscreenWrapper.mozRequestFullScreen ||
                J.slider.fullscreenWrapper.msRequestFullscreen),
          ...
          switch (t.action) {
            ...
            case "scrollToTimelinePosition":
              J.slider.isScene || $.addClass("ls-action-trigger"),
                J.slider.isScrollScene &&
                  "scrollToTimelinePosition" === t.action &&
                  ((t.action = "scrollToScenePosition"),
                  (t.target = "currentScene"));
              var r,
                o,
                n,
                l = ie(
                ...
                h = d.index(p);
              if (
                (J.slider.isScene || $.removeClass("ls-action-trigger"),
                "scrollToSelf" === t.action)
              )
                v = J.slider.$spacingWrapper.offset().top + (t.offset || 0);
              else if ("scrollBelowProject" === t.action)
                v =
                  J.slider.$spacingWrapper.offset().top +
                  J.slider.$spacingWrapper.height() +
                  (t.offset || 0);
              else if ("scrollToPrevProject" === t.action)
                0 !== l.index(p)
                  ? ((n = (c = l.eq(l.index(p) - 1)).is("ls-scene-wrapper")
                      ? c.find(".ls-container")
                      : c),
                    (v =
                      parseFloat(c.offset().top) -
                      parseFloat(n.css("top")) +
                      (t.offset || 0)))
                  : (s = "There’s no previous project to scroll to.");
              else if ("scrollToNextProject" === t.action)
                l.index(p) < l.length - 1
                  ? ((n = (c = l.eq(l.index(p) + 1)).is("ls-scene-wrapper")
                      ? c.find(".ls-container")
                      : c),
                    (v =
                ...
                c.length && c.size()
                  ? (v = parseFloat(c.offset().top) + (t.offset || 0))
                  : (s =
                ...
                c.length &&
                  ((r = parseFloat(c.attr("data-scene-duration"))),
                  (o = c.height()),
                  (l = (n = c.find(".ls-container")).height()),
                  (t.position = ie.trim(t.position) || "0ms"),
                  (v = c.is('[data-scene="scroll"]')
                    ? ((m =
                ...
                var m = J.transitions._slideTimeline.duration(),
                  f =
                    m * ((100 * J.transitions._slideTimeline.progress()) / 100),
                  g = 0,
                  g =
                    -1 !== t.position.indexOf("%") ||
                    -1 === t.position.indexOf("ms")
                      ? (m * parseFloat(t.position)) / 100
                      : parseFloat(t.position) / 1e3;
              ...
              s ||
                ((t.duration = ie.isNumeric(t.duration) ? t.duration : 1e3),
                "scrollToTimelinePosition" === t.action
                  ? J.transitions._slideTimeline
                      .tweenTo(g, {
                  ...
                  : ee.TweenMax.to("html, body", t.duration / 1e3, {
                      scrollTop: v,
                      ease: J.functions.convert.easing(t.easing),
                    }));
              break;
            ...
            case "stopSlideshow":
            case "startSlideshow":
              "nextSlide" === t.action && (w = "next"),
                "prevSlide" === t.action && (w = "prev"),
                "lastSlide" === t.action && (w = "last"),
                "firstSlide" === t.action && (w = "first"),
                "stopSlideshow" === t.action && (w = "stop"),
                "startSlideshow" === t.action && (w = "start"),
                J.navigation[w]("clicked");
              break;
            case "replaySlide":
              J.api.methods("replay");
              break;
            ...
            case "openPopup":
              var y,
                v = ie("[id^=layerslider_" + t.popup + "]").first(),
                w = v.data("lsSliderUID");
              v.length
                ? (((y =
                    window._layerSliders[w].initializedPlugins
                      .popup).plugin.settings.showOnce = !1),
                  "opened" == y.state.is
                    ? t.toggle && y.events.hide()
                    : t.slide
                    ? v.layerSlider("fastChangeTo", t.slide, function () {
                        y.events.show();
                      })
                    : y.events.show())
                : ((v = {
                  ...
                  ie.get(
                    J.o.ajaxURL || window.ajaxurl || "/wp-admin/admin-ajax.php",
                    v,
                    function (e) {
                      ie(e).appendTo("body");
                    }
      ...
      (J.api = {
        ...
        methods: function (e, t, i, s) {
          if (!J.slider.isBusy())
            if ("number" == typeof e)
              0 < e &&
                e < J.slides.count + 1 &&
                e != J.slides.current.index &&
                J.slideshow.changeTo(e, !0, !0);
            else
              switch (e) {
                case "touchPrev":
          ...
          switch (e) {
            ...
            case "fastChangeTo":
              t &&
                ie.isNumeric(t) &&
                (J.slides.current.index !== t
                  ? ((J.slideshow.forceFastChange = !0),
                    i &&
                      "function" == typeof i &&
                      (J.slideshow.forceFastChangeCallback = i),
                    J.slideshow.changeTo(t, !0, !0))
                  : i && i());
              break;
            case "resetScroll":
              J.slider.set.offset(),
                M.trigger("scroll.scroll" + B)
            ...
            case "enableScene":
              J.slider.isScene &&
                (J.slider.$spacingWrapper.removeAttr("data-disabled-scene"),
                J.api.methods("resetScroll"));
              break;
            case "disableScene":
              J.slider.isScene &&
                (J.slider.$spacingWrapper.attr("data-disabled-scene", ""),
                $.css({ top: "auto", bottom: "auto" }),
                J.transitions.scrollscene.animate("start"),
                J.api.methods("resetScroll"));
              break;
            case "closePopup":
              J.initializedPlugins.popup &&
                J.initializedPlugins.popup.events.hide();
              break;
            case "closeAllPopups":
              ie('<div class="ls-close-all-popups-button"></div>')
                .css("display", "none")
                .appendTo("body")
                .trigger("click")
                .remove();
            ...
            case "replay":
              J.transitions._slideTimeline &&
                J.transitions._slideTimeline.restart();
              break;
            case "reverseSlide":
            case "reverse":
              J.transitions._slideTimeline &&
                (J.transitions._slideTimeline.reversed()
                  ? J.transitions._slideTimeline.play()
                  : J.transitions._slideTimeline.reverse(),
                t && (J.transitions.layers.timeline.shouldReplay = !0));
              break;
            case "unmute":
            case "unmuteMedia":
              J.media.unmute.multipleMediaElements();
            ...
            case "pause":
              t &&
                "performanceMode" === t &&
                J.functions.setStates(J.slideshow, { pausedByPerformance: !0 }),
                J.transitions._slideTimeline &&
                  !J.slider.isScrollScene &&
                  J.transitions._slideTimeline.stop(),
                ...
                (J.transitions.layers.parallax.state.paused = !0),
                (J.transitions.layers.scroll.state.paused = !0),
                J.media.functions.pauseActiveMedia(!0);
              break;
            case "resumePopup":
              J.layers.get("active").each(function () {
                ...
                J.transitions._slideTimeline &&
                  (J.transitions._slideTimeline.timeScale() < 0.001 &&
                    J.transitions.layers.timeline.resume(),
                  J.transitions._slideTimeline.play()),
                J.transitions._slideTransition &&
                  J.transitions._slideTransition.play();
            ...
            case "resume":
              J.transitions._slideTimeline &&
                (J.transitions._slideTimeline.timeScale() < 0.001 &&
                  J.transitions.layers.timeline.resume(),
                J.slider.isScrollScene || J.transitions._slideTimeline.play()),
                J.media.functions.playActiveMedia(!0),
                J.layers.get("active").each(function () {
                  var e = ie(this).data(J.defaults.init.dataKey);
                  e.loop._timeline && e.loop._timeline.play();
                }),
                (J.transitions.layers.parallax.state.paused = !1),
                (J.transitions.layers.scroll.state.paused = !1),
                J.transitions._slideTransition
                  ? J.transitions._slideTransition.play()
                  : J.o.animateFirstSlide &&
                    J.slideshow.firstStart &&
            ...
            case "toggle":
              J.slider.state.isPaused
                ? ($.layerSlider("resume"), (J.slider.state.isPaused = !1))
                : ($.layerSlider("pause"), (J.slider.state.isPaused = !0));
              break;
            case "reset":
            case "resetSlider":
              break;
            ...
            case "kill":
              if (J.slider.state.isLoaded) {
                if (
                  (J.functions.clearTimers(),
                  J.functions.clearTimelines(),
                  J.layers.$all.removeData(),
                  J.api.hasEvent("sliderDidDestroy") &&
                    J.api.triggerEvent("sliderDidDestroy"),
                  J.slider.state.sholudBeRemoved || t)
                ) {
                  if (
                    (J.slider.$hiddenWrapper.remove(),
                    J.gui.timers.slidebar.$containerElement)
                  )
                    for (
                      var a = 0;
                      a < J.gui.timers.slidebar.$containerElement.length;
                      a++
                    )
                      J.gui.timers.slidebar.$containerElement[a] instanceof
                        jQuery &&
                        J.gui.timers.slidebar.$containerElement[a].remove();
                  J.api.hasEvent("sliderDidRemove") &&
                    J.api.triggerEvent("sliderDidRemove");
                  ...
                  r.closest(".ls-popup").length &&
                    (r = r.closest(".ls-popup"))
                      ...
                      .remove(),
                    r.remove(),
                    J.slider.$silentWrapper && J.slider.$silentWrapper.remove();
                }
        ...
        eventData: function () {
          return {
            ...
            navigation: { direction: J.navigation.direction },
            slides: {
              first: {
            ...
            cycles: { max: J.o.cycles, current: J.slideshow.curCycle },
          };
        },
